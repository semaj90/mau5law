 ...
 * - If it fails with an error mentioning missing `.logic.getInitialSnapshot`,
 *   attempts a lightweight adapter that moves top-level getInitialSnapshot/getPersistedSnapshot/restoreSnapshot
