...
export async function copilotOrchestrator( request: MCPGenericRequest | string, options?: OrchestrationOptions
): Promise<any> {
...
export const commonMCPQueries = {
  search: 'search', analyze: 'analyze', generate: 'generate', analyzeSvelteKit: (): string => 'analyze-sveltekit', analyzeDrizzle: (): string => 'analyze-drizzle', performanceBestPractices: (): string => 'performance-best-practices', securityBestPractices: (): string => 'security-best-practices'
};
export default {
  copilotOrchestrator, semanticSearch, mcpMemoryReadGraph, mcpCodebaseAnalyze, generateMCPPrompt, commonMCPQueries
};
