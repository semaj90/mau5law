9: >, 10: export function resolveVariantStyle(variant: 1, 2: options?: {
enableGlow?: boolean ): VariantResolvedStyle {
...
return {
backgroundColor, borderColor, textColor, glow, hover: {
backgroundColor, hoverColor }
};
  11: // Central exported theme adapter export const yoRHaThemeAdapter = {
