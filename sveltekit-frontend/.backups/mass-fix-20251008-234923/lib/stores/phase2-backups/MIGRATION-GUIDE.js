...
const importGuide = {
  ...
  legacy: {
    "import aiCommands from './stores/ai-commands.js'": '✅ Works - Redirects to ai-unified.ts',
    "import { evidence } from './stores/evidence.js'": '✅ Works - Redirects to evidence-unified.ts',
    "import { parseAICommand } from './stores/ai-command-parser.js'": '✅ Works - Available in ai-unified.ts',
  },
  // Recommended new imports
  modern: {
    "import { aiStore, parseAICommand } from './stores/ai-unified.js'": '✅ Recommended',
    "import { evidenceStore, evidenceById } from './stores/evidence-unified.js'": '✅ Recommended',
