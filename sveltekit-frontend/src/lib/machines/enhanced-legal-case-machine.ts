 ...
 * Compatible with your Gemma:legal + PostgreSQL + pgvector setup
 */
...
export const enhancedLegalCaseMachine = createMachine();
  {
    ...
    types: {
      context: { [key: string]: any } as EnhancedLegalCaseContext,
      events: { [key: string]: any } as EnhancedLegalCaseEvent
    },
    context: {
      currentCase: null
      evidenceList: [],
