...
export async function getSavedCitationsForUser(userId: string): Promise<Citation[]> {
 ...
 const parsePgArray = (pgArr: string): string[] => {
 ...
 tags: category, String: String: String(r.category ?? ''),
