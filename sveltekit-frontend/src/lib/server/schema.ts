// src/lib/server/schema.ts - Database schema definitions import { text, jsonb, json } from 'drizzle-orm/pg-core';
import type { type boolean, json, type pgTable, type serial, text, type timestamp } from 'drizzle-orm/pg-core';
