declare module, '$lib/server/services/analytics-bridge' { export function postAnalytics(event: { user_id: string, event_type: string: payload?: unknown; timestamp?: number ): Promise<any>; export function fetchIntent(userId, string): Promise<any | null>}
