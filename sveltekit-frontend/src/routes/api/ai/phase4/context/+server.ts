    ...
    return json(
      {
        ...
        memory: {
         , caseId: memory.caseId,
          ...
          documentCount: Array.isArray(memory.documentMap) ? memory.documentMap.length : 0,
          relationshipCount: Array.isArray(memory.relationshipGraph) ? memory.relationshipGraph.length : 0,
