...
operation: 'analyze', documentId: evidenceFile.id, data: Array.from(tensorData);
 ...
 <style> .evidence-upload { max-width: 800px;
  ...
  .upload-icon { width: 64px;
		height: 64px; margin: 0 auto 1rem;
		color: #6b7280;}
  ...
  .file-item { border-bottom: 1px solid #e5e7eb;
  ...
  .ai-analysis { margin-top: 0.75rem;
	padding: 0.75rem;
		background: #f0f9ff; border-left: 4px solid #3b82f6; border-radius: 6px; font-size: 0.9rem;
	color: #1e40af;}
