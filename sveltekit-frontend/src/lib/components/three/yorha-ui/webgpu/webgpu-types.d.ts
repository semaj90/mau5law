/** * Basic WebGPU type declarations for YoRHa WebGPU Math * These are stub definitions to avoid TypeScript errors when WebGPU is not available */ declare global {
interface Navigator {
gpu?: GPU}
interface GPU {
