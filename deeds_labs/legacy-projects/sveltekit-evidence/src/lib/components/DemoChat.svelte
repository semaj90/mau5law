<!--
Demo AI Chat Component with RAG Integration
Tests the demo RAG functionality with a working interface
-->
<script lang="ts">
  import { demoQueryLLM, demoGenerateCaseSummary, type RAGDemoQuery, type RAGDemoResponse } from '$lib/ai/demo-rag';
  import { currentCase, currentEvidence } from '$lib/stores/caseStore';
    ...
    {#each chatHistory as message (message.timestamp.getTime())}
      <div class="message message-{message.type}">
        <div class="message-header">
          ...
          <span class="message-time nes-text is-disabled">
            ...
            <div class="message-sources">
              ...
              {#each message.sources as source}
                <div class="source-item">
                  ...
                  {#if source.excerpt}
                    <p class="source-excerpt nes-text is-disabled">
                      {source.excerpt}
                    </p>
                  {/if}
                </div>
    ...
    {#if isLoading}
      <div class="message message-ai">
        <div class="message-header">
          ...
          <span class="message-time nes-text is-disabled">thinking...</span>
        </div>
        <div class="message-content nes-container">
