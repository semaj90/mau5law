...
export interface Gemma3LegalConfig { model: { name: string;
  ...
  legal_prompts: { contract_analysis: string;, case_summary: string;
...
export const GEMMA3_LEGAL_CONFIG: Gemma3LegalConfig = { model: { name: 'gemma3-legal',
    version: 'latest',
    size: '7.3GB',
    context_length: 8192,
...
export const API_ENDPOINTS = { ollama: { base_url: OLLAMA_BASE,
    ...
    models: `/api/tags` },
  enhanced_rag: { base_url: 'http://localhost:8094',
    query: '/api/v1/rag',
    search: '/api/v1/search',
    index: '/api/v1/index',
    health: `/health` },
  legal_services: { base_url: 'grpc://localhost:50051',
