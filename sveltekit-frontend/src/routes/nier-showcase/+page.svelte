...
<div class="min-h-screen bg-nier-white dark:bg-nier-black transition-colors duration-500">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <section class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
      <div class="nier-nier-bits-card p-6 text-center group hover:border-digital-green dark:hover:border-digital-green">
        <div class="text-3xl font-bold text-harvard-crimson dark:text-digital-green mb-2">127</div>
        <p class="text-sm text-nier-gray dark:text-nier-silver">Active Cases</p>
      </div>
      <div class="nier-nier-bits-card p-6 text-center group hover:border-digital-green dark:hover:border-digital-green">
        <div class="text-3xl font-bold text-harvard-crimson dark:text-digital-green mb-2">89%</div>
        <p class="text-sm text-nier-gray dark:text-nier-silver">Success Rate</p>
      </div>
      <div class="nier-nier-bits-card p-6 text-center group hover:border-digital-green dark:hover:border-digital-green">
        <div class="text-3xl font-bold text-harvard-crimson dark:text-digital-green mb-2">1,247</div>
        <p class="text-sm text-nier-gray dark:text-nier-silver">Evidence Items</p>
      </div>
      <div class="nier-nier-bits-card p-6 text-center group hover:border-digital-green dark:hover:border-digital-green">
        <div class="text-3xl font-bold text-harvard-crimson dark:text-digital-green mb-2">24/7</div>
    ...
    <section id="showcase" class="py-12">
      <div class="text-center mb-8">
        <h2 class="text-3xl font-display font-bold nier-heading mb-4">Component Showcase</h2>
    ...
    <section class="py-16 border-t border-nier-light-gray dark:border-nier-gray/30">
      <h2 class="text-3xl font-display font-bold nier-heading text-center mb-12">System Features</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="text-center">
          <div
            class="w-20 h-20 mx-auto mb-4 bg-nier-gradient-digital rounded-2xl flex items-center justify-center text-3xl animate-pulse"
          >
            🔐
          </div>
        ...
        <div class="text-center">
          <div
            class="w-20 h-20 mx-auto mb-4 bg-nier-gradient-crimson rounded-2xl flex items-center justify-center text-3xl"
          >
            🧠
          </div>
        ...
        <div class="text-center">
          <div
            class="w-20 h-20 mx-auto mb-4 bg-nier-gradient-gold rounded-2xl flex items-center justify-center text-3xl"
          >
            ⚡
          </div>
  ...
  <footer class="mt-24 py-8 border-t border-nier-light-gray dark:border-nier-gray/30">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p class="text-xs text-nier-light-gray dark:text-nier-gray">© 2025 YoRHa • For the Glory of Mankind</p>
    </div>
  </footer>
  <!-- AI Assistant -->
  {#if showAIAssistant}
