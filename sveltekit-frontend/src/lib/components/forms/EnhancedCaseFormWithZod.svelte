...
<script lang="ts">
  ...
  $effect(() => {
    if (enableRealTimeValidation) {
      ...
      // use store value of errors (auto-subscribe using $errors)
  ...
  $effect(() => {
    if (!enableRealTimeValidation || !$form) return;
          ...
          {#if showAdvanced}
            <div class="space-y-6 border-l-2 border-muted pl-6">
              ...
              <div class="flex flex-col space-y-3">
                <div class="flex items-center space-x-2">
                  <!-- Use checked + onchange to update the store via helper -->
                  <input
                    id="isConfidential"
                    name="isConfidential"
                    type="checkbox"
        ...
        <div class="border-t pt-6">
          <div class="space-y-4">
            <div class="flex items-center space-x-2">
              ...
              <div class="text-base font-medium">Case Documents</div>
            </div>
            <!-- File Upload Input -->
