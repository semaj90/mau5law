...
- /> -            <Button onclick={ searchCitations } disabled={!searchTerm}> -              ðŸ” Search -            </Button> +            <div class="citation-search"> +              <svelte:component +                this={ UIInput } +                value={ searchTerm } +                oninput={(e: unknown) => (searchTerm = (e.target as HTMLInputElement).value)} +                placeholder="Search citations by title, content, tags, or notes..."
