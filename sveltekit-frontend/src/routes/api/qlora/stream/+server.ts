        ...
        async start(controller) {
            ...
            try {
                ...
                const qloraResponse: any = {
                    prediction: {
                        type: resultAny.prediction?.type || 'legal_document',
                        ...
                        topology: {
                            nodes: resultAny.topology?.nodes || 10,
                    ...
                    topology: {
                        structure: resultAny.topology?.structure || 'hierarchical',
                    ...
                    processingTime,
                    metrics: {
                        hmmPredictionScore: metrics.hmmAccuracy || 0.8,
                        somClusterScore: 0.9,
                ...
                sendEvent('end', {
                    ...
                    metadata: {
                        accuracy: qloraResponse.prediction.accuracy,
                        processingTime
                    }
                });
                controller.close();
