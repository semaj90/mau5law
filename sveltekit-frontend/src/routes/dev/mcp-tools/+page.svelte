...
<main class="min-h-screen">
  <div class="max-w-7xl mx-auto">
    ...
    <MCPToolsDemo />
    <div class="mt-12 bg-white border border-gray-200 rounded-lg">
      <h2 class="text-xl font-semibold">Integration Status</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="space-y-3">
          <h3 class="font-medium">🤖 AI Systems</h3>
          <ul class="space-y-1 text-sm">
      ...
      <div class="mt-6 p-4 bg-blue-50">
        <h4 class="font-medium text-blue-900">Available Tools</h4>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <strong>analyze-stack:</strong> Context-aware analysis, for: unknown stack component
          </div>
          <div>
