...
const testQueries = [
  'Review this contract for potential liability issues', 'What are the precedents for copyright infringement in software?', 'Hello, how are you today?', 'Search for cases involving data privacy violations', 'Analyze this employment agreement for compliance issues', 'Can you help me understand trademark law?', 'urgent: need immediate analysis of this merger document', "What's the weather like today?",'
  'Find similar cases to Brown vs Board of Education', 'Draft a response to this cease and desist letter'];
/**
...
export async function demonstrateSOMClustering(): Promise<void> {
  ...
  console.log('=============================\n');
  const legalQueries = [
    'contract review needed urgently', 'analyze patent application', 'copyright infringement case research', 'trademark dispute analysis'];
