...
<div class="pt-6">
	<Tabs.Root
		value="outbound"
		class="rounded-nier-bits-card border-muted bg-background-alt shadow-nier-bits-card w-[390px] border p-3"
	>
		<Tabs.List
		...
		<Tabs.Content value="outbound" class="select-none pt-3">
			<div class="grid grid-cols-3 grid-rows-2 gap-0 p-4 pb-1">
				<div class="text-left">
					...
					<p class="nes-text is-disabled text-sm font-medium">06:05</p>
				</div>
				<div class="self-end text-center">
					<p class="nes-text is-disabled text-sm font-medium">3h 30m</p>
				</div>
				...
				<div class="relative col-span-3">
					...
					<div class="bg-background-alt absolute left-1/2 -translate-x-1/2 p-1">
						<Airplane class="nes-text is-disabled size-6 rotate-90" />
					</div>
				</div>
			</div>
		</Tabs.Content>
		<Tabs.Content value="inbound" class="select-none pt-3">
			<div class="grid grid-cols-3 grid-rows-2 gap-0 p-4 pb-1">
				<div class="text-left">
					...
					<p class="nes-text is-disabled text-sm font-medium">07:25</p>
				</div>
				<div class="self-end text-center">
					<p class="nes-text is-disabled text-sm font-medium">3h 20m</p>
				</div>
				<div class="text-right">
					<h4 class="mb-2 text-[20px] font-semibold leading-none tracking-[-0.01em]">
						Prague
					</h4>
					<p class="nes-text is-disabled text-sm font-medium">10:45</p>
				</div>
				<div class="relative col-span-3">
					<hr class="border-border-input border-1 relative top-4 h-px border-dashed" />
