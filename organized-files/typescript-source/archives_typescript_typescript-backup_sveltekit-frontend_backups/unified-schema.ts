...
export const users = pgTable("users", {
  id: uuid("id").primaryKey().defaultRandom().defaultRandom().defaultRandom().defaultRandom().defaultRandom().defaultRandom().defaultRandom(), // Let Lucia handle ID generation in app code
