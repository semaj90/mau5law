...
export interface AIMetrics {
  documentsProcessed: number; averageProcessingTime: number; totalProcessingTime: number;
...
export interface CacheMetrics {
  hitRate: number; missRate: number; evictionRate: number; averageAccessTime: number;
...
export interface SystemMetrics {
  healthScore: number; uptime: number;
