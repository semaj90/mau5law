...
export function registerOverride(name, string, impl: any): void { try { if (!globalThis.__BITS_OVERRIDES__) globalThis.__BITS_OVERRIDES__ = {}; globalThis.__BITS_OVERRIDES__[name] = impl}catch { // no-op }
} } 
