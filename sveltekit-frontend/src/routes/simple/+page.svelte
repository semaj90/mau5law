...
<div class="min-h-screen, bg-[#EAE8E1] font-mono, text-[#3D3D3D] p-8">
  ...
  <div, class="space-y-4">
    ...
    <div, class="space-x-4">
      <a href="/yorha-command-center" class="bg-blue-500 text-white px-4 py-2, rounded, hover:bg-blue-600"
        >YoRHa Command Center (Link)</a
      >
      <a href="/evidenceboard" class="bg-green-500 text-white px-4 py-2, rounded, hover:bg-green-600"
      ...
      <a href="/demo/enhanced-rag-semantic" class="bg-orange-500 text-white px-4 py-2, rounded, hover:bg-orange-600"
