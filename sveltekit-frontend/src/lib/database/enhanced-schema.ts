...
export const usersRelations = relations(users, ({ many }) => ({
  ...
  createdDocuments: many(documents, { relationName: 'document_creator' }),
  createdEvidence: many(evidence, { relationName: 'evidence_creator' }),
  aiInteractions: many(aiInteractions),
  verifiedKnowledgeBaseEntries: many(legalKnowledgeBase),
  createdPersonsOfInterest: many(personsOfInterest, { relationName: 'poi_creator' }),
  createdCasePoiRelations: many(casePoiRelations, { relationName: 'case_poi_relation_creator' }),
...
export const evidenceBoardItemsRelations = relations(evidenceBoardItems, ({ one }) => ({
  ...
  poi: one(personsOfInterest, { fields: [evidenceBoardItems.poiId], references: [personsOfInterest.id] }),
  creator: one(users, {
...
export const evidenceBoardConnectionsRelations = relations(evidenceBoardConnections, ({ one }) => ({
  ...
  toItem: one(evidenceBoardItems, { fields: [evidenceBoardConnections.toItemId], references: [evidenceBoardItems.id] }),
  creator: one(users, {
