<!-- YoRHa Terminal, Interface --> <script lang="ts"> // Svelte, 5 runes are auto-imported // $state is declared globally in src/types/svelte-helpers.d.ts import { onMount } from 'svelte'; // YoRHa API client is exported as a named export — import { YoRHaAPIClient }.
