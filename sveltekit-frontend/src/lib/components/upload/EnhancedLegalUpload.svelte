...
import type { Document } from '$lib/types'; // Svelte, 5 runes are auto-imported import { superForm } from 'sveltekit-superforms/client'; import { zod } from 'sveltekit-superforms/adapters'; import { fileUploadSchema } from '$lib/schemas/file-upload.js'; import { createActor } from 'xstate'; import { evidenceProcessingMachine } from '$lib/state/evidenceProcessingMachine.js'; import * as Dialog from "bits-ui/components/dialog"; import type { PageData } from './$types.js'; interface Props { data: PageData, caseId?: string; onUploadComplete?: (result: unknown) => void; onUploadError?: (error: string) => void; preserveExistingFlow?: boolean; // New prop to maintain existing RAG flow }
