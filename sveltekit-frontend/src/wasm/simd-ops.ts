...
export function simd_vector_add(a: Float32Array, b: Float32Array): Float32Array {
...
export function simd_matrix_multiply(a: Float32Array, b: Float32Array, rowsA: number, colsA: number, colsB: number): Float32Array {
...
export function process_batch_embeddings(embeddings: Float32Array, batchSize: number, dimensions: number): Float32Array {
