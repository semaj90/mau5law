<script lang="ts">
// Svelte, 5 runes are auto-imported import type { onMount, onDestroy  } from 'svelte'; import Button from '$lib/components/ui/enhanced-bits.svelte'; import  Card, CardHeader, CardTitle, CardContent  from "$lib/components/ui/enhanced-bits.svelte"; import type { Activity, Cpu, MemoryStick, Users, Zap, RefreshCw, TrendingUp, TrendingDown, AlertTriangle, CheckCircle  } from 'lucide-svelte'; import type { ClusterHealth, WorkerMetrics } from '$lib/services/nodejs-cluster-architecture'; // Cluster state let clusterHealth = $state <ClusterHealth>({ totalWorkers: 0, healthyWorkers: 0, totalRequests: 0, averageResponseTime: 0, memoryUsage: { total: 0, average: 0, peak: 0 }, cpuUsage: { total: 0, average: 0 }, errors: { total: 0, rate: 0 } });
