...
export type MCPGenericRequest = MCPRequest | MCPToolRequest; export interface OrchestrationOptions { maxRetries?: number; timeout?: number; cacheEnabled?: boolean; useMemory?: boolean; useCodebase?: boolean; useSemanticSearch?: boolean; agents?: string[]; synthesizeOutputs?: boolean}
