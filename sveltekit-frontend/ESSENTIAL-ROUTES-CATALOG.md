# Essential Routes Catalog - Legal AI Platform
...
- ✅ `/evidenceboard` - Evidence visualization board
...
- ✅ `/evidence-editor` - Evidence editing interface
- ✅ `/citations` - Legal citations manager
- ✅ `/saved-citations` - Saved citations library
- ✅ `/laws` - Legal statutes database
- ✅ `/law` - Individual law viewer
- ✅ `/legal-ai-suite` - Comprehensive AI legal tools
- ✅ `/reports` - Legal reports dashboard
- ✅ `/report-builder` - Report creation interface
...
- ✅ `/assistant` - General assistant interface
- ✅ `/aiassistant` - Alternative AI assistant
...
- ✅ `/optimization-dashboard` - Performance optimization
- ✅ `/memory-dashboard` - Memory usage monitoring
...
- ✅ `/prosecutor` - Prosecutor-specific tools
...
- **SelectBits** - Dropdown selections
...
- **Typography**: Press Start 2P for headers, modern fonts for content
...
- **Test Routes**: 268 files (cleanup candidate)
...
4. 🔄 **XState v5**: Migrate disabled state machines
