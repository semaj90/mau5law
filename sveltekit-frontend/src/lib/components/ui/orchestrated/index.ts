...
import {
  Button, Card, Dialog as EnhancedDialog, Select as EnhancedSelect, Input
...
export interface LegalEvidenceItem { id: string; title: string;
  ...
  priority: "critical" | "high" | "medium" | "low"; confidence: number;
...
export interface OrchestrationState { currentRoute: string; activeDialog: string | null;
  loadingOperations: Set<string>;
  evidenceItems: LegalEvidenceItem[]; analysisResults: Map<string, AIAnalysisResult>;
...
export const OrchestrationContext = {
  ...
  // Cache coordination
  cacheService: null, as any, // GPU acceleration status
  webgpuService: null, as any, // Vector search integration
...
// export type {
//   LegalEvidenceItem, //   AIAnalysisResult, //   OrchestrationState
// }
