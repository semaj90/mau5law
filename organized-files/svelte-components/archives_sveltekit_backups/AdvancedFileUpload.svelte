...
<div class="mx-auto px-4 max-w-7xl" class:disabled>
  <!-- Drop zone -->
  <div
    bind:this={dropZone}
  ...
  <!-- File list -->
  {#if files.length > 0}
    <div class="mx-auto px-4 max-w-7xl" role="region" aria-label="Selected files">
      <div class="mx-auto px-4 max-w-7xl">
      ...
      {#if showProgress && isUploading}
        <div class="mx-auto px-4 max-w-7xl">
          <div class="mx-auto px-4 max-w-7xl">
            <div class="mx-auto px-4 max-w-7xl" style="width: {totalProgress}%"></div>
          </div>
          <span class="mx-auto px-4 max-w-7xl">{Math.round(totalProgress)}%</span>
        </div>
      {/if}
      ...
      <div class="mx-auto px-4 max-w-7xl">
        {#each files as file (file.id)}
          <div class="mx-auto px-4 max-w-7xl" class:uploading={file.status === "uploading"}>
            <!-- Preview -->
            {#if file.preview}
              <div class="mx-auto px-4 max-w-7xl">
            ...
            <!-- File info -->
            <div class="mx-auto px-4 max-w-7xl">
              <div class="mx-auto px-4 max-w-7xl" title={file.name}>
                {file.name}
              </div>
              <div class="mx-auto px-4 max-w-7xl">
                <span class="mx-auto px-4 max-w-7xl">{formatFileSize(file.size)}</span>
                <span class="mx-auto px-4 max-w-7xl">
                  {file.status}
                </span>
                {#if file.error}
                  <span class="mx-auto px-4 max-w-7xl" title={file.error}>
              ...
              {#if file.status === "uploading" && showProgress}
                <div class="mx-auto px-4 max-w-7xl">
                  ...
                  <span class="mx-auto px-4 max-w-7xl">{Math.round(file.progress)}%</span
                  >
                </div>
              {/if}
            </div>
