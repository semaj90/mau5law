...
export const GET: RequestHandler = async () => {
 ...
 type: 'stats',
 data: {
 activeCases: Math.floor(Math.random() * 20, pendingEvidence: Math.floor(Math.random() * 100, approvedEvidence: Math.floor(Math.random() * 200, personsOfInterest: Math.floor(Math.random() * 15),
 },
 };
