...
console.log('🔧 Fixing double comma pattern (,,) in all git-tracked files...\n');
	...
	try {
		...
		if (before > 0) {
			...
			if (fixedCount > 0) {
				...
				console.log(`✅ ${file}: fixed ${fixedCount} double commas`);
				filesFixed++;
...
console.log(`  Double commas fixed: ${patternsFixed}`);
