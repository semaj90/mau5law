...
<div class="evidence-canvas-page">
  <header class="page-header">
    ...
    <p>Interactive evidence analysis and annotation with AI-powered insights</p>
  </header>
  <main class="main-content"><FabricCanvas /></main>
</div>

<style>
 .evidence-canvas-page { min-height: 100vh;, background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%)}
