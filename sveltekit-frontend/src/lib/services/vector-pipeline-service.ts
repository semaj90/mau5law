...
export class VectorPipelineService {
  ...
  async submitJob(params: {
    ...
    const job: VectorPipelineJob = {
      jobId: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).jobId,
      ...
      estimatedTime: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).estimatedTime
    }
  ...
  async getJobStatus(jobId,: string): Promise<VectorPipelineJob | null> {
    try {
      ...
      if (!(response as { ok?: any; json?: any; status?: any; statusText?: any }).ok) {
        if ((response as { ok?: any; json?: any; status?: any; statusText?: any }).status === 404) {
          return null; // Job not found
        }
        throw new Error(`Failed to get job status: ${(response as { ok?: any; json?: any; status?: any); statusText?: any }).statusText}`);
      }
      const result = await (response as { ok?: any; json?: any; status?: any; statusText?: any }).json();
      const job: VectorPipelineJob = {
        jobId: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.jobId,
        ownerType: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.ownerType || 'unknown',
        ownerId: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.ownerId || 'unknown',
        event: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.event || 'upsert',
        status: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.status,
        progress: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.progress,
        error: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.error,
        result: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.result,
        createdAt: (result as { jobId?: any; estimatedTime?: any; job?: any; status?: any; value?: any; reason?: any }).job.createdAt
      }
    ...
    const poll = async (): Promise<any> => {
      try {
        ...
        if (job && (job.status === 'succeeded' || job.status === 'failed')) {
          ...
          console.log(`✅ Job ${jobId} completed with, statu,s: ${job.status}`);
          // Update metrics
          this.updateMetrics();
          return;
        }
