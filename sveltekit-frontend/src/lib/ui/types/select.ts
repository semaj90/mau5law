...
export interface SelectProps<T = string> {
  ...
  /**
   * The name of the select input, useful for form submissions.
   */
  name?: string;
  /**
...
export interface SelectTriggerProps extends HTMLButtonAttributes {
  /**
   * Custom class to apply to the select trigger.
   */
  class?: string;
  /**
...
export interface SelectValueProps extends HTMLAttributes<HTMLSpanElement> {
  /**
   * Custom class to apply to the select value display.
   */
  class?: string;
  /**
...
export interface SelectContentProps extends HTMLAttributes<HTMLDivElement> {
  /**
   * Custom class to apply to the select content wrapper.
   */
  class?: string;
  /**
  ...
  /**
   * Whether the content should be modal (i.e., trap focus).
   * @default true
   */
  modal?: boolean;
}
