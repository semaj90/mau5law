...
export const EnhancedBitsClasses = {
  // Fonts
  fontSans: 'font-enhanced', fontMono: 'font-enhanced-mono', fontLegal: 'font-enhanced-legal', fontPixel: 'font-enhanced-pixel', fontJapanese: 'font-enhanced-japanese', // Backgrounds
  bgPrimary: 'bg-enhanced-primary', bgSecondary: 'bg-enhanced-secondary', bgTertiary: 'bg-enhanced-tertiary', // Text Colors
  textPrimary: 'text-enhanced-primary', textSecondary: 'text-enhanced-secondary', textMuted: 'text-enhanced-muted', textAccent: 'text-enhanced-accent', // Borders
  border: 'border-enhanced', borderAccent: 'border-enhanced-accent', // Buttons
  btn: 'enhanced-btn', btnPrimary: 'enhanced-btn enhanced-btn-primary', btnSecondary: 'enhanced-btn', btnNES: 'nes-enhanced-btn', // YoRHa Harvard Gaming Components
  yorhaHarvardBtn: 'yorha-harvard-btn', yorhaHarvardBtnPrimary: 'yorha-harvard-btn yorha-harvard-btn-primary', yorhaHarvardBtnGaming: 'yorha-harvard-btn yorha-gaming-btn', yorhaHarvardBtnTerminal: 'yorha-harvard-btn yorha-terminal-btn', harvardGamingBadge: 'harvard-gaming-badge', // Cards
  card: 'enhanced-card', yorhaHarvardCard: 'yorha-harvard-card', yorhaTerminal: 'yorha-terminal', // Gaming Utilities
  harvardCrimson: 'text-harvard-crimson', harvardGold: 'text-harvard-gold', yorhaMatrixGreen: 'yorha-matrix-green', yorhaCyberBlue: 'yorha-cyber-blue', gamingBorder: 'gaming-border', harvardGlow: 'harvard-glow', pixelated: 'pixelated', gamingScanLines: 'gaming-scan-lines', // Inputs
 ...
 */
export const EnhancedBitsFonts = { sans: 'Inter', mono: 'JetBrains Mono', legal: 'IBM Plex Sans', pixel: 'Press Start 2P', japanese: 'Noto Sans JP'
 }as const;
/**
