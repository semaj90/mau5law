...
const REPLACEMENTS = [
  // Import replacements
  { from: /import.*?from\s+['"]bullmq['"]/g, to: "import amqp from 'amqplib'" },
  { from: /import\s*\{[^}]*Queue[^}]*\}\s*from\s+['"]bullmq['"]/g, to: "import amqp from 'amqplib'" },
  { from: /import\s*\{[^}]*Worker[^}]*\}\s*from\s+['"]bullmq['"]/g, to: "import amqp from 'amqplib'" },
