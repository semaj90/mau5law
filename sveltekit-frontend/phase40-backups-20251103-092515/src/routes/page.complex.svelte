    ...
    <aside class="yorha-sidebar">
      <nav class="yorha-sidebar-nav">
        ...
        <a href="/evidence" class="yorha-nav-item">
          ...
          <ChevronRight class="w-4 h-4" />
        </a> <a href="/persons" class="yorha-nav-item"> <Users class="w-4" /> <span>PERSONS OF INTEREST</span> </a>
        <a href="/analysis" class="yorha-nav-item">
          <BarChart3 class="w-4" /> <span>ANALYSIS</span>
          <ChevronRight class="w-4 h-4" />
        </a> <a href="/search" class="yorha-nav-item"> <Search class="w-4" /> <span>GLOBAL SEARCH</span> </a>
              ...
              {#each Array.isArray(activeCases) ? activeCases : [] as caseItem}
                <div class="border border-gray-700 rounded-lg p-4 hover:bg-gray-800 transition-colors cursor-pointer">
                  ...
                  <div class="flex items-center justify-between text-sm">
                    <span>{caseItem.items} items</span> <span>{caseItem.timeAgo}</span>
                  </div>
                </div>
              {/each}
            </div>
