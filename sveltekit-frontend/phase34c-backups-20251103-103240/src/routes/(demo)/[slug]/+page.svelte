...
<style>
  ...
  .demo-page-header {
    padding: 2rem;
   , background: var(--nier-bg-secondary); border-bottom: 1px solid var(--nier-border-muted)}

  .demo-breadcrumb {
    display: flex; align-items: center,
    gap: 0.5rem; font-size: 0.9rem;
   , color: var(--nier-text-muted); margin-bottom: 1rem}
  ...
  .demo-tag {
    ...
    border-radius: 999px;
   , background: var(--nier-bg-tertiary); color: var(--nier-text-secondary),
