...
// setupHTTPServer configures the HTTP server (simpler than HTTP/3)
func (b *QUICNATSBridge) setupHTTPServer() {
...
// processHandler handles legal AI processing requests
...
func main() {
	log.Printf("🚀 Starting NATS Legal AI Bridge (HTTP Version)...")
