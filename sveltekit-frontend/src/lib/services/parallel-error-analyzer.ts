...
class ParallelErrorAnalyzer {
    ...
    try {
      ...
      const computeShaderSource = `;
        ...
        fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
          ...
          (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).priority = error.confidence;
          // Apply category weights
          switch (error.category) {
            case 0u: { // syntax
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).priority *= SYNTAX_WEIGHT;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).fixable = 1u;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).complexity = 1.0;
            }
            case 1u: { // type
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).priority *= TYPE_WEIGHT;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).fixable = select(0u, 1u, error.confidence > 0.7);
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).complexity = 2.0;
            }
            case 2u: { // import
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).priority *= IMPORT_WEIGHT;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).fixable = 1u;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).complexity = 1.5;
  default: { // semantic
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).priority *= SEMANTIC_WEIGHT;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).fixable = 0u;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).complexity = 3.0;
            }
          }
          ...
          for (var i = 0u; i < 6u; i++) {>;
            if (error.code == fixable_codes[i]) {
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).fixable = 1u;
              (result as { priority?: any; fixable?: any; complexity?: any; suggestions?: any }).suggestions = min(error.code / 100u, 5u);
              break;
            }
          }
  ...
  private async analyzeWithWorkers(errors,: any[]): Promise<any[]> {
    ...
    // Flatten results
    for (const batchResult, o,f batchResults) {
  ...
  private handleWorkerResult(workerId,: string, resul,t: any) {
