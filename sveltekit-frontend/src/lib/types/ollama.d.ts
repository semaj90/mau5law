 ...
 */
export interface EmbeddingRequest { model: string; prompt: string;
 }
 ...
 */
export interface GenerateRequest { model: string; prompt: string;
  stream?: boolean;
 }
 ...
 */
export interface GenerateResponse { model: string; created_at: string;
  response: string;
  done: boolean;
