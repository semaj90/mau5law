...
export function getServiceAdapters() {
	...
	return {
		ollama:
			cachedServices.ollama || (cachedServices.ollama = new OllamaAdapter(env.ollamaConfig)),
		redis: cachedServices.redis || (cachedServices.redis = new RedisAdapter(env.redisConfig)),
		qdrant:
			cachedServices.qdrant || (cachedServices.qdrant = new QdrantAdapter(env.qdrantConfig)),
		pgvector:
			cachedServices.pgvector ||
			(cachedServices.pgvector = new PgVectorAdapter(env.postgresConfig)),
		...
		rabbitmq:
			...
			(cachedServices.rabbitmq = new RabbitMQAdapter(env.rabbitmqConfig)),
		env,
