...
export class CHRROMCacheReader {
  ...
  private getFallbackPattern(patternType: string): CHRROMPattern {
    const fallbackPatterns: { [key: string]: CHRROMPattern } }= { summary_icon: { type: 'icon' as const,
        size: 'sm' as const,
