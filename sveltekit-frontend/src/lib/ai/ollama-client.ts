...
export class OllamaClient {
  ...
  constructor(
    ...
    defaultModel: string = 'gemma3-legal:latest'
  ) {
  ...
  async generate(
    ...
    const { model = this.defaultModel, temperature = 0.7, topP = 0.9, topK = 50, maxTokens = 512, stream = false } = options;
 ...
 */
export function getOllamaEndpoint(model: 'gemma3-legal:latest' | 'embeddinggemma:latest' = 'gemma3-legal:latest'): string {
