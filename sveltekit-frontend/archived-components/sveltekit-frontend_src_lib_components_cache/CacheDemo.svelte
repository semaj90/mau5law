        ...
        <NesCard>
          ...
          <div class="yorha-panel-content" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
              <button class="nes-btn" onclick={setCacheValue} disabled={$isLoading}>
                <Database class="mr-2" size={16} />
                Set Value
              </button>
              
              <button class="nes-btn" variant="outline" onclick={getCacheValue} disabled={$isLoading}>
                <RefreshCw class="mr-2" size={16} />
                Get Value
              </button>
              
              <button class="nes-btn is-error" onclick={deleteCacheValue} disabled={$isLoading}>
                <Trash2 class="mr-2" size={16} />
                Delete
              </button>
              
              <button class="nes-btn is-error" onclick={clearCache} disabled={$isLoading}>
