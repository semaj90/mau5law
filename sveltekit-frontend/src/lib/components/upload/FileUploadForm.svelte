...
import type { DrizzleTypes } from '$lib/types/enhanced-svelte5-types';
  } from 'lucide-svelte'; import { superForm } from 'sveltekit-superforms'; import { zodClient } from 'sveltekit-superforms/adapters'; interface Props { data: {
	form: any } caseId?: string}
