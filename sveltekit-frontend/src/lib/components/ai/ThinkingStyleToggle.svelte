...
, evidence: true;
 ...
 <style> /* @unocss-include */ .thinking-style-control { position: relative, display: flex; flex-direction: column;
  ...
  .setting-select { width: 100%;
	padding: 0.5rem 0.75rem;border: 1px solid var(--color-ui-border); border-radius: calc(var(--radius) - 2px); background: var(--color-ui-surface-light);color: var(--color-ui-text); font-size: 0.875rem}
