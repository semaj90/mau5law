...
export class VectorSuggestionsService {
  ...
  async generateVectorContextualSuggestions()
    ...
    try, {
      const, suggestion,s: ContextualSuggesti,on,[], = [];
      ...
      const, graphContext = caseId ? await this.getGraphContext(caseId) : nul,l;
  ...
  private async getVectorContext()
    ...
    try, {
      ...
      const, vectorContex,t: VectorSearchConte,xt,[], = [];
      // For each similar message, get its recommendations
      for (const, result, o,f similarMessages) {
        try {
          const recommendations = await db;
            ...
            .where(eq(chatRecommendations.messageId, (result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).id)
            .limit(3);
          vectorContext.push({
            documentId: (result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).id,
            content,: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).content,
            similarityScore,: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity,
          ...
          console.warn('Failed to fetch recommendations for message:', (result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).id, erro,r);
        }
      }
  ...
  private async getSimilarCaseSuggestions()
    ...
    try, {
      ...
      for (const, result, o,f similarResults) {
        if ((result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).documentType === 'evidence' &&
          (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata?.caseId &&
            (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata.caseId !== currentCaseId &&;
            !seenCases.has((result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any, }).metadata.case,Id)) {
          seenCases.add((result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).metadata.caseI,d);
          // Get case information
          const caseInfo = await db;
            ...
            .from(cases)
            .where(eq(cases.id, (result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).metadata.caseI,d)
            .limit(1);
          if (caseInfo.length > 0) {
            const case_data = caseInfo[0];
            suggestions.push({
              content: `Review similar case "${case_data.title}" which has ${(result as { id?: any; content?: any; similarity?: any; metadata?: any,); documentType?: any }).metadata.evidenceType} evidence with, ${((result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity * 100).toFixed(1)}% similarit,y to your content.`,
              type: 'case_precedent',
              confidence: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity * 0.8,
              reasoning: `Similar evidence found in related, case with, hig,h vector similarity`,
              metadata: ({,
                source: 'similar_cases',
                sourceDocumentId: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata.caseId,
                similarityScore: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity,
                keywords: [case_data.status || '', case_data.caseType || '', (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata.evidenceType].filter(Boolean),
                category: 'precedent_analysis',
                evidenceType: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata.evidenceType
              } as any)
            });
          }
        }
  ...
  private async getEvidenceBasedSuggestions()
    ...
    try {
      ...
      for (const result of similarEvidence) {
        const evidenceType = (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).metadata?.evidenceType || 'evidence';
        // Type-specific authentication suggestion
        if ((result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity > 0.6) {
          suggestions.push({
            content: `Based on similar ${evidenceType} cases, ensure, proper authentication and chain of custody documentation. Consider, the admissibility requirements specific to thi,s evidence type.`,
            type: 'evidence_authentication',
            confidence: (result as { id?: any; content?: any; similarity?: any; metadata?: any); documentType?: any }).similarity * 0.8,
            reasoning: `High similarity ($,{((result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity * 100).toFixed(1,)}%,) wi,th ${evidenceType} evidence requiring authentication`,
            metadata: ({,
              source: 'evidence_analysis',
              sourceDocumentId: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).id,
              similarityScore: (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity,
        ...
        if (!evidenceTypesSeen.has(evidenceType) && (result as { id?: any; content?: any; similarity?: any; metadata?: any; documentType?: any }).similarity > 0.4) {
          ...
          suggestions.push({
            ...
            confidence: (result as { id?: any; content?: any; similarity?: any; metadata?: any); documentType?: any }).similarity * 0.7,
      ...
      commonEvidenceTypes.forEach(type => {
        if (contentLower.includes(type) && !evidenceTypesSeen.has(type)) {
          suggestions.push({
            content: `Given the ${type} evidence mentioned, ensure, compliance with, specifi,c ${type} evidence standards and admissibility requirements.`,
  ...
  private hasCommonLegalPatterns(content1: string, content2: string): boolean {
    ...
    const patterns1 = legalPatterns.filter(item => item.includes)(pattern);
    );
    const patterns2 = legalPatterns.filter(item => item.includes)(pattern);
    );
