...
export function setupWebSocketServer(server: unknown) {
...
function handleWebSocketMessage(caseId: string, message: unknown, sender: unknown, user: unknown) {
  switch (message.type) {
...
function broadcastToCase(caseId: string, message: unknown, excludeConnection?: unknown) {
