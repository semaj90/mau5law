...
| { type: 'LOGIN';
  ...
  | { type: 'LOGOUT' }
  | { type: 'START_WORKFLOW';
	workflowType: 'case_creation' | 'evidence_processing' | 'document_review' | 'collaboration' | 'case_closure'; data?: any }
  ...
  | { type: 'UPDATE_PREFERENCES';
	preferences: Partial<UserWorkflowContext['preferences']> }
  | { type: 'ERROR';
	error: string }
  | { type: 'RETRY' }
  | { type: 'RESET' };
