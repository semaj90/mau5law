...
import type { embedText  } from '$lib/server/services/vectorDBService'; // Changed from generateEmbedding to embedText
import type { redis  } from '$lib/server/cache/redis'; // For caching
