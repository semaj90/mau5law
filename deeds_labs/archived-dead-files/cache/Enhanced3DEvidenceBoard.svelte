...
z: 500 }); rotation.set({ x: 0, y: 0 })}
  ...
  .control-panel { position: absolute; top: 1rem; right: 1rem; background: rgba(0, 0, 0, 0.8); border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 8px; padding: 1rem; min-width: 200px; backdrop-filter: blur(8px); }
  ...
  .stats { display: flex; flex-direction: column; gap: 0.25rem; }
  .stat { display: flex; justify-content: space-between; font-size: 0.8rem; color: rgba(255, 255, 255, 0.7); }
  .value { color: #8a2be2; font-weight: bold; }
  .control-btn { display: block; width: 100%; margin: 0.25rem 0; padding: 0.5rem; background: rgba(138, 43, 226, 0.2); border: 1px solid rgba(138, 43, 226, 0.5); border-radius: 4px; color: #fff; font-size: 0.8rem; cursor: pointer; transition: all 0.2s ease; }
  ...
  .stat-item { display: flex; align-items: center; gap: 1rem; margin: 0.75rem 0; }
  ...
  .connection-item { display: flex; align-items: center; gap: 0.5rem; padding: 0.5rem; border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 4px; margin: 0.5rem 0; }
