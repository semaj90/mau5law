/** * Enhanced Environment Variables Type Definitions * Fixes: "$env /dynamic/private" module resolution issues */ // SvelteKit environment modules declare module '$env /dynamic/private' { export const env: { process.env.QDRANT_URL?: string; process.env.OLLAMA_URL?: string; ENHANCED_RAG_MAX_RESULTS?: string; ENHANCED_RAG_CONFIDENCE?: string; ENHANCED_RAG_CLUSTERING?: string; ENHANCED_RAG_CACHING?: string; ENHANCED_RAG_CACHE_THRESHOLD?: string; ENHANCED_RAG_WORKERS?: string; ENHANCED_RAG_MAX_CONCURRENT?: string; ENHANCED_RAG_PRECACHING?: string; process.env.DATABASE_URL?: string; POSTGRES_URL?: string; REDIS_URL?: string; NEO4J_URL?: string; NEO4J_USERNAME?: string; NEO4J_PASSWORD?: string; MINIO_URL?: string; MINIO_ACCESS_KEY?: string; MINIO_SECRET_KEY?: string; MINIO_BUCKET_LEGAL_DOCUMENTS?: string; JWT_SECRET?: string; OPENAI_API_KEY?: string; ANTHROPIC_API_KEY?: string; GOOGLE_API_KEY?: string; NODE_ENV?: string; SUPABASE_URL?: string; SUPABASE_ANON_KEY?: string; [key: string]: string | undefined}
