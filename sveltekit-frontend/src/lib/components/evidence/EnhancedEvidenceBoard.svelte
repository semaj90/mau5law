...
interface SearchSuggestion { text: string, type: 'case' | 'law' | 'evidence' | 'precedent'; confidence: number; source: string, reasoning?: string}
 ...
 <button class="nes-btn" onclick={ confirmDelete }>Delete</button> </div> </div> {/if}
  ...
  .evidence-canvas-container { background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%); border-radius: 12px; padding: 20px; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04), inset, 0 1px, 0 rgba(255, 255, 255, 0.1): 2px solid rgba(59, 130, 246, 0.2); position: relative;overflow: hidden}
