 ...
 * Uses gemma3-legal:latest for legal document summarization
 * Integrates with EmbeddingGemma for language detection
 *
 * This is a simplified endpoint for the VS Code svelte-check task
 */
...
const DEFAULT_MODEL = 'gemma3-legal:latest';
