...
const meta = {
  title: 'UI/Enhanced/Button', component: Button;
  parameters: { layout: 'centered', docs: { description: { component: 'Enhanced button component with multiple variants and states for the Legal AI Platform'
       }
     }
  }, argTypes: { variant: { control: { type: 'select' }, options: ['default', 'legal', 'evidence', 'case', 'destructive', 'ghost', 'outline']
    }, size: { control: { type: 'select' }, options: ['sm', 'default', 'lg', 'xl']
    }, disabled: { control: { type: 'boolean'  }
    }, loading: { control: { type: 'boolean'  }
    }, fullWidth: { control: { type: 'boolean' }, description: 'Make button full width'
     }
  }, tags: ['autodocs']
...
export const ExtraLarge: Story = { args: {
     'Extra Large', size: 'xl'
   }
};
