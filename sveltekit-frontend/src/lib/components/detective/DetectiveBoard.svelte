...
// App stores & Services
import { evidenceStore, aiAssistant } from '/stores/unified';
import AIAssistantPanel from \"../ai/AIAssistantPanel.svelte\";
import EvidenceCard from \"./EvidenceCard.svelte\";
import UploadZone from \"./UploadZone.svelte\";
import { analyzeEvidence, findEvidenceConnections } from '/ai/ai-service';
import { rabbitMQService } from '/services/rabbitmq-service';
import { VectorService } from '/services/vector-service';
import { gpuAccelerationService as gpuService } from '/services/gpu-acceleration-service';
...
<div class=\"w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-3xl\">🕵️</div>
<div>
