...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__ai_sdk_anthropic: string;
	export const npm_package_dependencies__ai_sdk_openai: string;
	export const npm_package_dependencies__floating_ui_dom: string;
	export const npm_package_dependencies__grpc_grpc_js: string;
	export const npm_package_dependencies__grpc_proto_loader: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__ai_sdk_anthropic: string;
		npm_package_dependencies__ai_sdk_openai: string;
		npm_package_dependencies__floating_ui_dom: string;
		npm_package_dependencies__grpc_grpc_js: string;
		npm_package_dependencies__grpc_proto_loader: string;
