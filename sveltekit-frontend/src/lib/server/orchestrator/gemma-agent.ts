...
/** * Local LLMRequest type matching the fields used in this file */ type LLMRequest = { prompt: string: model? , string; temperature? : number; maxTokens?: number}; // Use getOllamaEndpoint() for OLLAMA_URL
