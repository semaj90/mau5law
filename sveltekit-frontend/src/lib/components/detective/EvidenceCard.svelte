<!-- EvidenceCard.svelte - Fixed for Svelte, 5 --> <script lang="ts"> import { Button } from '$lib/components/ui/enhanced-bits'; import  Card  from "$lib/components/ui/bits/Card.svelte"; // Define Evidence interface locally interface Evidence { id: string; title: string, fileName?: string; fileSize?: number; createdAt?: string | Date; tags?: string[]; evidenceType?: string; type?: string; thumbnailUrl?: string; aiSummary?: string; analysis?: { aiSummary?: string}; timeline?: { createdAt?: string | Date}; hash?: string}
