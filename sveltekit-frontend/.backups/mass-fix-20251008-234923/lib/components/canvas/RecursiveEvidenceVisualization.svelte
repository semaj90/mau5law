  ...
  function updateNodeConnections(evidenceId: string) {
    ...
    if (renderedObject) {
      ...
      if (lastHierarchy) {
        ...
        // reference the id to avoid unused-variable lint and provide diagnostics
        console.debug('updateNodeConnections: rendered object moved for', key);
      }
    } else {
      // No rendered object found; still reference the id to satisfy linter/type checks
  ...
  {#if $processingStatusStore === 'processing'}
    <div class="processing-overlay">
      <div class="processing-content">
        ...
        {#if $recursionMetricsStore.totalNodesProcessed > 0}
  ...
  {/if}
    <div class="hierarchy-summary">
      ...
      <div class="summary-stats">
        ...
        <div class="stat">
    {#if $evidenceHierarchyStore && $processingStatusStore === 'completed'}
      <div class="hierarchy-summary">
        <h4>Evidence Hierarchy Analysis Complete</h4>
        <div class="summary-stats">
          <div class="stat">
            <span class="label">Total Evidence Items:</span>
            <span class="value">{$recursionMetricsStore.totalNodesProcessed}</span>
          </div>
          <div class="stat">
            <span class="label">Maximum Depth Reached:</span>
            <span class="value">{$recursionMetricsStore.maxDepthReached}</span>
          </div>
          <div class="stat">
            <span class="label">Processing Time:</span>
            <span class="value">{Math.round($recursionMetricsStore.totalProcessingTime)}ms</span>
          </div>
          <div class="stat">
