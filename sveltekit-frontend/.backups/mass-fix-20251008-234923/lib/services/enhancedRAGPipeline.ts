...
import { aiAutoTaggingService } from './ai-auto-tagging-service.js';
...
class EnhancedRAGPipeline {
  ...
  private async retrieveDocuments()
    ...
    const, source,s: RAGSour,ce,[], = [];
    // 1. Semantic search with embeddings
    if (options,.useSemanticSearc,h) {
      ...
      sources.push();
        ...semanticResults.map((result) => ({
          id: String((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any,); response?: any }).id),
          title,: String((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: an,y); response?: any }).title),
          content: String((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any,); response?: any }).description || ","),
          relevance: Number((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any,); response?: any }).similarity),
    ...
    if (this.fuseIndex) {
      ...
      sources.push();
        ...fuseResults.map((result) => ({
          id: (result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any; response?: any }).item.id,
          title: (result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any; response?: any }).item.title,
          content: (result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any; response?: any }).item.content,
          relevance: 1 - ((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any; response?: any }).score || 0),
          type: (result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any; response?: any }).item.type || "document"
        })
      );
    }
   ...
   */;
  private calculateRelevanceScore(source,: RAGSource, quer,y: strin,g): number {
  ...
  "suggestedActions": ["Review contract terms", "Consult precedent cases"]
    ...
    try {
      ...
      if (!(response as { ok?: any; statusText?: any; json?: any }).ok) {
        throw new Error(`Ollama generation failed: ${(response as { ok?: any; statusText?: any,); json?: any }).statusText}`);
      }
      const result = await (response as { ok?: any; statusText?: any; json?: any }).json();
      const parsed = JSON.parse((result as { id?: any; title?: any; description?: any; similarity?: any; item?: any; score?: any); response?: any }).response);
