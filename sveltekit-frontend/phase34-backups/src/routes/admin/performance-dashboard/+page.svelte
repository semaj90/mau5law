...
<svelte:head><title>Legal AI Performance Dashboard</title></svelte:head>
<div class="min-h-screen bg-black text-green-400 font-mono">
  <!-- Header -->
  <div class="border-b border-green-500 pb-4">
    <h1 class="text-2xl font-bold">Legal AI Performance Dashboard</h1>
    <p class="text-sm">Gemma3:legal-latest + RTX, 3060 Ti Monitoring</p>
  </div>
  <!-- System, Health, Overview -->
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    <!-- System, Health -->
    <div class="border border-green-500 rounded">
      <h3 class="text-sm font-semibold text-green-300">System Health</h3>
      <div class="text-xl">{$systemHealth.toUpperCase()}</div>
      <div class="text-xs text-green-600">Overall system status</div>
    </div>
    <!-- Cache, Efficiency -->
    <div class="border border-green-500 rounded">
      <h3 class="text-sm font-semibold text-green-300">Cache Efficiency</h3>
      <div class="text-xl">{formatMetric($cacheEfficiency, 'percentage')}</div>
      <div class="text-xs text-green-600">Multi-tier hit rate</div>
    </div>
    <!-- Average, Latency -->
    <div class="border border-green-500 rounded">
      <h3 class="text-sm font-semibold text-green-300">Query Latency</h3>
      <div class="text-xl">{formatMetric($averageLatency, 'milliseconds')}</div>
      <div class="text-xs text-green-600">Average response time</div>
    </div>
    <!-- GPU, Utilization -->
    <div class="border border-green-500 rounded">
      <h3 class="text-sm font-semibold text-green-300">GPU Utilization</h3>
      <div class="text-xl">{formatMetric($gpuUtilization / 100, 'percentage')}</div>
      <div class="text-xs text-green-600">RTX, 3060 Ti usage</div>
    </div>
  </div>
  {#if $currentMetrics}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <!-- Cache, Performance -->
      <div class="border border-green-500 rounded">
        <h3 class="text-lg font-semibold text-green-300">Cache Performance</h3>
        <div class="space-y-3">
          <div class="flex">
      ...
      <!-- Latency, Breakdown -->
      <div class="border border-green-500 rounded">
        <h3 class="text-lg font-semibold text-green-300">Latency Breakdown</h3>
        <div class="space-y-3">
          <div class="flex">
      ...
      <!-- Resource, Usage -->
      <div class="border border-green-500 rounded">
        <h3 class="text-lg font-semibold text-green-300">Resource Usage</h3>
        <div class="space-y-3">
          <div class="flex">
      ...
      <div class="border border-green-500 rounded">
        <h3 class="text-lg font-semibold text-green-300">Legal Processing</h3>
        <div class="space-y-3">
          <div class="flex">
    ...
    <div class="border border-green-500 rounded p-4">
      <h3 class="text-lg font-semibold text-green-300">Throughput Metrics</h3>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.queries_per_second, 'count')}</div>
          <div class="text-xs">QPS</div>
        </div>
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.embeddings_per_second, 'count')}</div>
          <div class="text-xs">Embeddings/sec</div>
        </div>
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.documents_per_minute, 'count')}</div>
          <div class="text-xs">Docs/min</div>
        </div>
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.concurrent_sessions, 'count')}</div>
          <div class="text-xs">Sessions</div>
        </div>
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.peak_throughput, 'count')}</div>
          <div class="text-xs">Peak QPS</div>
        </div>
        <div class="text-center">
          <div class="text-xl font-bold">{formatMetric($currentMetrics.throughput.average_batch_size, 'count')}</div>
          <div class="text-xs">Batch Size</div>
        </div>
      </div>
    </div>
  {/if}
  ...
  <div class="border border-green-500 rounded">
    <h3 class="text-lg font-semibold text-green-300">Recent Performance History (Last, 10 minutes)</h3>
  ...
  <!-- Footer -->
  <div class="mt-8 pt-4 border-t border-green-500 text-center text-xs">
