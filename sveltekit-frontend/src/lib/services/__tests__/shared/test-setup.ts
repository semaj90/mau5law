// src/lib/services/__tests__/shared/test-setup.ts
/**
 * Global Test Setup
 *
...
beforeAll(async () => {
  ...
  const envVars = TestConfigHelpers.getTestEnvVars('global');
  restoreEnvVars = UnifiedTestUtils.mockEnvVars(envVars);
