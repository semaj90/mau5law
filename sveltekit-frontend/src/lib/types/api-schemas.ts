...
export function isAPIResponse<T>(obj: unknown): obj is APIResponse<T> {
    ...
    return (
        typeof o.success === 'boolean' && 'data' in o && !!meta && typeof meta.timestamp === 'string' && typeof meta.cached === 'boolean' && (meta.source === 'ssr' || meta.source === 'api')
    );
}
export function isUser(obj: any): obj is User {
    ...
    const o = obj as Record<string, unknown>;
    return (
        typeof o.id === 'string' && typeof o.email === 'string' && typeof o.firstName === 'string' && typeof o.lastName === 'string' && typeof o.role === 'string' && Array.isArray(o.practiceAreas) && Array.isArray(o.permissions)
    );
}
export function isCase(obj: any): obj is Case {
    ...
    const o = obj as Record<string, unknown>;
    return (
        typeof o.id === 'string' && typeof o.title === 'string' && typeof o.status === 'string' && typeof o.priority === 'string' && typeof o.createdBy === 'string' && Array.isArray(o.tags)
    );
}
export function isEvidence(obj: any): obj is Evidence {
    ...
    const o = obj as Record<string, unknown>;
    return (
        typeof o.id === 'string' && typeof o.caseId === 'string' && typeof o.title === 'string' && typeof o.type === 'string' && typeof o.createdBy === 'string' && Array.isArray(o.chainOfCustody) && Array.isArray(o.tags)
    );
}
