<!-- All Routes Explorer - Comprehensive Legal AI Platform Route Analysis Integrates with Gemma Embeddings Vector Architecture for route, categorization -->
<script lang="ts">
...
<div class="container mx-auto p-6">
  <header class="text-center">
    ...
    <p class="text-gray-600">Comprehensive routing analysis for the Gemma Embeddings Vector Architecture</p>
  </header>
  ...
  {#if isLoaded}
    ...
    {#if showStats}
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 border-2 border-emerald-300 rounded-lg">
            <h3 class="font-bold text-lg text-emerald-800 flex items-center">🚀 Production Ready</h3>
            <p class="text-3xl font-bold">{routeStats.byPriority.production}</p>
            <p class="text-sm">Core + APIs</p>
          </div>
          <div class="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 rounded-lg">
          ...
          <div class="bg-gradient-to-br from-pink-50 to-pink-100 border-2 border-pink-300 rounded-lg">
          ...
          <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 border-2 border-indigo-300 rounded-lg">
    ...
    <div class="bg-white rounded-lg border-2 border-gray-200 p-6">
      <div class="flex flex-col lg:flex-row">
        <!-- Search -->
        <div class="flex-1">
          <label for="search-routes" class="block text-sm font-medium text-gray-700">🔍 Search Routes</label>
          <input
            type="text"
            id="search-routes"
        ...
        <!-- Section, Filter -->
        <div class="lg:w-48">
          <label for="section-filter" class="block text-sm font-medium text-gray-700">📂 Section</label>
          <select
            id="section-filter"
      ...
      <div class="mt-4">
        <span id="quick-filters-label" class="block text-sm font-medium text-gray-700">⚡ Quick Filters</span>
    ...
    {#if showSSRTest}
      <Card class="mb-6 bg-gradient-to-r from-purple-50 to-indigo-50 border-2">
        {#snippet children()}
          <CardContent class="p-4">
            <h3 class="text-lg font-bold text-purple-800 mb-2 flex items-center">🧪 SSR UI Components Test</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="bg-white/50 rounded">
                <strong>SSR Benefits:</strong> <br />• Faster first paint <br />• Better SEO <br />• Improved
                accessibility
              </div>
              <div class="bg-white/50 rounded">
                <strong>Flexbox Layout:</strong> <br />• Responsive columns <br />• Equal height cards <br />• Automatic
                wrapping
              </div>
              <div class="bg-white/50 rounded">
                <strong>Component Tests:</strong> <br />• Card components <br />• Typography rendering <br />• Icon
                display
              </div>
            </div>
          </CardContent>
    ...
    {#if layoutMode === 'flexbox' && !showClustered}
      <div class="ssr-flexbox-container flex flex-wrap">
        {#each filteredRoutes() as route, index}
          ...
          >
            <Card class="ssr-card {columnClass} min-w-80 max-w-none group">
              {#snippet children()}
                <CardHeader>
                  {#snippet children()}
                ...
                <CardContent>
                  {#snippet children()}
                    ...
                    <div class="flex flex-wrap">
                      <span class="px-2 py-1 rounded-full text-xs {cls.bg100}">
                        {categoryInfo.name}
                      </span>
                    </div>
                  {/snippet}
    ...
    <div class="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg">
