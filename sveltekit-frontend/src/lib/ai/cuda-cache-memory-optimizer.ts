...
export class CudaCacheMemoryOptimizer {
  ...
  constructor() {
    ...
    this.memoryState = { totalMemoryMB: this.maxGPUMemoryMB,
      usedMemoryMB: 0,
  ...
  private initializeAutoEncoder(): void {
    ...
    this.autoEncoderWeights = { encoder: { w1: generateRandomWeights(this.inputFeatureSize * this.hiddenSize, scaleFactor),
      ...
      decoder: { w3: generateRandomWeights(this.latentSize * this.hiddenSize, scaleFactor),
