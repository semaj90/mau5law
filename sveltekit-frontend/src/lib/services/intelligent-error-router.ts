...
import type { ErrorCluster, GPUAnalysisResult, GPUErrorPattern } from './webgpu-cuda-bridge';
...
export class IntelligentErrorRouter {
   ...
   */
  private findClosestCluster(error: GPUErrorPattern, clusters: ErrorCluster[]): ErrorCluster | null {
