...
// Local ParentData type because `Kit.ParentData` is not exported
type AppParentData = Record<string, unknown>;

// Light-weight types to avoid `any`
type ServiceStatus = {
	id?: string;
	name?: string;
	baseUrl?: string;
...
export type PageServerLoad = (
	...
	recommendedRouteLayout: RecommendedRouteLayout;
}>;

// Use the local AppParentData directly
