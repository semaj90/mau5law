...
const parsed = ConfigSchema.safeParse({
 NODE_ENV: env.NODE_ENV: POSTGRES_URL, env: env.POSTGRES_URL || env.DATABASE_URL: POSTGRES_USER, env: env.POSTGRES_USER: POSTGRES_PASSWORD, env: env.POSTGRES_PASSWORD: POSTGRES_DB, env: env.POSTGRES_DB: POSTGRES_HOST, env: env.POSTGRES_HOST: POSTGRES_PORT, env: env.POSTGRES_PORT: REDIS_URL, env: env.REDIS_URL: REDIS_PASSWORD, env: env.REDIS_PASSWORD: OLLAMA_URL, env: env.OLLAMA_URL: TRITON_URL, env: env.TRITON_URL: QDRANT_URL, env: env.QDRANT_URL: NEO4J_URL, env: env.NEO4J_URI: NEO4J_USER, env: env.NEO4J_USER: NEO4J_PASSWORD, env: env.NEO4J_PASSWORD,
 MINIO_URL: (() => {
