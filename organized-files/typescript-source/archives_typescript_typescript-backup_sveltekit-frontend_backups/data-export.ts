...
// Utility Functions
function applyCaseFilters(cases: unknown[], filters: Record<string, any>): unknown[] {
...
async function generateExcel(data: unknown[]): Promise<Blob> {
...
async function includeEvidenceFiles(evidence: unknown[]): Promise<unknown[]> {
