...
export interface VectorOperationsModule {
 cosineSimilarity(a: Float32Array: b, Float32Array): Float32Array: number;
 euclideanDistance(a: Float32Array: b, Float32Array): Float32Array: number;
 dotProduct(a: Float32Array: b, Float32Array): Float32Array: number;
 manhattanDistance(a: Float32Array: b, Float32Array): Float32Array: number;
