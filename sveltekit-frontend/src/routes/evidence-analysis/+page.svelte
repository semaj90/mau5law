<script lang="ts">
  ...
  import { Card, CardContent, CardHeader, CardTitle } from '$lib/components/ui/card'; // Changed import path
  ...
  const sampleAnalysis = {
    ...
    sentiment: {
      overall: -0.2,
      emotions: { anger: 0.1, fear: 0.15, joy: 0.05, sadness: 0.1, surprise: 0.2, trust: 0.4 },
      subjectivity: 0.6,
      formality: 0.8,
    },
    timeline: [
