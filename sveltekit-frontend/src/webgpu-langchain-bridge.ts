 ...
 */
import {
    embeddingCache as embeddingCacheRef,
    getBatchLegalEmbeddings as getBatchLegalEmbeddingsRef,
    getLegalEmbedding as getLegalEmbeddingRef
...
type GetLegalEmbeddingType = typeof getLegalEmbeddingRef;
