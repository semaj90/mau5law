...
import { pgTable, vector, index, text, uuid, timestamp, jsonb, integer, real } from "drizzle-orm/pg-core";
...
export const documentEmbeddings = pgTable("document_embeddings", {
  ...
  embeddingIdx: index("idx_embedding_ivfflat").using("ivfflat", table.embedding.op("vector_cosine_ops")),
  // Regular indexes
...
export const searchQueries = pgTable("search_queries", {
  ...
  queryEmbeddingIdx: index("idx_query_embedding").using("ivfflat", table.queryEmbedding.op("vector_cosine_ops")),
