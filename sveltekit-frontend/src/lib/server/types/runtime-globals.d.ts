...
declare const ollamaService: unknown;
declare const aiPipeline: unknown;
declare const enhancedRAGPipeline: unknown;
declare const enhancedRAGPipelineService: unknown;
declare const enhancedRAG: unknown;
...
declare const nomicEmbeddings: unknown;
declare const comprehensiveCachingService: unknown;
declare const comprehensiveCaching: unknown;
...
declare const hashPasswords: unknown;
declare const createHash: unknown;
declare const randomUUID: unknown;
declare const inArray: unknown;
declare const reports: unknown;
declare const legalAnalysisSessions: unknown;
declare const legalPrecedents: unknown;
declare const chatMessages: unknown;
declare const librarySyncServiceEnabled: unknown;
declare const enhanced_db: unknown;
declare const db: unknown;

// Helpers commonly used from drizzle/orm modules
declare const desc: unknown;
