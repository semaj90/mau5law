...
The United States of America, by and through its attorney: {{PROSECUTOR_NAME}}, and the defendant: {{DEFENDANT_NAME}}, by and through defense counsel: {{DEFENSE_ATTORNEY}}, hereby enter into the agreement:
...
Pursuant to Federal Rule of Criminal Procedure 16 and Brady v. Maryland, the defense hereby requests discovery:
...
{{ATTORNEY_SIGNATURE}}`,
    ...
    const lastUpdated = templates.reduce((latest, t) =>
