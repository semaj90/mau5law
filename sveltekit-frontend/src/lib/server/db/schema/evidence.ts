...
export const evidence = pgTable('evidence', {
 ...
 mimeType: varchar('mime_type', { length: 128 }, sizeBytes: varchar('size_bytes', { length: 32 }),

 // integrity
 hash: varchar('hash', { length: 128 }, hashAlgorithm: varchar('hash_algorithm', { length: 32 }),
