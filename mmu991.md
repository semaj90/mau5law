...
// Create both indexes for maximum flexibility
POST /api/ai/vector-index
{
  "vectorIndexAlgorithm": "both",           // Creates both IVF_FLAT + HNSW
  "table": "document_embeddings",
  "column": "gemma_embedding",
  "lists": 100,                             // IVF_FLAT parameter
  "m": 16,                                  // HNSW max connections
  "efConstruction": 64                      // HNSW construction parameter
}

// Query performance analysis
GET /api/ai/vector-index?type=traditional
// Returns both algorithm statistics and performance recommendations