...
<style>
	...
	.user-insights-badge { display: flex;
		gap: 1rem;
		font-size: 0.875rem;}

	.expertise-level { background: #dbeafe;
		color: #2563eb;
		padding: 0.25rem 0.75rem;
		border-radius: 1rem;
		text-transform: capitalize;}

	.engagement-score { background: #dcfce7;
		color: #16a34a;
		padding: 0.25rem 0.75rem;
		border-radius: 1rem;}
	...
	.file-drop-zone.drag-over { border-color: #3b82f6;
	background: #eff6ff;}
	.file-drop-zone.has-files { border-color: #10b981;
	background: #f0fdf4;}

	.drop-zone-content { display: flex; flex-direction: column; align-items: center;
	gap: 1rem;}
	.upload-icon { font-size: 3rem;}
	.file-constraints { font-size: 0.875rem;
	color: #6b7280;}
	...
	.file-size, .file-type { font-size: 0.75rem;
	color: #6b7280;}
	...
	.upload-progress { background: #f9fafb;
		padding: 1.5rem;
		border-radius: 0.75rem;
		margin-bottom: 2rem;}
	...
	.pipeline-stage.active { border-color: #3b82f6;
	background: #eff6ff;}
	.pipeline-stage.completed { border-color: #10b981;
	background: #f0fdf4;}
	...
	.error-section h3 { margin: 0 0 1rem 0;
		color: #dc2626;}
