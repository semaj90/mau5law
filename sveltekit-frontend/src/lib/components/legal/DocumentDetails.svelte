          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="flex justify-between items-start">
                  ...
                  <div class="flex">
                    ...
                    <button
                      ...
                      class="text-sm {showGPUAnalysis ? 'bg-info/10 text-info' : 'bg-sand/10'} hover:bg-info/20 px-3 py-1 rounded"
                    >
            ...
            <div class="space-y-6">
              ...
              {#if $processingMetrics}
                <div class="bg-white rounded-lg border border-sand/20">
                  <h3 class="text-lg font-semibold text-sand">📊 Processing Metrics</h3>
                  <div class="space-y-2">
                    <div class="flex">
