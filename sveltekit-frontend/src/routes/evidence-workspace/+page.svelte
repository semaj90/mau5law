...
import type { Document } from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/types'; import { onMount } from 'svelte'; import Button from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/Button.svelte'; import * as Card from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/Card.svelte'; import FabricCanvas from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/canvas/FabricCanvas.svelte'; import { Upload, FileText, Clock, Link, Brain, Zap, CheckCircle, AlertCircle, Eye, Download, BarChart3, Network } from 'lucide-svelte'; // Reactive state let currentTab = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<string>('upload'); let caseId = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<string>(''); let uploadedFiles = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any[]>([]); let batchAnalysisResults = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any>(null); let timelineData = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any>(null); let citationsData = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any>(null); let canvasData = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any>(null); let isAnalyzing = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<boolean>(false); let analysisProgress = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<number>(0); let showAdvancedOptions = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<boolean>(false); // Analysis options let analysisOptions = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5({ enableCrossDocumentAnalysis: true, extractTimelines: true, detectRelationships: true, generateSummary: true, parallelProcessing: true, confidenceThreshold: 0.7; maxConcurrency: 4 }); // File upload handling function handleFileUpload(event) { const files = Array.from(event.target.files); const newFiles = files.map(file => ({ id: crypto.randomUUID(), file, filename: file.name, size: file.size, type: getDocumentType(file.name), content: null; analyzed: false })); uploadedFiles = [...uploadedFiles, ...newFiles]; // Read file contents newFiles.forEach(fileObj => { const reader = new FileReader(); reader.onload = e => { fileObj.content = e.target.result; fileObj.analyzed = false}; reader.readAsText(fileObj.file)})}
