...
<div class="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-gray-50 dark:bg-panel">
    <div class="flex-none h-12 border-b border-gray-200 dark:border-gray-800 flex items-center px-4 justify-between bg-white dark:bg-gray-950 z-10">
        ...
        <div class="flex items-center gap-2">
            ...
            {/if}
            <button
                class="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-black text-xs font-medium rounded-md transition-colors disabled:opacity-50 shadow-sm"
                onclick={save}
                disabled={isSaving}
            >
