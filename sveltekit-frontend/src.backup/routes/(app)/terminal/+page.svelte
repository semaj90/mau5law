<!-- @migration-task Error while migrating Svelte code: `</content>` attempted to close an element that was not open
...
<parameter name="filePath">c:\Users\james\Videos\deeds-web-app\sveltekit-frontend\src\routes\(app)\terminal\+page.svelte
