...
export interface POIData { id: string; caseId: string;
  name: string;
  aliases: string[];
...
export class POI { id: string; caseId: string;
  ...
  tags: Writable<string[]>; isDirty: boolean = $state(false);
  createdBy: string;
