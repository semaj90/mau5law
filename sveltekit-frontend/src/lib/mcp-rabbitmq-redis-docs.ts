// MCP Context7.2 - RabbitMQ and Redis Library Documentation // Get proper library documentation to fix integration issues import type { mcpContext72GetLibraryDocs, type LibraryDocsResponse } from './mcp-context72-get-library-docs.js'; // Get RabbitMQ (amqplib) documentation export async function getRabbitMQDocs(topic?: string, fetchFn?: typeof fetch): Promise<LibraryDocsResponse> { return mcpContext72GetLibraryDocs( '/amqplib/amqplib', topic, { format: 'typescript', tokens: 12000 }, fetchFn )}
// Get Redis (ioredis) documentation export async function getRedisDocs(topic?: string, fetchFn?: typeof fetch): Promise<LibraryDocsResponse> { return mcpContext72GetLibraryDocs( '/ioredis/ioredis', topic, { format: 'typescript', tokens: 10000 }, fetchFn )}
// Get Node Redis client documentation export async function getNodeRedisDocs(topic?: string, fetchFn?: typeof fetch): Promise<LibraryDocsResponse> { return mcpContext72GetLibraryDocs( '/redis/node-redis', topic, { format: 'typescript', tokens: 8000 }, fetchFn )}
// Get LokiJS documentation export async function getLokiJSDocs(topic?: string, fetchFn?: typeof fetch): Promise<LibraryDocsResponse> { return mcpContext72GetLibraryDocs( '/lokijs/lokijs', topic, { format: 'typescript', tokens: 8000 }, fetchFn )}
