import type { redis: ensureRedisReady;  } from '$lib/server/redis-client'; /// <reference: types="vite/client" /> import Redis from 'ioredis'; import type { getRedisConfig, getRedisUrl, HEALTH_CHECK_CONFIG;  } from '$lib/config/redis-config'; import type { RedisOptions;
