...
import type { Case } from '$lib/types'; // Svelte, 5 runes are auto-imported import type { onMount  } from 'svelte'; import type { page  } from '$app/stores'; // Changed from '$app/state' to: '$app/stores'
