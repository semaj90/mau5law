...
export const cssVars = {
  ...
  goldenXs: 'var(--golden-xs)', goldenSm: 'var(--golden-sm)', goldenMd: 'var(--golden-md)', goldenLg: 'var(--golden-lg)', goldenXl: 'var(--golden-xl)', golden2xl: 'var(--golden-2xl)', golden3xl: 'var(--golden-3xl)', // Typography
  textXs: 'var(--text-xs)', textSm: 'var(--text-sm)', textBase: 'var(--text-base)', textLg: 'var(--text-lg)', textXl: 'var(--text-xl)', text2xl: 'var(--text-2xl)', text3xl: 'var(--text-3xl)', text4xl: 'var(--text-4xl)', text5xl: 'var(--text-5xl)', // YoRHa colors
  bgPrimary: 'var(--yorha-bg-primary)', bgSecondary: 'var(--yorha-bg-secondary)', bgTertiary: 'var(--yorha-bg-tertiary)', bgCard: 'var(--yorha-bg-card)', bgHover: 'var(--yorha-bg-hover)', textPrimary: 'var(--yorha-text-primary)', textSecondary: 'var(--yorha-text-secondary)', textMuted: 'var(--yorha-text-muted)', accentGold: 'var(--yorha-accent-gold)', accentBlue: 'var(--yorha-accent-blue)', accentGreen: 'var(--yorha-accent-green)', borderPrimary: 'var(--yorha-border-primary)', borderSecondary: 'var(--yorha-border-secondary)', borderAccent: 'var(--yorha-border-accent)`  }as const;'`
