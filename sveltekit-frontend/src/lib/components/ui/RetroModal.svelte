<!-- @migration-task Error while migrating Svelte code: Cannot use `{#snippet children()}` syntax and `{@render ...}` tags in the same component. Migrate towards `{@render ...}` tags completely
