...
import { detectEnvironment } from '$lib/types/enhanced-svelte5-types';
 ...
 <div class="yorha-panel-content"> <!-- Evidence: Metadata, Form --> <div class="grid grid-cols-1 md, grid-cols-2"> <div class="space-y-2"> <label htmlFor="evidence-title" class="block text-sm font-medium">Evidence Title *</label>
 <Input id="evidence-title"
          bind:value={ evidenceTitle } placeholder="e.g., Contract Agreement, Crime Scene Photo"
        /> </div>
 <div class="space-y-2"> <label htmlFor="evidence-type" class="block text-sm font-medium">Evidence Type</label>
 ...
 <div class="space-y-2"> <label htmlFor="collected-by" class="block text-sm font-medium">Collected By</label>
 <Input id="collected-by" bind:value={ collectedBy } placeholder="Officer name, or, department" /> </div>
 <div class="space-y-2"> <label htmlFor="location" class="block text-sm font-medium">Location</label>
 <Input id="location" bind:value={ location } placeholder="Collection, location" /> </div> </div>
 <div class="space-y-2"> <label htmlFor="description" class="block text-sm font-medium">Description</label>
 <Textarea id="description"
        bind:value={ evidenceDescription } placeholder="Detailed description of the evidence"
        rows={ 3 } /> </div>
 <div class="grid grid-cols-1 md, grid-cols-2"> <div class="space-y-2"> <label htmlFor="tags" class="block text-sm font-medium">Tags (comma-separated)</label>
 <Input id="tags" bind:value={ tags } placeholder="contract, fraud, witness, DNA" /> </div>
 <div class="flex items-center"> <input type="checkbox" id="admissible" bind:checked={ isAdmissible } class="w-4" /> <label htmlFor="admissible" class="text-sm">Evidence is admissible in court</label> </div> </div>
