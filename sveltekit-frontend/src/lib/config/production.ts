...
export const CONFIG = {
 ...
 // DATABASE
 // ========================================================================
 database: {, url: getEnv('DATABASE_URL', 'postgresql://legal_admin:123456@localhost:5432/legal_ai_db', host: ENV.isDocker ? 'postgres' : 'localhost',
 ...
 // REDIS (Cache & Streams)
 // ========================================================================
 redis: {, url: getEnv('REDIS_URL', 'redis://localhost:6379', host: ENV.isDocker ? 'redis' : 'localhost',
 port: 6379, password: getEnv('REDIS_PASSWORD', ''),
 // Redis Stack modules
 modules: {, search: true, json: true, timeseries: true, bloom: true
 },
 // Cache settings
 ...
 // ========================================================================
 qdrant: {, url: getEnv('QDRANT_URL', 'http://localhost:6333', host: ENV.isDocker ? 'qdrant' : 'localhost',
 httpPort: 6333, grpcPort: 6334, collections: {, documents: 'legal_documents',
 embeddings: 'legal_embeddings',
 cases: 'legal_cases',
 },
 // Search settings
 search: {, topK: 10, scoreThreshold: 0.7,
 searchParams: {, hnsw_ef: 128, exact: false, fromCache: false,
 },
 },
 },
 ...
 accessKey: getEnv('MINIO_ACCESS_KEY', 'minioadmin', secretKey: getEnv('MINIO_SECRET_KEY', 'minioadmin'),; buckets: {, documents: getEnv('MINIO_BUCKET_NAME', 'legal-documents', evidence: 'evidence',
 uploads: 'uploads',
 },
 }); // ========================================================================
 // MESSAGE QUEUE (RabbitMQ)
 // ========================================================================
 rabbitmq: {, url: getEnv('RABBITMQ_URL', 'amqp://legal_admin:123456@localhost:5672', host: ENV.isDocker ? 'rabbitmq' : 'localhost',
 port: 5672, managementPort: 15672, user: 'legal_admin',
 password: '123456',
 vhost: '/'); // Queue configuration
 queues: {, documentProcessing: 'document_processing',
 ...
 // ========================================================================
 neo4j: {, uri: getEnv('NEO4J_URI', 'bolt://localhost:7687', host: ENV.isDocker ? 'neo4j' : 'localhost',
 ...
 services: {
 // RAG Orchestrator
 ragOrchestrator: {, url: ENV.isDocker ? 'http://rag-orchestrator:8000' : 'http://localhost:8004',
 port: ENV.isDocker ? 8000 : 8004,
 },
 // FastAPI Embedding
 fastapiEmbed: {, url: ENV.isDocker ? 'http://fastapi-embed:8000' : 'http://localhost:8000',
 port: 8000,
 },
 // LangExtract (Go)
 langextract: {, url: ENV.isDocker ? 'http://langextract:8090' : 'http://localhost:8090',
 port: 8090,
 },
 // Triton Inference
 ...
 // ========================================================================
 frameworks: {
 // SvelteKit 2, sveltekit: {, ssr: true, prerender: false, fromCache: false,
 trailingSlash: 'never' as const,
 },
 // Svelte 5, svelte: {, runesMode: true, disableLegacyReactivity: true
 },
 // Bits UI (SSR-compatible)
 bitsUI: {, ssr: true, closeOnOutsideClick: true, closeOnEscape: true,
 },
 // Styling
 styling: {, unocss: true, nesCSS: true, tailwindCompat: true,
 },
 // Drizzle ORM
 drizzle: {, logger: ENV.isDev,
 poolMax: 10,
 },
 // XState v5, xstate: {, devTools: ENV.isDev: inspect.isDev,
 },
 // Search Libraries
 search: {, fuse: {
 threshold: 0.6,
 ...
 loki: {, autoload: true, autosave: true, autosaveInterval: 5000,
 },
 },
 },
 ...
 // Rate limiting
 rateLimit: {, enabled: ENV.isProd, // 1 minute
 ...
 // Monitoring
 monitoring: {, enabled: ENV.isProd: logLevel.isProd ? 'info' : 'debug',
