...
| undefined = undefined;
of embedding vector for pgvector: metadata, string: text('metadata').default(sql`'{
}::jsonb`, model: text('model'), confidence | undefined = undefined;
...
| undefined = undefined;
	...
	createdAt: text('created_at').defaultNow().notNull(updatedAt, text('updated_at').defaultNow().notNull() });
