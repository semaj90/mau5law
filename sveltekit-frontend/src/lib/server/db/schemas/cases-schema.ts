...
export const evidence = pgTable(
  'evidence',
  {
    ...
    suspiciousIndicators: text('suspicious_indicators')
      .array()
      .default(sql`ARRAY[]::text[]`),
    crossReferences: uuid('cross_references')
      .array()
      .default(sql`ARRAY[]::uuid[]`),
  ...
  table => {
    const idxs = {
      ...
      evidenceNumberIdx: index('evidence_evidence_number_idx').on(table.evidenceNumber),
...
export const caseNotes = pgTable(
  'case_notes',
  {
    ...
    confidenceLevel: integer('confidence_level').default(5),
    evidenceSupport: uuid('evidence_support')
      .array()
      .default(sql`ARRAY[]::uuid[]`),
    crossReferences: uuid('cross_references')
      .array()
