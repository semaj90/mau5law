<!--
  Recursive Evidence Node Component - Svelte 5 Implementation
  Self-importing component for displaying evidence hierarchy
...
>
  {#if isCircular}
    ...
    <div class="circular-warning">
      ...
      <div class="warning-content">
        <h5>Circular Reference Detected</h5>
  ...
  {:else if isMaxDepth}
    ...
    <div class="max-depth-warning">
      ...
      <div class="warning-content">
        <h5>Maximum Analysis Depth Reached</h5>
              ...
              {#each evidence.chainOfCustody.slice(0, 3) as entry}
                <div class="chain-entry">
                  <div class="entry-info">
                    ...
                    <span class="action">{entry.action || 'No action recorded'}</span>
                  </div>
            ...
            {#each evidence.relationships.slice(0, 3) as relationship}
              <div class="relationship-item">
                ...
                <div class="relationship-info">
                  ...
                  <span class="relationship-strength" title="Relationship strength">
                    {Math.round(relationship.strength * 100)}% strength
                  </span>
                  <span class="relationship-significance {relationship.legalSignificance}">
                    {relationship.legalSignificance}
                  </span>
                </div>
              </div>
            {/each}
