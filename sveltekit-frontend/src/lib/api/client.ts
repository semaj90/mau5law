...
export const api = { cases: { list: (params: RequestOf<CaseAPI.List>) => apiClient.listCases(params),
  ...
  evidence: { list: (params: RequestOf<EvidenceAPI.List>) => apiClient.listEvidence(params),
  ...
  health: { check: (detailed = false) => apiClient.healthCheck(detailed),
