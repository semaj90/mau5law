...
color: #f0f6fc;
 ...
 .global-search::before { content: ''; position: fixed;
 top: 0;
left: 0;
 width: 100%;
height: 100%;
...
margin: 0;
 ...
 .status-indicator.active { background: #10b981; color: #0d1117;
 box-shadow: 0 0 10px rgba(16, 185, 129, 0.3);
 }

 .status-indicator.inactive { background: #6b7280; color: #f9fafb;
 }
...
padding: 1rem;
 ...
 .search-input-container { display: flex; gap: 0.5rem;
 }

 .search-input { flex: 1; padding: 0.75rem;
 background: rgba(30, 41, 59, 0.8);
 border: 1px solid #6b7280;
 border-radius: 4px;
color: #f0f6fc;
...
cursor: pointer;
 ...
 .loading-spinner { display: inline-block; width: 16px;
 height: 16px;
...
margin: 0 0 1rem 0;
 ...
 .result-item { display: flex; gap: 1rem;
 padding: 1rem;
...
margin: 0;
 ...
 .result-meta { display: flex; gap: 0.75rem;
 font-size: 0.75rem;
 }
...
transition: all 0.3s ease;
 ...
 .action-btn.ghost { background: transparent; color: #10b981;
