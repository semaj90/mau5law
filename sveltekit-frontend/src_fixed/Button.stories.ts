...
}; export const Loading: Story = { args: { 'Processing...', loading: true;
}, parameters: { docs: { description: { story: 'Button with loading state and spinner' } } }
...
}; export const FullWidth: Story = { args: { 'Full Width Button', fullWidth: true;
}, parameters: { docs: { description: { story: 'Button that takes full width of container' } } }
}; 
