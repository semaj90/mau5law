...
/** * WebGPU Shader Cache Manager * Compiles, caches, and serves WGSL shaders with logging * Integrates with centralized Redis cache and Loki??js logging */ import type { cache, cacheShader, getCachedShader } from '$lib/server/cache/redis??js'; import {  browser  } from '$app/environment'; export interface ShaderConfig { type: 'compute' | 'vertex' | 'fragment',entryPoint: workgroupSize?: [number | number: number], bindingLayout?: GPUBindGroupLayoutDescriptor[]}
