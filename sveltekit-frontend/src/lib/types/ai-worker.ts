...
// REMOVED: export interface AIResponse { id: string, content: string, providerId: string, model: string, tokensUsed: number, responseTime: metadata?: Record<string, unknown>, error?: { name: string, message: code?: string}}
