...
describe('GET /api/routes/:routePath/error-brain-analyses', () => {
	...
	it('should cap limit at 100', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?limit=500'
		);
	...
	it('should handle large offset', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?offset=10000'
		);
	...
	it('should handle special characters in route path', async () => {
		const url = new URL(
			'http://localhost/api/routes/my-special-route-[id]/error-brain-analyses'
		);
	...
	it('should handle non-numeric limit', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?limit=abc'
		);
		const limit = url.searchParams.get('limit');
	...
	it('should handle non-numeric offset', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?offset=xyz'
		);
		const offset = url.searchParams.get('offset');
	...
	it('should handle negative limit', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?limit=-10'
		);
		const limit = parseInt(url.searchParams.get('limit')!);
	...
	it('should handle negative offset', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?offset=-5'
		);
		const offset = parseInt(url.searchParams.get('offset')!);
	...
	it('should preserve route path with slashes', async () => {
		const url = new URL(
			'http://localhost/api/routes/cases/[id]/overview/error-brain-analyses'
		);
	...
	it('should handle route path with query-like characters', async () => {
		const url = new URL(
			'http://localhost/api/routes/route?test=1/error-brain-analyses?limit=10'
		);
	...
	it('should handle float limit values', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?limit=10.5'
		);
	...
	it('should handle float offset values', async () => {
		const url = new URL(
			'http://localhost/api/routes/test-route/error-brain-analyses?offset=5.7'
		);
