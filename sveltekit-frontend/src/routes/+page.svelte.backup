<script lang="ts">
  ...
  let demoRoutes = $state([
    // AI Category Routes
    {
      ...
      title: 'AI Assistant',
      description: 'Interactive AI assistant testing interface with conversation capabilities.',
      category: 'AI',
    },
    {
      path: '/demo/ai-complete-test',
      title: 'AI Complete Test',
      description: 'Complete AI system testing with all legal AI functionality.',
      category: 'AI',
    },
    {
      path: '/demo/ai-dashboard',
      title: 'AI Dashboard',
      description: 'AI metrics and performance monitoring with real-time insights.',
      category: 'AI',
    },
    {
      path: '/demo/ai-integration',
      title: 'AI Integration',
      description: 'Full AI system integration showcase with legal capabilities.',
      category: 'AI',
    },
    {
      path: '/demo/ai-pipeline',
      title: 'AI Pipeline',
      description: 'AI processing pipeline demonstration with workflow stages.',
      category: 'AI',
    },
    {
      path: '/demo/ai-summary',
      title: 'AI Summary',
      description: 'AI-powered document summarization and content analysis.',
      category: 'AI',
    },
    {
      path: '/demo/ai-test',
      title: 'AI Test',
      description: 'AI service health checking and functionality validation.',
      category: 'AI',
    },
    {
      path: '/demo/document-ai',
      title: 'Document AI',
      description: 'AI-powered document processing and intelligent analysis.',
      category: 'AI',
    },
    {
      path: '/demo/legal-ai-complete',
      title: 'Legal AI Complete',
      description: 'Complete legal AI platform with all features integrated.',
      category: 'AI',
    },
    {
      path: '/demo/legal-ai-orchestrator',
      title: 'Legal AI Orchestrator',
      description: 'AI orchestration system for complex legal workflows.',
      category: 'AI',
    },
    {
      path: '/demo/legal-ai-platform',
      title: 'Legal AI Platform',
      description: 'Comprehensive legal AI platform demonstration.',
      category: 'AI',
    },
    {
      path: '/demo/ollama-integration',
      title: 'Ollama Integration',
      description: 'Ollama LLM integration with legal AI processing.',
      category: 'AI',
    },
    {
      path: '/demo/productivity-ai-integration',
      title: 'Productivity AI',
      description: 'AI integration for enhanced legal productivity workflows.',
      category: 'AI',
    },
    {
      path: '/demo/rag-integration',
      title: 'RAG Integration',
      description: 'Retrieval Augmented Generation for legal document processing.',
      category: 'AI',
    },
    {
      path: '/demo/webasm-ai-complete',
      title: 'WebAssembly AI',
      description: 'WebAssembly-powered AI processing for browser performance.',
      category: 'AI',
    },
    // GPU Category Routes
    {
      path: '/demo/cuda-minio-upload',
      title: 'CUDA MinIO Upload',
      description: 'GPU-accelerated file upload with CUDA and MinIO storage.',
      category: 'GPU',
    },
    {
      path: '/demo/cuda-rtx-integration',
      title: 'CUDA RTX Integration',
      description: 'RTX GPU integration with CUDA acceleration for legal AI.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-acceleration',
      title: 'GPU Acceleration',
      description: 'GPU acceleration demonstration for legal processing.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-assistant',
      title: 'GPU Assistant',
      description: 'GPU-powered AI assistant with accelerated inference.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-cache-integration',
      title: 'GPU Cache',
      description: 'GPU-accelerated caching system for faster processing.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-chat',
      title: 'GPU Chat',
      description: 'GPU-accelerated chat interface with enhanced speeds.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-inference',
      title: 'GPU Inference',
      description: 'GPU-powered inference engine for legal AI models.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-legal-ai',
      title: 'GPU Legal AI',
      description: 'Legal AI processing accelerated with GPU compute.',
      category: 'GPU',
    },
    {
      path: '/demo/gpu-vector-processing',
      title: 'GPU Vector Processing',
      description: 'Vector operations accelerated with GPU processing.',
      category: 'GPU',
    },
    {
      path: '/demo/nes-gpu-quantization',
      title: 'NES GPU Quantization',
      description: 'GPU quantization with retro NES styling integration.',
      category: 'GPU',
    },
    {
      path: '/demo/nes-texture-streaming',
      title: 'NES Texture Streaming',
      description: 'GPU texture streaming with NES-themed graphics.',
      category: 'GPU',
    },
    {
      path: '/demo/retro-gpu-metrics',
      title: 'Retro GPU Metrics',
      description: 'GPU performance metrics with retro gaming aesthetics.',
      category: 'GPU',
    },
    {
      path: '/demo/webgpu-acceleration',
      title: 'WebGPU Acceleration',
      description: 'WebGPU acceleration for browser-based legal AI.',
      category: 'GPU',
    },
    {
      path: '/demo/webgpu-graph',
      title: 'WebGPU Graph',
      description: 'Graph visualization powered by WebGPU acceleration.',
      category: 'GPU',
    },
    {
      path: '/demo/webgpu-quantization',
      title: 'WebGPU Quantization',
      description: 'Model quantization using WebGPU for efficiency.',
      category: 'GPU',
    },
    {
      path: '/demo/webgpu-webasm-integration',
      title: 'WebGPU WebAssembly',
      description: 'WebGPU and WebAssembly integration for performance.',
      category: 'GPU',
    },
    // UI Category Routes
    {
      path: '/demo/bits-ui',
      title: 'Bits UI Showcase',
      description: 'Complete Bits UI component library with YoRHa theme.',
      category: 'UI',
    },
    {
      path: '/demo/component-gallery',
      title: 'Component Gallery',
      description: 'Full showcase of UI components with interactive examples.',
      category: 'UI',
    },
    {
      path: '/demo/headless-ui-showcase',
      title: 'Headless UI Showcase',
      description: 'Headless UI components with legal platform styling.',
      category: 'UI',
    },
    {
      path: '/demo/legal-components',
      title: 'Legal Components',
      description: 'Specialized UI components for legal applications.',
      category: 'UI',
    },
    {
      path: '/demo/legal-form',
      title: 'Legal Form',
      description: 'Legal document form components with validation.',
      category: 'UI',
    },
    {
      path: '/demo/nes-bits-ui',
      title: 'NES Bits UI',
      description: 'Bits UI components with retro NES gaming aesthetics.',
      category: 'UI',
    },
    {
      path: '/demo/nes-yorha-3d',
      title: 'NES YoRHa 3D',
      description: '3D NES and YoRHa theme integration with depth effects.',
      category: 'UI',
    },
    {
      path: '/demo/nes-yorha-hybrid',
      title: 'NES YoRHa Hybrid',
      description: 'Hybrid NES and YoRHa theme combination interface.',
      category: 'UI',
    },
    {
      path: '/demo/professional-editor',
      title: 'Professional Editor',
      description: 'Advanced text editor for legal document formatting.',
      category: 'UI',
    },
    {
      path: '/demo/progressive-gaming-ui',
      title: 'Progressive Gaming UI',
      description: 'Gaming-inspired progressive UI with animations.',
      category: 'UI',
    },
    {
      path: '/demo/ps1-effects-advanced',
      title: 'PS1 Effects Advanced',
      description: 'Advanced PlayStation 1 style visual effects.',
      category: 'UI',
    },
    {
      path: '/demo/ps1-stories',
      title: 'PS1 Stories',
      description: 'Story interface with PlayStation 1 retro aesthetics.',
      category: 'UI',
    },
    {
      path: '/demo/ui-components',
      title: 'UI Components',
      description: 'General UI components library for the platform.',
      category: 'UI',
    },
    {
      path: '/demo/unocss-svelte5',
      title: 'UnoCSS Svelte 5',
      description: 'UnoCSS utility framework with Svelte 5 integration.',
      category: 'UI',
    },
    {
      path: '/demo/yorha-tables',
      title: 'YoRHa Tables',
      description: 'Data tables with YoRHa theme and styling.',
      category: 'UI',
    },
    // Search Category Routes
    {
      path: '/demo/enhanced-rag-demo',
      title: 'Enhanced RAG Demo',
      description: 'Enhanced RAG demonstration with semantic search.',
      category: 'Search',
    },
    {
      path: '/demo/enhanced-rag-semantic',
      title: 'Enhanced RAG Semantic',
      description: 'Semantic RAG processing with advanced search.',
      category: 'Search',
    },
    {
      path: '/demo/enhanced-semantic-architecture',
      title: 'Enhanced Semantic Architecture',
      description: 'Advanced semantic search architecture demonstration.',
      category: 'Search',
    },
    {
      path: '/demo/instant-search',
      title: 'Instant Search',
      description: 'Real-time instant search with immediate results.',
      category: 'Search',
    },
    {
      path: '/demo/legal-search',
      title: 'Legal Search',
      description: 'Specialized search for legal documents and cases.',
      category: 'Search',
    },
    {
      path: '/demo/real-time-search',
      title: 'Real-time Search',
      description: 'Live search results with dynamic filtering.',
      category: 'Search',
    },
    {
      path: '/demo/semantic-3d',
      title: 'Semantic 3D',
      description: '3D visualization of semantic search relationships.',
      category: 'Search',
    },
    {
      path: '/demo/semantic-search',
    ...
    },
    {
      ...
      description: 'Vector AI capabilities with intelligent processing.',
      category: 'Search',
    },
    {
      path: '/demo/vector-pipeline',
      title: 'Vector Pipeline',
      description: 'Vector processing pipeline for document embeddings.',
      category: 'Search',
    },
    {
    ...
    {
      path: '/demo/clean-architecture',
      title: 'Clean Architecture',
      description: 'Clean architecture patterns in legal AI system.',
      category: 'Integration',
    },
    {
      path: '/demo/complete-integration',
      title: 'Complete Integration',
      description: 'Complete system integration with all components.',
      category: 'Integration',
    },
    {
      path: '/demo/crud-integration',
      title: 'CRUD Integration',
      description: 'CRUD operations integration with legal data.',
      category: 'Integration',
    },
    {
      path: '/demo/full-stack-integration',
      title: 'Full Stack Integration',
      description: 'Full-stack integration demonstration.',
      category: 'Integration',
    },
    {
      path: '/demo/hybrid-cache-architecture',
      title: 'Hybrid Cache Architecture',
      description: 'Hybrid caching system architecture demonstration.',
      category: 'Integration',
    },
    {
      path: '/demo/hybrid-legal-analysis',
      title: 'Hybrid Legal Analysis',
      description: 'Hybrid analysis combining AI and traditional methods.',
      category: 'Integration',
    },
    {
      path: '/demo/integrated-system',
      title: 'Integrated System',
      description: 'Integrated legal AI system with all features.',
      category: 'Integration',
    },
    {
      path: '/demo/system-integration',
      title: 'System Integration',
      description: 'System architecture and integration patterns.',
      category: 'Integration',
    },
    {
      path: '/demo/unified-architecture',
      title: 'Unified Architecture',
      description: 'Unified system architecture design demonstration.',
      category: 'Integration',
    },
    {
      path: '/demo/unified-integration',
      title: 'Unified Integration',
      description: 'Unified integration patterns and practices.',
      category: 'Integration',
    },
    {
      path: '/demo/unified-vector',
      title: 'Unified Vector',
      description: 'Unified vector operations across the platform.',
      category: 'Integration',
    },
    // Performance Category Routes
    {
      path: '/demo/glyph-cache',
      title: 'Glyph Cache',
      description: 'Font glyph caching system for performance.',
      category: 'Performance',
    },
    {
      path: '/demo/glyph-generator',
      title: 'Glyph Generator',
      description: 'Dynamic glyph generation with caching optimization.',
      category: 'Performance',
    },
    {
      path: '/demo/lazy-loading',
      title: 'Lazy Loading',
      description: 'Lazy loading implementation for better performance.',
      category: 'Performance',
    },
    {
      path: '/demo/loading-button',
      title: 'Loading Button',
      description: 'Loading button states and performance optimization.',
      category: 'Performance',
    },
    {
      path: '/demo/observability',
      title: 'Observability',
      description: 'System observability and performance monitoring.',
      category: 'Performance',
    },
    {
      path: '/demo/production-analytics',
      title: 'Production Analytics',
      description: 'Production-level analytics and performance metrics.',
      category: 'Performance',
    },
    {
      path: '/demo/shader-cache',
      title: 'Shader Cache',
      description: 'GPU shader caching for improved rendering performance.',
      category: 'Performance',
    },
    {
      path: '/demo/simd-glyphs',
      title: 'SIMD Glyphs',
      description: 'SIMD-accelerated glyph processing for performance.',
      category: 'Performance',
    },
    {
      path: '/demo/upload-analytics',
      title: 'Upload Analytics',
      description: 'File upload analytics and performance tracking.',
      category: 'Performance',
    },
    // Advanced Category Routes
    {
      path: '/demo/case-scoring',
      title: 'Case Scoring',
      description: 'AI-powered legal case scoring and evaluation.',
      category: 'Advanced',
    },
    {
      path: '/demo/chat-stream',
      title: 'Chat Stream',
      description: 'Streaming chat interface with real-time updates.',
      category: 'Advanced',
    },
    {
      path: '/demo/cyber-elephant',
      title: 'Cyber Elephant',
      description: 'Advanced cybersecurity analysis with AI integration.',
      category: 'Advanced',
    },
    {
      path: '/demo/document-upload-gpu',
      title: 'Document Upload GPU',
      description: 'GPU-accelerated document upload and processing.',
      category: 'Advanced',
    },
    {
      path: '/demo/drag-drop',
      title: 'Drag & Drop',
      description: 'Advanced drag and drop functionality for documents.',
      category: 'Advanced',
    },
    {
      path: '/demo/editor-test',
      title: 'Editor Test',
      description: 'Advanced editor testing and functionality validation.',
      category: 'Advanced',
    },
    {
      path: '/demo/embedding-chat',
      title: 'Embedding Chat',
      description: 'Chat interface with document embedding integration.',
      category: 'Advanced',
    },
    {
      path: '/demo/enhanced-legal-upload',
      title: 'Enhanced Legal Upload',
      description: 'Enhanced legal document upload with AI processing.',
      category: 'Advanced',
    },
    {
      path: '/demo/evidence-hybrid',
      title: 'Evidence Hybrid',
      description: 'Hybrid evidence processing with AI and manual review.',
      category: 'Advanced',
    },
    {
      path: '/demo/gaming-evolution',
      title: 'Gaming Evolution',
      description: 'Gaming interface evolution with legal AI integration.',
      category: 'Advanced',
    },
    {
      path: '/demo/inline-suggestions',
      title: 'Inline Suggestions',
      description: 'Real-time inline suggestions for legal documents.',
      category: 'Advanced',
    },
    {
      path: '/demo/langextract-ollama',
      title: 'Language Extract Ollama',
      description: 'Language extraction using Ollama AI models.',
      category: 'Advanced',
    },
    {
      path: '/demo/live-agents',
      title: 'Live Agents',
      description: 'Live AI agents for real-time legal assistance.',
      category: 'Advanced',
    },
    {
      path: '/demo/neural-sprite',
      title: 'Neural Sprite',
      description: 'Neural network-generated sprite graphics system.',
      category: 'Advanced',
    },
    {
      path: '/demo/neural-sprite-engine',
      title: 'Neural Sprite Engine',
      description: 'Advanced neural sprite generation engine.',
      category: 'Advanced',
    },
    {
      path: '/demo/recommendation-system',
      title: 'Recommendation System',
      description: 'AI-powered legal recommendation and suggestion system.',
      category: 'Advanced',
    },
    {
      path: '/demo/streaming-workflow',
      title: 'Streaming Workflow',
      description: 'Real-time streaming workflow for legal processes.',
      category: 'Advanced',
    },
    {
      path: '/demo/wasm-parser',
      title: 'WebAssembly Parser',
      description: 'WebAssembly-powered document parsing for performance.',
      category: 'Advanced',
    },
    {
      path: '/demo/xstate-auth',
      title: 'XState Auth',
      description: 'XState-powered authentication and authorization system.',
      category: 'Advanced',
    },
    // Development Category Routes
    {
      path: '/demo/notes',
      title: 'Notes',
      description: 'Note-taking and annotation system for legal documents.',
      category: 'Development',
    },
    {
      path: '/demo/phase14',
      title: 'Phase 14',
      description: 'Development phase 14 features and functionality.',
      category: 'Development',
    },
    {
      path: '/demo/phase5',
      title: 'Phase 5',
      description: 'Development phase 5 features and testing.',
      category: 'Development',
    },
    {
      path: '/demo/simple-test',
      title: 'Simple Test',
      description: 'Simple testing interface for development validation.',
      category: 'Development',
    },
    {
      path: '/demo/system-summary',
      title: 'System Summary',
      description: 'System summary and status overview for development.',
      category: 'Development',
    },
  ]);
  $effect(() => {
  ...
  function getCategoryColor(category: string) {
    switch (category) {
      case 'AI':
        return 'from-blue-600/20 to-blue-800/40 border-blue-500/30';
      case 'GPU':
        return 'from-green-600/20 to-green-800/40 border-green-500/30';
      case 'UI':
        return 'from-purple-600/20 to-purple-800/40 border-purple-500/30';
      case 'Search':
        return 'from-amber-600/20 to-amber-800/40 border-amber-500/30';
      case 'Integration':
        return 'from-cyan-600/20 to-cyan-800/40 border-cyan-500/30';
      case 'Performance':
        return 'from-orange-600/20 to-orange-800/40 border-orange-500/30';
      case 'Advanced':
        return 'from-red-600/20 to-red-800/40 border-red-500/30';
      case 'Development':
        return 'from-slate-600/20 to-slate-800/40 border-slate-500/30';
      default:
        return 'from-gray-600/20 to-gray-800/40 border-gray-500/30';
    }
  }
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Professional legal investigation platform with AI-powered analysis and intelligent case management"
  />
</svelte:head>
<EvidenceBoardLayout title="LEGAL AI COMMAND CENTER" caseInfo="CORPORATE ESPIONAGE INVESTIGATION" demoMode={true}>
  {#snippet children()}
        ...
        <div class="p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <!-- Special glow effect -->
              <div
                class="absolute inset-0 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 opacity-0 group-hover:opacity-100 transition-opacity"
              ></div>
            </a>
            <!-- SPA Canvas Button -->
            <a
            ...
            >
              ...
              <div
                class="absolute inset-0 bg-gradient-to-r from-purple-400/20 to-blue-400/20 opacity-0 group-hover:opacity-100 transition-opacity"
              ></div>
            </a>
            ...
            >
              ...
              <div
                class="absolute inset-0 bg-gradient-to-r from-indigo-400/20 to-purple-400/20 opacity-0 group-hover:opacity-100 transition-opacity"
              ></div>
            </a>
          </div>
        </div>
      ...
      <div class="yorha-3d-panel">
        <div class="p-6">
          <div class="flex items-center justify-between mb-6">
            ...
            <a href="/activity" class="text-amber-400 hover:text-amber-300 text-sm font-medium"> View All → </a>
          </div>
          <div class="space-y-4">
            {#each recentActivity as activity}
              <div
                class="flex items-start gap-4 p-4 bg-gray-800/50 rounded-lg border border-gray-600 hover:border-yellow-600/50 transition-colors"
              >
                {#if activity.icon}
      ...
      <div class="yorha-3d-panel">
        <div class="p-6">
          <div class="flex items-center justify-between mb-6">
            ...
            <a
              href="/all-routes"
              class="text-amber-400 hover:text-amber-300 text-sm font-medium bg-amber-400/10 px-3 py-1 rounded-lg border border-amber-400/20 hover:border-amber-400/40 transition-colors"
            >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Essential Routes -->
            <div
              class="group p-4 bg-green-600/10 rounded-lg border border-green-600/20 hover:border-green-400/40 transition-colors"
            >
            ...
            <!-- AI Demo Routes -->
            <div
              class="group p-4 bg-blue-600/10 rounded-lg border border-blue-600/20 hover:border-blue-400/40 transition-colors"
            >
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2">
            ...
            <!-- UI Component Demos -->
            <div
              class="group p-4 bg-purple-600/10 rounded-lg border border-purple-600/20 hover:border-purple-400/40 transition-colors"
            >
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2">
            ...
            <!-- Integration Demos -->
            <div
              class="group p-4 bg-amber-600/10 rounded-lg border border-amber-600/20 hover:border-amber-400/40 transition-colors"
            >
              <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2">
          ...
          <div class="mt-6 pt-6 border-t border-gray-600">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
              <a
                ...
                class="p-3 bg-gray-800/50 rounded-lg border border-gray-600 hover:border-blue-500/50 transition-colors text-center group"
              >
              ...
              <a
                href="/demo/bits-ui"
                class="p-3 bg-gray-800/50 rounded-lg border border-gray-600 hover:border-purple-500/50 transition-colors text-center group"
              >
              ...
              <a
                href="/demo/gpu-legal-ai"
                class="p-3 bg-gray-800/50 rounded-lg border border-gray-600 hover:border-green-500/50 transition-colors text-center group"
              >
              ...
              <a
                ...
                class="p-3 bg-gray-800/50 rounded-lg border border-gray-600 hover:border-yellow-500/50 transition-colors text-center group"
              >
      ...
      <div class="yorha-3d-panel">
        <div class="p-6">
          <div class="flex items-center justify-between mb-6">
            ...
            <div
              class="text-amber-300 text-sm font-medium bg-amber-400/10 px-3 py-1 rounded-lg border border-amber-400/20"
            >
            ...
            {#each demoRoutes as route (route.path)}
              <div class="demo-route-modal">
                <a href={route.path} class="block">
                  <Card
                    class="demo-route-card bg-gradient-to-br {getCategoryColor(
                      route.category,
                    )} border-2 hover:scale-105 transition-all duration-300 cursor-pointer p-4 rounded-lg shadow-lg"
                  >
                    ...
                    <div class="mt-4 pt-4 border-t border-white/10">
                      <div class="flex items-center justify-between">
                        <span class="text-xs text-white/60 uppercase tracking-wide font-medium"> Live Demo </span>
