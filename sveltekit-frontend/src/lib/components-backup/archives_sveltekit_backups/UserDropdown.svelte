	...
	{#if dropdownOpen}
		<div class="mx-auto px-4 max-w-7xl">
			<div class="mx-auto px-4 max-w-7xl">
				...
				<div class="mx-auto px-4 max-w-7xl">
					<div class="mx-auto px-4 max-w-7xl">{user?.name || 'User'}</div>
					<div class="mx-auto px-4 max-w-7xl">{user?.email || ''}</div>
					<div class="mx-auto px-4 max-w-7xl">{user?.role || ''}</div>
				</div>
			</div>
			...
			<div class="mx-auto px-4 max-w-7xl">
				<a href="/profile" class="mx-auto px-4 max-w-7xl">
				...
				<button type="button" class="mx-auto px-4 max-w-7xl" onclick={() => handleLogout()}>
					<svg width="16" height="16" viewBox="0 0 16 16" fill="none">
