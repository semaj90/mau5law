...
/** * XState v5 actor for generating embeddings with legal context */ export const embeddingActor =
 ...
 code: 'INVALID_INPUT',
 } satisfies EmbeddingError; // Used 'satisfies' for type checking
 }
...
/** * Batch embedding actor for multiple texts */ export const batchEmbeddingActor = fromPromise(
 ...
 // Corrected item and index type annotation
...
/** * Helper function to create and run embedding actor */ export async function generateEmbedding(
...
/** * Helper function for batch embeddings */ export async function generateBatchEmbeddings(
 inputs: EmbeddingInput[]
): Promise<EmbeddingOutput[]> {
 // Changed inputs type annotation
