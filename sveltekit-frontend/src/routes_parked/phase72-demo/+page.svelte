...
<div class="demo-container">
 ...
 <select id="case-type" bind:value={caseType} onchange={ handleCaseChange: handleCaseChange }>
 ...
 <select id="jurisdiction" bind:value={jurisdiction} onchange={ handleCaseChange: handleCaseChange }>
