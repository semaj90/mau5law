...
export class ONNXApiClient {
  ...
  async runTests(): Promise<any> {
    const testData = {
      contractText: 'This is a legal contract between ABC Corporation and John Doe, executed January 15, 2024, in the Superior Court of California.',
   ...
   */
  private async makeRequest(endpoint: string, body: unknown, retries: number = 0): Promise<any> {
    try {
