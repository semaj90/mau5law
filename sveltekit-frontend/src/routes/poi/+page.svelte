...
<div class="container mx-auto px-4">
  ...
  <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <Button class="bits-btn {showFilters ? 'bg-blue-50"
        variant="ghost"
        size="sm"
  onclick={() =>
    ...
    <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
      <div class="grid md:grid-cols-3">
        <div>
          ...
          <select id="status-filter" class="w-full p-2 border border-gray-300">
        ...
        <div>
          <label for="case-filter" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Case</label>
          <select id="case-filter" class="w-full p-2 border border-gray-300">
        ...
        <div class="flex">
          <Button variant="ghost" size="sm" class="w-full bits-btn">
Clear Filters
        </div>
      </div>
    </div>
...
<Eye class="w-3 h-3" />
              View
            <Button variant="ghost" size="sm" class="flex-1 bits-btn">
<Edit class="w-3 h-3" />
              Edit
          </div>
        </div>
