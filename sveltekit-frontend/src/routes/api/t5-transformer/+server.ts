...
async function generateMockT5Response(input: string, task: string, domain: string): Promise<T5TransformResponse> {
  ...
  switch (task) {
    case 'summarize':
      ...
      structured = {
        summary: output,
        keyPoints: extractKeyPoints(output),
    ...
    case 'analyze':
      ...
      structured = {
        analysis: output,
        entities: extractLegalEntities(output),
    ...
    case 'extract':
      ...
      structured = {
        extracted: output,
        entities: extractLegalEntities(output),
        structuredData: parseStructuredData(output, domain),
    ...
    case 'generate':
      ...
      structured = {
        ...
        relevance: assessRelevance(input, output),
      };
      break;
    default:
