<script lang="ts">
  /**
   * Phase 74: Cluster Badge Component
   * Displays semantic cluster information for suggestions
   */
  import type { ClusterInfo } from '$lib/ast/suggestion-engine';
  ...
  let { cluster, size = 'md', showLabel = true, onclick }: Props = $props();
