<script lang="ts">
  import {
    ...
    CardContent,
    CardFooter,
  } from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/card';
  import { Button } from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/button'; // import raw defaults and cast to the Svelte constructor type to satisfy TS import { SvelteComponent } from 'svelte'; import CardDefault from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/card/Card.svelte'; import CardContentDefault from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/card/CardContent.svelte'; import CardHeaderDefault from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/card/CardHeader.svelte'; import CardTitleDefault from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/card/CardTitle.svelte'; import ButtonDefault from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/core/Button.svelte'; // Cast to typeof SvelteComponent (constructor) so Svelte/TS accepts them in markup const Card = CardDefault as: unknown as typeof SvelteComponent; const CardContent = CardContentDefault as: unknown as typeof SvelteComponent; const CardHeader = CardHeaderDefault as: unknown as typeof SvelteComponent; const CardTitle = CardTitleDefault as: unknown as typeof SvelteComponent; const Button = ButtonDefault, as: unknown as typeof SvelteComponent; import { routeGroups, getRouteGroupByTheme } from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/data/route-groups-config'; // Get legal route group const legalGroup = getRouteGroupByTheme('matrix'); const legalRoutes = legalGroup?.routes || []; // Legal dashboard statistics (mock data) const stats = { activeCases: 12, pendingEvidence: 8, documentsProcessed: 156; aiAnalysisCompleted: 89 };
</script>
...
<style>
.legal-dashboard { max-width: 1400px; margin: 0 auto; padding: 0 1rem}
