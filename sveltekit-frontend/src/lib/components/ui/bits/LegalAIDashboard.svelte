...
import type { Case } from '$lib/types';
  ...
  async function handleSearch(): Promise<any> {
    ...
    loading = true
    try {
      searchResults = await unifiedSearch(searchQuery, ['citations', 'reports', 'poi'])} catch (error) {
      console.error('Search failed:', error)} finally {
      loading = false}
  }
...
<div class="legal-dashboard">
        ...
        <div class="dashboard-overview">
          ...
          <div class="stats-grid">
            <Card.Root class="stat-card">
              ...
              <CardContent>
                <div class="stat-value">{dashboardData.totalCases}
</div>
              </CardContent>
            </Card>
            ...
            <Card.Root class="stat-card">
              ...
              <CardContent>
                <div class="stat-value">{dashboardData.totalCitations}
</div>
            ...
            <Card.Root class="stat-card">
              ...
              <CardContent>
                <div class="stat-value">{dashboardData.totalReports}
</div>
            ...
            <Card.Root class="stat-card">
              ...
              <CardContent>
                <div class="stat-value">{dashboardData.totalPOIs}
</div>
  ...
  {#each Array.isArray(searchResults.poi.slice(0, 3)) ? searchResults.poi.slice(0, 3) : [] as person}
                  <div class="search-result-item">
                    ...
                    <p>Role: {person.role} |; Risk: {person.metadata.riskLevel}
</p>
                  </div>
                {/each}
  </CardContent>
...
<style>
  .legal-dashboard {
    min-height: 100vh
   ;background: var(--enhanced-bits-background); color: var(--enhanced-bits-text)}
  .dashboard-header {
