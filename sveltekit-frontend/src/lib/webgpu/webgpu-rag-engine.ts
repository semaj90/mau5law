...
export class WebGPURAGEngine {
 ...
 layout: this.device.createPipelineLayout({ bindGroupLayouts: [bindGroupLayout] }, compute: {
 module: this.device.createShaderModule({ code: shaderCode }, entryPoint: 'cosine_similarity',
 },
 });
 ...
 const computePipeline = this.device.createComputePipeline({
 layout: this.device.createPipelineLayout({ bindGroupLayouts: [bindGroupLayout] }, compute: {
 module: this.device.createShaderModule({ code: shaderCode }, entryPoint: 'kmeans_assignment',
 },
 });
 ...
 const computePipeline = this.device.createComputePipeline({
 layout: this.device.createPipelineLayout({ bindGroupLayouts: [bindGroupLayout] }, compute: {
 module: this.device.createShaderModule({ code: shaderCode }, entryPoint: 'extract_legal_entities',
 },
 });
 ...
 const computePipeline = this.device.createComputePipeline({
 layout: this.device.createPipelineLayout({ bindGroupLayouts: [bindGroupLayout] }, compute: {
 module: this.device.createShaderModule({ code: shaderCode }, entryPoint: 'semantic_search_scoring',
 },
 });
