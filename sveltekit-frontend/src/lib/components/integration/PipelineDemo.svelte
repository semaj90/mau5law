...
<input id="cache-key"
 ...
 <div class="text-sm">Average Time</div> </div> </div> </div>
 <div class="nes-container"> <div class="yorha-panel-content"> <div class="text-center"> <div class="text-2xl font-bold">{metrics.successRate.toFixed(1)}%</div>
 <div class="text-sm">Success Rate</div> </div> </div> </div>
 <div class="nes-container"> <div class="yorha-panel-content"> <div class="text-center"> <div class="text-2xl font-bold">{results.length}
</div>
