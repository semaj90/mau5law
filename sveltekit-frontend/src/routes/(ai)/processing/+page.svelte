...
<div class="min-h-screen bg-gray-50">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <div class="text-center">
        ...
        <div class="text-sm">Hit Rate</div>
        <div class="text-xs text-gray-400">
    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <div class="text-center">
        ...
        <div class="text-sm">Active Banks</div>
        <div class="text-xs text-gray-400">
  ...
  <div class="mt-8 bg-white rounded-lg shadow">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4">
      <div class="text-center">
        <div class="text-2xl font-bold">{performanceStats.totalDocumentsProcessed}</div>
        <div class="text-sm">Documents Processed</div>
      </div>
      <div class="text-center">
        <div class="text-2xl font-bold">{Math.round(performanceStats.averageProcessingTime)}ms</div>
        <div class="text-sm">Avg Processing Time</div>
      </div>
      <div class="text-center">
        <div class="text-2xl font-bold">{Math.round(performanceStats.successRate)}%</div>
        <div class="text-sm">Success Rate</div>
      </div>
      <div class="text-center">
        <div class="text-2xl font-bold">{Math.round(performanceStats.memoryEfficiency * 100)}%</div>
        <div class="text-sm">Memory Efficiency</div>
      </div>
    </div>
  </div>
</div>
      ...
      <form onsubmit={submitProcessingJob} class="space-y-4">
        ...
        <div>
          ...
          {#if newJobForm.errors?.documentId}
            <div class="text-red-600 text-sm">{newJobForm.errors.documentId[0]}</div>
          {/if}
        </div>
        <div>
        ...
        <div class="flex">
          ...
          />
          <label for="useGPU" class="ml-2 block text-sm"> Use GPU Acceleration (NES-GPU Bridge) </label>
        </div>

        {#if newJobForm.errors.general}
          <div class="text-red-600">{newJobForm.errors.general[0]}</div>
        {/if}
        <div class="flex justify-end gap-3">
          ...
          <div
            class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2"
          >
