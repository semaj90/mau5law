...
export const load: PageServerLoad = async ({ url, fetch }) => {
  try {
    ...
    const componentSpecs = { button: { id: 'yorha-button-3d',
        ...
        defaultConfig: { text: 'YoRHa Button',
          variant: 'primary',
          size: 'medium',
          icon: 'terminal',
          loading: false,
      ...
      panel: { id: 'yorha-panel-3d',
        ...
        defaultConfig: { title: 'YoRHa Panel',
          variant: 'default',
          width: 400,
          height: 300,
          scrollable: true,
      ...
      input: { id: 'yorha-input-3d',
        ...
        defaultConfig: { placeholder: 'Enter command...',
          type: 'text',
          variant: 'terminal',
          value: '',
          error: false,
