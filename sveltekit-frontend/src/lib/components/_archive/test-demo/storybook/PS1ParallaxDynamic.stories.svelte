...
<script lang="ts">
  ...
  let pointer = { x: 0, y: 0 };
  let isGyroscopeAvailable = $state<boolean>(false);
  ...
  async function requestGyroscopePermission(): Promise<any> {
...
<div class="ps1-parallax-container" bind:this={container}>
  ...
  <div class="parallax-viewport ps1-3d-scene">
    <!-- Background Layer -->
    <div class="parallax-layer layer-background ps1-pixelated" data-parallax-id="background">
    ...
    <!-- Midground Layer 1 -->
    <div class="parallax-layer layer-midground-1" data-parallax-id="midground-1">
      <div class="geometric-shapes">
        {#each Array(8) as _, i}
          <div class="shape triangle ps1-wireframe" style="left: {20 + i * 10}%; top: {30 + (i % 3) * 20}%"></div>
        {/each}
      </div>
    </div>
    <!-- Midground Layer 2 -->
    <div class="parallax-layer layer-midground-2" data-parallax-id="midground-2">
    ...
    <!-- Foreground Layer -->
    <div class="parallax-layer layer-foreground" data-parallax-id="foreground">
