	...
	<div class="error-boundary-container">
		<div class="error-boundary-content">
			...
			<div class="error-actions">
				...
				{/if}
				<button class="nes-btn" onclick={goHome}>Go Home</button>
				{#if showReportButton}
					<button class="nes-btn" onclick={reportError}>Report Issue</button>
				{/if}
				<button class="nes-btn" onclick={reset}>Reset</button>
			</div>
		</div>
	</div>
