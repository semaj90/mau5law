...
declare module '$lib/services/system-monitor-client' {
  ...
  export function startSystemMonitorClient(opts?: { batchSize?: number; intervalMs?: number; url?: string }): { push?: (e: LatencyEntry) => void; stop?: () => void; service?: unknown };
...
// Minimal WebGPU global types (enough for TS checks)
declare global {
  interface GPUAdapter { requestDevice(opts?: any): Promise<any>; }
  interface GPUDevice { queue: any; createShaderModule(...args: any[]): any; createBuffer(...args: any[]): any; createTexture(...args: any[]): any; createCommandEncoder(...args: any[]): any; requestDevice?: any; }
  interface GPUCanvasContext { getCurrentTexture(): { createView(): any }; configure(opts: any): void; }
  type GPUTextureFormat = string;
  interface Navigator { gpu?: { requestAdapter?: () => Promise<GPUAdapter | null>; getPreferredCanvasFormat?: () => GPUTextureFormat } }
}
