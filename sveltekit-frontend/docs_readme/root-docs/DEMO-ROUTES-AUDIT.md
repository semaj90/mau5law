...
- **Status**: Comprehensive audit needed for cleanup
...
- ✅ `/demo/ai-integration` - Full AI system integration showcase
- ✅ `/demo/ai-pipeline` - AI processing pipeline demo
- ✅ `/demo/ai-summary` - AI summarization capabilities
...
- ✅ `/demo/professional-editor` - Professional text editor
...
- ✅ `/demo/gpu-cache-integration` - GPU caching
- ✅ `/demo/gpu-chat` - GPU-powered chat
- ✅ `/demo/gpu-inference` - GPU inference
- ✅ `/demo/gpu-legal-ai` - Legal AI on GPU
...
- ✅ `/demo/real-time-search` - Live search results
- ✅ `/demo/vector-intelligence` - Vector AI capabilities
...
- ✅ `/demo/unified-architecture` - Unified system design
...
- ✅ `/demo/enhanced-legal-upload` - Enhanced file upload
- ✅ `/demo/cuda-minio-upload` - CUDA + MinIO upload
...
- ✅ `/demo/phase14` - Phase 14 development demo
- ✅ `/demo/recommendation-system` - Recommendations
...
- `/demo/case-scoring` - Legal AI scoring
- `/demo/ai-pipeline` - AI processing demo
- `/demo/ai-summary` - AI summarization
- `/demo/ai-test` - AI health testing
...
- Duplicate/similar functionality (50+ routes)
- Phase-specific development demos
- Outdated test interfaces
...
mv src/routes/demo/nes-* ../legal-ai-demos-archive/
mv src/routes/demo/ps1-* ../legal-ai-demos-archive/
mv src/routes/demo/phase* ../legal-ai-demos-archive/
# ... move low-value demos
```
