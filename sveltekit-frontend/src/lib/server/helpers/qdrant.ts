 ...
 * Prioritizes environment variables, then QDRANT_CONFIG, then a default.
 * @returns The Qdrant base URL.
 */
 ...
 * @returns A promise that resolves to true if Qdrant is healthy, false otherwise.
 */
export async function checkQdrantHealth(): Promise<boolean> {
  const qdrantUrl = getQdrantBaseUrl();
  try {
