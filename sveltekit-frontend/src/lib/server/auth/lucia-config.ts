...
const resolved =
  (typeof mod === 'object' && mod !== null && 'lucia' in mod ? (mod as { lucia: any }).lucia : undefined) ??
  (typeof mod === 'object' && mod !== null && 'default' in mod ? (mod as { default: any }).default : undefined) ??
  mod;
if (!resolved) {
  throw new Error(
