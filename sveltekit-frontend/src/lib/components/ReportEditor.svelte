...
<div class="report-editor">
    <input type="text" bind:value={currentTitle} placeholder="Report Title" class="report-title-input" />
    <textarea bind:value={currentContent} placeholder="Start writing your report..." class="report-textarea"></textarea>
