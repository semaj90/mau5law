...
// Client helper for the vector-search API
}
...
export async function searchVectors(
    ...
    return payload as VectorSearchResponse;
}
// Additional service exports for compatibility
export { redisService } from '../server/redis-service.js';
export { rabbitmqService, QUEUES, type MessageHandler } from '../server/messaging/rabbitmq-service.js';
// AI Services
