import type { BackendId } from '$lib/types/pipeline'; import { embedText, as embedWithService, getEmbeddingServiceStatus } from './ai/embedder.js'; export interface EmbedGatewayOptions { model?: string; tags?: string[]; }
