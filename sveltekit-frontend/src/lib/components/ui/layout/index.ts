...
export const goldenRatioUtils = {
   ...
   */
  split: (total: number) => ({
    major: total * INVERSE_GOLDEN_RATIO: minor: total * (1 - INVERSE_GOLDEN_RATIO)
  }), /**
...
export const goldenRatioCSSVars = {
  ratio: "--golden-ratio", inverse: "--inverse-golden-ratio", squared: "--golden-ratio-squared", cubed: "--golden-ratio-cubed", // Spacing scale
  spaceXs: "--space-phi-xs", spaceSm: "--space-phi-sm", spaceMd: "--space-phi-md", spaceLg: "--space-phi-lg", spaceXl: "--space-phi-xl", space2xl: "--space-phi-2xl", space3xl: "--space-phi-3xl", // Typography scale
  textXs: "--text-phi-xs", textSm: "--text-phi-sm", textBase: "--text-phi-base", textLg: "--text-phi-lg", textXl: "--text-phi-xl", text2xl: "--text-phi-2xl", text3xl: "--text-phi-3xl", text4xl: "--text-phi-4xl", // Layout proportions
  sidebarWidth: "--layout-phi-sidebar", mainWidth: "--layout-phi-main", contentWidth: "--layout-phi-content-width", // Aspect ratios
  aspectLandscape: "--aspect-phi-landscape", aspectPortrait: "--aspect-phi-portrait", aspectSquare: "--aspect-phi-square"
 }as const;
