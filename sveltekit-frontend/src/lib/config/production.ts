...
export const CONFIG = {
  ...
  // DATABASE
  // ========================================================================
  database: { url: getEnv('DATABASE_URL', 'postgresql://legal_admin:123456@localhost:5432/legal_ai_db'),
  ...
  // STORAGE (MinIO)
  // ========================================================================
  minio: { endpoint: getEnv('MINIO_ENDPOINT', 'localhost:9000'),
    ...
    buckets: { documents: getEnv('MINIO_BUCKET_NAME', 'legal-documents'),
      evidence: 'evidence',
      uploads: 'uploads'
    } }
  },
  ...
  web: {
    ...
    // Transformers.js v3
    transformers: { device: 'webgpu' as const,
      dtype: 'fp16' as const,
      modelCache: '/models',
      useCache: true
    },
  ...
  frameworks: {
    ...
    // XState v5
    xstate: { devTools: ENV.isDev,
      inspect: ENV.isDev
    },
    
    // Search Libraries
    search: { fuse: { threshold: 0.6,
