	...
	<CardRoot class="bg-nier-bg-secondary border shadow-sm p-6">
		<div class="space-y-4">
			<div class="flex gap-2">
				...
				>
					{#if isSearching}
						<span class="i-lucide-loader-2 w-4 h-4 mr-2 animate-spin inline-block"></span> Searching...
					{:else}
						<span class="i-lucide-search w-4 h-4 mr-2 inline-block"></span> Search
					{/if}
				</Button>
		...
		<CardRoot class="bg-nier-bg-secondary border shadow-sm p-6">
			<div class="flex justify-between items-center mb-2">
				<h3 class="font-bold text-nier-accent-warm flex items-center gap-2">
					<span class="i-lucide-check-circle w-5 h-5 inline-block"></span> AI Response
				</h3>
				<div class="text-xs text-nier-text-muted">Generated by: gemma4-legal</div>
			</div>
