...
export {
  sessionManager, isSessionActive, currentUser, sessionPermissions, sessionHealth, sessionAnalytics, securityLevel, hasPermission, requirePermission, recordActivity
...
export {
  aiAssistant, type AIMessage, type Backend, type CaseAIContext, type AssistantConfig
 } from './ai-assistant.svelte';

// Legacy compatibility (for gradual migration)
export {
  aiAssistantManager, isAIActive as isAIAssistantActive, isProcessing as isAIProcessing, currentResponse, conversationHistory, currentModel, currentTemperature, aiError, clusterHealth, context7Analysis, aiUsage, sendAIMessage, setAIModel, setAITemperature, clearAIConversation, checkAIClusterHealth
