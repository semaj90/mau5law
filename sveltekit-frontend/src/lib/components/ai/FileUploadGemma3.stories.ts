...
// Large file support
export const LargeFileSupport: Story = { args: {, maxFileSize: 104857600, // 100MB
    acceptedTypes: [
      'application/pdf',
      'application/msword',
      'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
...
export const SimpleUpload: Story = { args: {, maxFileSize: 5242880, // 5MB
...
export const LegalDocuments: Story = { args: {, maxFileSize: 52428800, // 50MB
    acceptedTypes: [
      'application/pdf',
      'application/msword',
      'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
...
export const MediaUpload: Story = { args: {, maxFileSize: 209715200, // 200MB
    acceptedTypes: [
      'image/jpeg',
      'image/png',
      'image/webp',
