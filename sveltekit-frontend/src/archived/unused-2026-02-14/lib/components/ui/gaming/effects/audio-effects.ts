...
export class RetroAudioEngine {
    ...
    private getContext(): AudioContext {
        if (!this.audioContext) {
            this.audioContext = new (typeof window !== 'undefined' ? (window.AudioContext || (window as any).webkitAudioContext) : null)();
        }
    ...
    async playSNESButtonClick(
        options: { volume?: number, duration?: number, harmonics?: boolean } = {}
    ): Promise<void> {
