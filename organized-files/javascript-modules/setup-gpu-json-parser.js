...
class JsonParserSetup {
    ...
    async createTestConfig() {
        ...
        await fs.writeFile(join(this.projectRoot, 'jest.config.json'), JSON.stringify(jestConfig, null, 2));
...
`;
    ...
    async setupVsCodeExtension() {
        ...
        try {
            ...
            await fs.writeFile(join(vscodeDir, 'tasks.json'), JSON.stringify(tasks, null, 2));
            ...
            await fs.writeFile(join(vscodeDir, 'launch.json'), JSON.stringify(launch, null, 2));
            ...
            await fs.writeFile(join(vscodeDir, 'settings.json'), JSON.stringify(settings, null, 2));
