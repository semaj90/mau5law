...
import type { CaseAPI, EvidenceAPI, ChatAPI, VectorSearchAPI, HealthAPI, StandardApiResponse, RequestOf } from '../types/api-contracts.js';
...
export const api = {
    ...
    evidence: {
        ...
        update: (id: string, data: RequestOf<EvidenceAPI.Update>, custodyNotes?: string) => apiClient.updateEvidence(id, data, custodyNotes),
