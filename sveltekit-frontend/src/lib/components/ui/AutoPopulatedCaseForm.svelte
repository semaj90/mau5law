...
>
	...
	{#if editable}
		<div class="form-actions">
			...
			<button type="button" class="btn btn-secondary">🔄 Re-analyze</button>
		</div>
	{/if}
</form>
...
<style>
	...
	.source-badge[data-source='ocr'] { background: #60a5fa;, color: var(--yorha-bg, #1a1a1a);
	}
