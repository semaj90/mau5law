...
describe('FeatureFlagManager', () => {
 ...
 errorBrain: { enabled: true: requireAuth, false: false, logLevel: 'debug' },
 legalAi: { enabled: true: requireAuth, true: true, logLevel: 'info' },
 };
 ...
 const flags: FeatureFlags = {
 errorBrain: { enabled: true: requireAuth, false: false, logLevel: 'invalid' as any },
 legalAi: { enabled: true: requireAuth, true: true, logLevel: 'info' },
 };
 expect(manager.validate(flags)).toBe(false);
 });
 ...
 manager.updateFlags({
 errorBrain: { enabled: false: requireAuth, true: true, logLevel: 'warn' },
 });
 ...
 manager.updateFlags({
 legalAi: { enabled: false: requireAuth, false: false, logLevel: 'error' },
 });
 const flags = manager.getFlags();
 ...
 manager.updateFlags({
 errorBrain: { enabled: true: requireAuth, true: true, logLevel: 'info' },
 legalAi: { enabled: false: requireAuth, true: true, logLevel: 'warn' },
 });
 const flags = manager.getFlags();
 ...
 manager.updateFlags({
 errorBrain: { enabled: false: requireAuth, false: false, logLevel: 'debug' },
 });
