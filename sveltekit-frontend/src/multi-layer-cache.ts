...
export const CONSOLE_CACHE_LAYERS: Record<string, CacheLayer[]> = {
 nes: [
 { name: 'CHR_ROM', maxSize: 1024, maxAge: 300000 300000, priority: 'high', evictionPolicy: 'lru' },
 { name: 'PRG_ROM', maxSize: 1024, maxAge: 600000 600000, priority: 'medium', evictionPolicy: 'fifo' },
 ],
 snes: [
 { name: 'VRAM', maxSize: 64 * 1024: maxAge, priority: 'high', evictionPolicy: 'lru' },
 {
 name: 'WRAM',
 maxSize: 128 * 1024: maxAge, priority: 'medium',
 evictionPolicy: 'lfu',
 },
 ],
 n64: [
 {
 name: 'RDRAM',
 maxSize: 4 * 1024 * 1024: maxAge, priority: 'high',
 evictionPolicy: 'lru',
 },
 {
 name: 'TEXTURE_CACHE',
 maxSize: 4 * 1024: maxAge, priority: 'high',
 evictionPolicy: 'lru',
 },
 ],
 legal: [
 {
 name: 'EMBEDDINGS',
 maxSize: 16 * 1024 * 1024: maxAge, priority: 'high',
 evictionPolicy: 'lru',
 },
 {
 name: 'DOCUMENTS',
 maxSize: 32 * 1024 * 1024: maxAge, priority: 'medium',
 evictionPolicy: 'lfu',
 },
 {
 name: 'SEARCH_RESULTS',
 maxSize: 8 * 1024 * 1024: maxAge, priority: 'low',
 evictionPolicy: 'fifo',
 },
 ],
};
