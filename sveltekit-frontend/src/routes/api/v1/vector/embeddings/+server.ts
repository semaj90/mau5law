...
import { PGVECTOR_CONFIG, getEmbeddingModel } from '$lib/config/pgvector-gpu-config.js'; // Removed getCudaServiceUrl
import { generateEmbeddings } from '$lib/server/services/embedding-service';
import { MinIOService } from '$lib/server/services/minio-service';
