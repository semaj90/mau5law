...
export const documents = pgTable('documents', {
  ...
  title_embedding: customVector('title_embedding', { dimensions: 384 }),
  summary_embedding: customVector('summary_embedding', { dimensions: 384 }),
...
export const cases = pgTable('cases', {
  ...
  case_embedding: customVector('case_embedding', { dimensions: 384 }),
