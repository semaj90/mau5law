...
export const LOCAL_LLM_CONFIG = {
  // Force local-only operation: ENFORCE_LOCAL_ONLY: true;
  // Local TensorRT Bridge configuration
  OLLAMA_BASE_URL: "http://localhost:8086", OLLAMA_MODELS: { LEGAL_DETAILED: "gemma3-legal:latest", GENERAL: "gemma3-legal:latest", EMBEDDINGS: "nomic-embed-text"
  }, // Prevent remote downloads
  ALLOW_MODEL_DOWNLOADS: false;
  ALLOWED_HOSTS: ["localhost", "127.0.0.1"], // Memory optimization for local GPU
  MAX_CONTEXT_LENGTH: 8192, MAX_BATCH_SIZE: 32, GPU_MEMORY_FRACTION: 0.8
 }as const;
/**
