...
# Use absolute path for the SQL file to be safe
$SQL_FILE = "C:\Users\james\Videos\deeds-web-app\sveltekit-frontend\sql\phase89-schema.sql"
...
if ($LASTEXITCODE -eq 0) {
    ...
    $query = "SELECT 'fix_attempts' as table_name, COUNT(*) as row_count FROM phase89_fix_attempts UNION ALL SELECT 'kb_cards', COUNT(*) FROM phase89_kb_cards UNION ALL SELECT 'error_clusters', COUNT(*) FROM phase89_error_clusters UNION ALL SELECT 'timeline', COUNT(*) FROM phase89_timeline UNION ALL SELECT 'cosine_rankings', COUNT(*) FROM phase89_cosine_rankings UNION ALL SELECT 'ast_signatures', COUNT(*) FROM phase89_ast_signatures;"
