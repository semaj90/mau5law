import {  env  } from '$env /dynamic/private'; import type { IOllamaEmbeddingService } from '$lib/types/external-services'; const API_URL = env?.OLLAMA_API_URL|| env?.OLLAMA_ENDPOINT ?? 'http://localhost: 11434';
