...
<div class="max-w-6xl mx-auto p-6">
  <div class="text-center">
    <h1 class="text-4xl font-bold">Evidence Analysis Pipeline</h1>
    <p class="text-xl nes-text">AI-powered multi-agent legal document analysis</p>
  </div>
    ...
    <div class="yorha-panel-content">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="space-y-2">
          ...
          <input
            ...
            disabled={analyzing}
            class="font-mono w-full rounded border px-3 py-2 focus:outline-none"
          />
        </div>
      ...
      <div class="space-y-2">
        ...
        <Input
          ...
          disabled={analyzing}
          class="file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary"
        />

        {#if evidenceFile}
          <div class="flex items-center gap-2 text-sm nes-text">
            <span>📝</span>
      ...
      <div class="space-y-2">
        ...
        {#if evidenceContent}
          <div class="flex justify-between text-sm nes-text">
      ...
      <div class="flex items-center">
        {#if priority !== 'low'}
          <span class="px-2 py-1 rounded text-xs">
            {priorityOptions.find((p: PriorityOption) => p.value === priority)?.label}
          </span>
        {/if}
        {#if evidenceType !== 'other'}
          <span class="px-2 py-1 rounded text-xs font-medium border border-gray-300"
            >{evidenceTypes.find((t: EvidenceType) => t.value === evidenceType)?.label}</span
          >
        {/if}
      </div>
      <div class="flex">
  ...
  {#if analyzing}
    <div class="nes-container">
      <div class="yorha-panel-header">
        <h3 class="nes-text is-primary flex items-center">⚙️ Analysis in Progress</h3>
      ...
      <div class="yorha-panel-content">
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="nes-text">{progress.toFixed(0)}%</span>
          </div>
            ...
            <div class={"transition-all duration-300 nes-container " + (currentStep === i ? 'ring-2 ring-primary shadow-md' : '')}>
              <div class="yorha-panel-content">
                <div class="flex items-center">
                  ...
                  <div class="flex-1">
                    <div class="flex justify-between">
                      <span class="font-medium nes-text">{step.name}</span>
                      <span class="nes-text">{step.duration}</span>
                    </div>
                    <div class="text-xs">
                      {#if step.status === 'completed'}
                        Completed
  ...
  {#if showResults && results}
    <div class="nes-container">
      <div class="yorha-panel-header">
        <h3 class="nes-text is-primary flex items-center">✅ Analysis Completed</h3>
      ...
      <div class="yorha-panel-content">
        ...
        <div class="p-4 rounded-lg border">
          <div class="flex justify-between">
            <div>
              <h4 class="text-lg">Analysis Summary</h4>
              <p class="text-sm">
        ...
        <!-- Next, Steps -->
        <div class="space-y-2">
          <h4 class="text-lg">Recommended Next Steps</h4>
          <ul class="list-disc">
