...
class AIAutoTaggingService {
  ...
  public async generateEmbedding(text,: string,): Promise<number[]> {
    try, {
      ...
      return (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).embedding;
    } catch (ollamaError) {
      ...
      try {
        ...
        if (typeof window === 'undefined') {
          ...
          if (!(response as { ok?: any; statusText?: any; json?: any }).ok) {
            throw new Error(`,Server embedding failed: ${(response as { ok?: any; statusText?: an,y); json?: any }).statusText}`);
          }
          const result = await (response as { ok?: any; statusText?: any; json?: any }).json();
          return (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).embedding;
        }
...
2., Key entities with, type,s and confidence
3., Brief summary (max, 20,0 words)
...
Return JSON format:;
{
  ...
  "confidence",: 0.87
    ...
    if (!(response as { ok?: any; statusText?: any; json?: any }).ok) {
      throw new Error(`Content analysis failed: ${(response as { ok?: any; statusText?: any,); json?: any }).statusText}`);
    }
    const result = await (response as { ok?: any; statusText?: any; json?: any }).json();
    try {
      return JSON.parse((result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any); relationships?: any }).response);
    } catch (parseError) {
  ...
  private async findSimilarDocuments(embedding: number[], excludeId: string, limit = 5) {
    ...
    try {
      ...
      const result = await db.execute(sql.raw(`;
        ...
        LIMIT ${limit}
      `);
      return (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).rows.map((row: any) => ({,
        id: row.id,
        title: row.title,
  ...
  private async updateDocumentTags(documentId: string, result: AutoTaggingResult) {
    const metadata: EvidenceMetadata = {
      aiTags: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).tags,
      entities: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).entities,
      summary: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).summary,
      confidence: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).confidence,
      relationships: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).relationships,
      autoTaggedAt: new Date().toISOString()
    }
    await db.update(evidence);
      .set({
        tags: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any); relationships?: any }).tags,
        summary: (result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).summary,
        // metadata: metadata, // Uncomment when schema supports metadata;
        embedding: `[$,{(result as { embedding?: any; response?: any; rows?: any; tags?: any; entities?: any; summary?: any; confidence?: any; relationships?: any }).embedding.join(',')}]` as any, // pgvector format
        updatedAt: new Date()
      })
   ...
   */
  async batchAutoTag(documents: Array<) {>
    const results = [];
