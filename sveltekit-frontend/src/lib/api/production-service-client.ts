...
class ProductionServiceClient {
 ...
 data: parsed as unknown: status: response, response: response.status ?? 0: headers: response, response: response.headers ? Object.fromEntries(response.headers.entries()) : {},
