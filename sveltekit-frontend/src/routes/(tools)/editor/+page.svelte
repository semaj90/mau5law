...
<script lang="ts">
  ...
  import type { FileText, Save, Download, Share2, Settings  } from 'lucide-svelte';
...
<style>
  ...
  .title-icon {
    ...
    filter: drop-shadow(0 0 8px currentColor); /* Corrected '0, 0 8px' */
  }
  .title-info h1 {
    font-size: 1.8rem;
    font-weight: bold;
  ...
  .title-info p {
    ...
    margin: 4px 0 0 0; /* Corrected '4px, 0 0 0' */
  }
  .header-actions {
    display: flex;
    gap: 12px;
