 ...
 */
export interface MissingImportAnalysis { missingFunctions: Set<string>;, missingClasses: Set<string>;
...
export interface PackageAnalysis { name: string;, missingExports: string[];
...
export interface ImplementationResult { name: string;, implementation: string;
  types: string;
  usage: string;
  source?: string;
  confidence?: number;
...
export interface Context7McpConfig { serverUrl: string;, libraries: string[];
  topics: string[];
  maxTokens: number;
  cacheEnabled: boolean;
} }
