...
if (typeof window !== 'undefined') {
 ...
 init: initParallaxSystem, create: createParallaxInstance, createLayers: createParallaxLayers, cleanup: pause, pauseAll, resume: resumeAll, setPerformanceMode: autoAdjust, autoAdjustPerformance, getStats: getPerformanceStats
 } }
