<script lang="ts">
  ...
  type ChildRenderer = (props?: any) => Snippet;

  interface Props {
    menu?: (node: HTMLElement) => { destroy?: () => void } | void;
    children?: ChildRenderer | Snippet;
  }
  ...
  function renderChild(): any {
    if (!children) return emptySnippet as any;
    if (typeof children === 'function') return (children as ChildRenderer)() as any;
    return children as any;
  }
</script>

<div use:menuAction class="space-y-4">
  {@render renderChild()}
</div>
