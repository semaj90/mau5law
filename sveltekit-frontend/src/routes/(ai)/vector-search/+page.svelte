<script lang="ts">
import type { Case } from '$lib/types'; import  Button  from "$lib/components/ui/core.svelte"; import  Card, CardContent, CardHeader, CardTitle  from "$lib/components/ui/Card.svelte"; import { onMount } from 'svelte'; interface VectorResult { id: string, content?: string; textContent?: string; similarity: number; metadata: Record<string, unknown>;, source: string, contentType?: string; caseId?: string; evidenceId?: string}
