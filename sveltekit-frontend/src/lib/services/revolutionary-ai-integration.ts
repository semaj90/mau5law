...
import type { MemoryQuery, MemoryRetrievalResult, VisualMemoryPalaceManager } from '$lib/memory/visual-memory-palace-integration';
...
import type { LegalDocumentJSON, SIMDJSONAccelerator, SIMDParsingMetrics } from '$lib/wasm/simd-json-wrapper';
