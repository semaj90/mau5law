...
<style>
 /* @unocss-include */ /* Ensure the Monaco editor fills the container */ .monaco-container { height: 480px; /* ensure visible editor; adjust as needed */ }:global(.monaco-editor) { border-radius: 0.5rem;, height: 100% !important}
</style>
