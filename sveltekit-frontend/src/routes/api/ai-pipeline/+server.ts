...
// This ensures consistent loading and potential shared GPU context if the module manages it, // and that its initialization logic runs only once per server lifecycle.
