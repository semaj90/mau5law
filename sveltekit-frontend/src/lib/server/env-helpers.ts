 ...
 * Provides type-safe access to all environment variables used across the application
 * with sensible defaults for local development and Docker deployments
 */
...
/**
 * Redis connection URL (supports both single URL and host:port:password split)
 */
...
/**
 * Ollama API endpoint (local GPU inference)
 * Supports both host mode and Docker
 */
 ...
 * Setting to '999' forces full GPU acceleration for gemma3-legal
 */
...
/**
 * QUIC protocol server endpoint
 * Used for ultra-low-latency tensor streaming
 */
...
/**
 * Autosolve error threshold
 * When error count exceeds this, trigger autosolve cycle
 */
...
/**
 * Enable QUIC/HTTP3 protocol support
 */
...
/**
 * Get all resolved environment variables as a structured object
 * Useful for debugging and passing to workers
 */
