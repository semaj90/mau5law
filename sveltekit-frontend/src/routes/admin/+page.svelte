<script lang="ts">
// Svelte, 5 runes are auto-imported import { goto } from '$app // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/navigation'; import Button from '$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/Button.svelte'; import  Badge  from "$lib // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5/components/ui/badge.svelte"; // Icons import { Users, Activity, Database, Cpu, HardDrive, Shield, BarChart3, Clock, CheckCircle, AlertTriangle, RefreshCw, Zap, Server, Network, Monitor } from 'lucide-svelte'; // Svelte, 5 runes let systemStats = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5({ totalUsers: 0, activeUsers: 0, totalCases: 0, activeCases: 0, totalDocuments: 0, processedDocuments: 0, aiAnalyses: 0, uptime: '0d 0h 0m'
  });
  let systemHealth = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5({ database: true, redis: true, aiService: true, fileSystem: true, gpu: false, vectorSearch: true });
  let recentActivity = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<any[]>([]); let isLoading = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5<boolean>(true); let lastUpdated = $state // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5(new Date()); $effect // TODO: Verify store subscription is correct for Svelte 5 // TODO: Verify store subscription is correct for Svelte 5(() => { (async () => { await loadSystemStats(); await loadSystemHealth(); await loadRecentActivity()})(); // Auto-refresh every, 30 seconds const interval = setInterval(refreshData, 30000); return () => clearInterval(interval)});
