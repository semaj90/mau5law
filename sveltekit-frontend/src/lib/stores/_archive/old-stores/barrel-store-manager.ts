...
export class BarrelStoreManager {
  ...
  constructor() {
    // Defer loading persisted stores until after module-level stores are created.
    // Scheduling on a microtask ensures other top-level createStore() calls run first.
