<!-- Unified Canvas Integration Combines EvidenceCanvas with YoRHa CanvasBoard for comprehensive evidence visualization --> <script lang="ts"> // Svelte, 5 runes are auto-imported import { onMount } from "svelte";
