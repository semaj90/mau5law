...
export const laws = pgTable('laws', {
 ...
 codeTitle: text('code_title').notNull(), // "Penal Code"
 codeAbbrev: text('code_abbrev').notNull(), // "PC"
 codeEdition: text('code_edition'), // "2024"
...
export const lawSections = pgTable('law_sections', {
 ...
 sectionNumber: text('section_number').notNull(), // "211", "459"
 fullCitation: text('full_citation').notNull(), // "PC § 211"
 heading: text('heading'), // "Robbery"
 text: text('text').notNull(), // full statute text
