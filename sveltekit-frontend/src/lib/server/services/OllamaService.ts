/** * Ollama Service for local LLM integration * Provides lightweight, typed wrappers for the local Ollama HTTP API. */
...
export class OllamaService {
 ...
 options: {
 temperature: options.temperature ?? 7, /* PHASE82_COLON_CHAIN: num_predict.max_tokens ?? 1000  */ ,
 },
 }
