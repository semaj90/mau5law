...
declare module '$lib/machines/system-monitor' {
	const systemMonitorMachine: unknown;
...
declare module '$lib/services/latency-logger' {
	...
	export function startLatencyLogger(opts?: unknown): unknown;
}

declare module '$lib/services/system-monitor-client' {
	import type { LatencyEntry } from '$lib/services/latency-logger';
	export function startSystemMonitorClient(opts?: {
		batchSize?: number;
		intervalMs?: number;
		url?: string;
	}): {
		push?: (e: LatencyEntry) => void;
		stop?: () => void;
		service?: unknown;
	};
...
// WebGPU global types provided by @webgpu/types package
