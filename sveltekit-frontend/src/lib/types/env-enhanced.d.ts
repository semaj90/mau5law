...
DATABASE_URL: string;, POSTGRES_URL: string;
POSTGRES_HOST: string;, POSTGRES_PORT: string;
POSTGRES_DB: string;, POSTGRES_USER: string;
POSTGRES_PASSWORD: string;, REDIS_URL: string;
REDIS_HOST: string;, REDIS_PORT: string;
REDIS_PASSWORD: string;, OLLAMA_URL: string;
OLLAMA_HOST: string;, OLLAMA_PORT: string;
OPENAI_API_KEY: string;, ANTHROPIC_API_KEY: string;
GOOGLE_API_KEY: string;, QDRANT_URL: string;
QDRANT_HOST: string;, QDRANT_PORT: string;
QDRANT_API_KEY: string;, NEO4J_URL: string;
NEO4J_HOST: string;, NEO4J_PORT: string;
NEO4J_USERNAME: string;, NEO4J_PASSWORD: string;
MINIO_URL: string;, MINIO_HOST: string;
MINIO_PORT: string;, MINIO_ACCESS_KEY: string;
MINIO_SECRET_KEY: string;, MINIO_BUCKET: string;
MINIO_BUCKET_LEGAL_DOCUMENTS?: string;, JWT_SECRET: string;
ENCRYPTION_KEY: string;, API_SECRET: string;
NODE_ENV: string;, PORT: string;
HOST: string;, PUBLIC_API_BASE_URL: string;
DEBUG: string;, LOG_LEVEL: string;
