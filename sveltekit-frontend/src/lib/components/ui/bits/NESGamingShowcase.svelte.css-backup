<script lang="ts"> import  NESButton  from "./NESButton.svelte";
 import  NESCard  from "./NESCard.svelte";
 import  NESModal  from "./NESModal.svelte"; interface NESGamingShowcaseProps { title?: string; showStats?: boolean}
  let { title = 'NES Gaming UI Showcase', showStats = true }: NESGamingShowcaseProps = $props();
   ...
   const gameFeatures = [ { id: 'legal-ai', title: 'Legal AI System', description: 'Advanced neural networks for legal analysis', status: 'online'; icon: 'âš–ï¸'
    }, {
