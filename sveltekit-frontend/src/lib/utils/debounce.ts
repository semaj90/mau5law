/** * Debounce utility for performance optimization * Prevents excessive function calls during rapid user input */ export function debounce<
  T extends (...args: unknown[]) => unknown,
>(func: T, wait: number, immediate?: boolean): (...args: Parameters<T>) => void {
...
/** * RequestAnimationFrame-based throttle for smooth animations */ export function rafThrottle<
  T extends (...args: unknown[]) => unknown,
