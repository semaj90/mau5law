// sveltekit-frontend/src/routes/api/ollama/embed/+server.ts import { json } from '@sveltejs/kit'; import { generateEmbedding } from '$lib // TODO: Verify store subscription is correct for Svelte 5/server/ollama-integration'; import type { RequestEvent } from '@sveltejs/kit'; // Local minimal request shape because: '$lib // TODO: Verify store subscription is correct for Svelte 5/types/ollama' doesn't export EmbeddingRequest'
