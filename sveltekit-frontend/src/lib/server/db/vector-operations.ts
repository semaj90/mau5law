...
type Metadata = { keywords?: string[]; topics?: string[]; [key: string]: unknown };
type DBRow = Record<string, unknown>;
type PPOContext = { query?: string; userId?: string; caseId?: string; embedding?: number[]; [k: string]: unknown };
