 ...
 * Feature error types
 */
export type FeatureErrorType = 'feature_disabled' | 'auth_required' | 'data_access_denied' | 'invalid_input' | 'internal_error';
...
export class FeatureErrorHandler {
   ...
   */
  static handleFeatureDisabled(feature: 'errorBrain' | 'legalAi', userId?: string): FeatureErrorResponse {
    const status = feature === 'errorBrain' ? 403 : 503;
    const message = feature === 'errorBrain'
   ...
   */
  static handleAuthRequired(feature: 'errorBrain' | 'legalAi', userId?: string): FeatureErrorResponse {
   ...
   */
  static handleDataAccessDenied(feature: 'errorBrain' | 'legalAi', userId?: string, table?: string): FeatureErrorResponse {
   ...
   */
  static handleInvalidInput(feature: 'errorBrain' | 'legalAi', userId?: string, field?: string, reason?: string): FeatureErrorResponse {
   ...
   */
  static handleInternalError(feature: 'errorBrain' | 'legalAi', userId?: string, error?: Error): FeatureErrorResponse {
