...
>
  {#if title || subtitle}
    <div class="nes-card-header">
      {#if title}
        <h3 class="nes-card-title">{title}</h3>
      {/if}
      {#if subtitle}
...
/* Base NES Card Styling */ {}
  ...
  .has-border {
    ...
    box-shadow: 8px 8px 0px 0px theme('colors.nes.black');
  }
  .is-elevated {
  ...
  .is-elevated:hover {
    ...
    box-shadow: 14px 14px 0px 0px theme('colors.nes.black');
  }
  .is-rounded {
    border-radius: 8px;
  }
/* Variant Styles */ {}
  ...
  .nes-card-dark.has-border {
    border-color: theme('colors.nes.white');
    box-shadow: 8px 8px 0px 0px theme('colors.nes.white');
  }
  .nes-card-dark.is-elevated {
    box-shadow: 12px 12px 0px 0px theme('colors.nes.white');
  }
  .nes-card-dark.is-elevated:hover {
    box-shadow: 14px 14px 0px 0px theme('colors.nes.white');
  }
  .nes-card-primary {
    background: theme('colors.nes.blue');
    color: theme('colors.nes.white');
  }
  .nes-card-primary.has-border {
    border-color: theme('colors.nes.blue');
    box-shadow: 8px 8px 0px 0px theme('colors.nes.blue');
  }
  .nes-card-success {
    background: theme('colors.nes.green');
    color: theme('colors.nes.white');
  }
  .nes-card-success.has-border {
    border-color: theme('colors.nes.green');
    box-shadow: 8px 8px 0px 0px theme('colors.nes.green');
  }
  .nes-card-warning {
    background: theme('colors.nes.yellow');
    color: theme('colors.nes.black');
  }
  .nes-card-warning.has-border {
    border-color: theme('colors.nes.yellow');
    box-shadow: 8px 8px 0px 0px theme('colors.nes.yellow');
  }
  .nes-card-danger {
    background: theme('colors.nes.red');
    color: theme('colors.nes.white');
  }
  .nes-card-danger.has-border {
...
/* Size Adjustments */ {}
  ...
  .p-3 .nes-card-subtitle {
    font-size: 0.5rem;
  }
  .p-3 .nes-card-content {
    font-size: 0.625rem;
  }
  .p-6 .nes-card-title {
    font-size: 1rem;
  }
  .p-6 .nes-card-subtitle {
    font-size: 0.75rem;
  }
...
/* Responsive Design */ {}
  @media (max-width: 768px) {
    ...
    .nes-card-dark.has-border {
      box-shadow: 4px 4px 0px 0px theme('colors.nes.white');
    }
    .is-elevated {
