...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'panel-soft':
      'bg-panelSoft text-sand rounded-lg border border-black/30 shadow-[0_0_0_1px_#00000080]',
  ...
  safelist: [
    ...
    // Sidebar navigation icons (YorhaSidebar.svelte — dynamic i-lucide-{name})
    ...
    'i-lucide-landmark',
    'i-lucide-gamepad-2',
    // Additional dynamic icon names missing from extraction
    'i-lucide-pencil',
    'i-lucide-bookmark',
