  ...
  <div class="max-w-6xl mx-auto">
    ...
    <section class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3">
        ...
        <!-- Grey, Variants -->
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Grey Balance</h3>
    ...
    <section class="space-y-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4">
        ...
        <div class="bg-harvard-gold p-4 rounded text-black">
          <div class="font-bold">Harvard Gold</div>
          <div class="text-sm">#ffd700</div>
        </div>

        <div class="bg-nes-grey p-4 rounded text-white">
          <div class="font-bold">NES Grey</div>
          <div class="text-sm">#6a6a6a</div>
        </div>
