...
export const GET: RequestHandler = async ({ url }) => {
  try {
    ...
    query = query
      .groupBy(documents.id, documents.filename, documents.title, documents.fileSize, documents.mimeType, documents.processingStatus, documents.createdAt, documents.metadata)
    ...
    // Enhance documents with summaries (first chunk as preview)
