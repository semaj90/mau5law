...
import { MessageSquare } from "lucide-svelte";;
 ...
 <p class="text-muted-foreground"> OCR • AI Assistant • Neo4j • PostgreSQL • pgvector • RAG • XState • RabbitMQ • SIMD • Redis Cache </p> </div>
...
<div class="space-y-6">
 ...
 <ul class="text-sm">
 {#each Array.isArray(processedResults.aiAnalysis.keyPoints.slice(0, 3)) ? processedResults.aiAnalysis.keyPoints.slice(0, 3): [] as point} <li class="flex items-start"> <span class="text-blue-500">•</span>
 ...
 <p class="text-sm text-muted-foreground max-h-32 overflow-hidden">
