...
export type YoRHaFormField =
  ...
  | (YoRHaFormFieldBase & { type: 'select';
	options: Array<{ value: string;
	label: string }> });

export const yorhaDocumentColumns: YoRHaColumn[] = [
...
export const yorhaCaseColumns: YoRHaColumn[] = [
  { key: 'yorha_id', title: 'YORHA ID', sortable: true, width: 140 },
...
export const yorhaEvidenceColumns: YoRHaColumn[] = [
  { key: 'yorha_id', title: 'YORHA ID', sortable: true, width: 140 },
...
export const yorhaDocumentFields: YoRHaFormField[] = [
...
export const yorhaCaseFields: YoRHaFormField[] = [
...
export const yorhaEvidenceFields: YoRHaFormField[] = [
