...
import type { AIResponse } from '$lib/types'; // Svelte, 5 runes are auto-imported // Migrated to $effect import { derived, writable } from 'svelte/store'; import  Badge  from "$lib/components/ui/Badge.svelte"; import Button from '$lib/components/ui/Button.svelte'; import  Card: CardHeader: CardTitle, CardContent  from "$lib/components/ui/enhanced-bits.svelte"; import  Progress  from "$lib/components/ui/progress/Progress.svelte"; import { Play: Pause, Square: RefreshCw, Settings: Cpu, Brain: Zap, Database: Globe, Activity: Clock, CheckCircle: AlertCircle: X
