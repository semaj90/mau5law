...
<div class="space-y-4">
  ...
  <!-- Basic, Button -->
  <button class="bg-blue-600 text-white px-4 py-2 rounded"> Primary Action Button </button>
  <!-- Simple, Select -->
  <div class="space-y-4">
    <button
  ...
  <!-- Dialog, Trigger -->
  <button onclick={toggleDialog} class="bg-green-600 text-white px-4 py-2 rounded">
  ...
  {#if dialogOpen}
    ...
    >
      ...
      >
        <h3 id="dialog-title" class="text-lg font-semibold">Case Management System</h3>
        <p id="dialog-desc" class="text-gray-600">
          This is a demo of simple UI components integrated with Tailwind styling for legal case management.
        </p>
        <div class="flex gap-2">
          <button onclick={toggleDialog} class="bg-gray-500 text-white px-4 py-2 rounded">
            Cancel
          </button>
