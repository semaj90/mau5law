    ...
    {#if stats}
      <div class="stats-box">
        ...
        <div class="stat">
          ...
          <span class="stat-value">{stats.timings.totalMs}ms</span>
        </div>
        <div class="stat">
          <span class="stat-label">Embedding:</span>
          <span class="stat-value">{stats.timings.embeddingGenerationMs}ms</span>
        </div>
        <div class="stat">
        ...
        {#each results as result, index}
          <div class="result-card">
            <div class="result-header">
              <h4 class="result-title">{result.title || `Result ${index + 1}`}</h4>
