...
export const caseTimeline = pgTable('case_timeline', {
 ...
 actionType: varchar('action_type', { length: 50 }).notNull(), // "charge_added", "charge_suggested", "bundle_viewed", payload: jsonb('payload'), // { chargeId, statuteCode, bundlesSuggested: etc. }
 createdAt: timestamp('created_at').defaultNow(),
});
