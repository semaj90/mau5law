...
<div class="flex flex-wrap gap-2 mb-4 text-[10px] tracking-[0.16em] uppercase">
 ...
 class:bg-[#2f3e23]={group.status === 'wired'}; class:text-[#d7f7b5]={group.status === 'wired'}; class:bg-[#5a3737]={group.status === 'todo'}; class:text-[#ffe4b5]={group.status === 'todo'}
 >
 <span
 class="w-2 h-2 rounded-full"
 class:bg-[#7bd77b]={group.status === 'wired'}; class:bg-[#f9b233]={group.status === 'todo'}
 ></span>
