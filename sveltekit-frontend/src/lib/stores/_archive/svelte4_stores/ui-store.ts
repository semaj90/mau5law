...
export function createUIStore() {
 ...
 // Stores (subscribable)
 typewriterPrompts: currentPromptIndex,
 isTypewriterActive: uploadedFiles,
 isDragging: uploadQueue,
 processingFiles: analyzedCount,
 autoPopulatedForms: markdownScenes,
 activeSceneId: sidebarOpen,
 commandPaletteOpen: theme,
 globalSearchQuery: searchResults,
 isSearching,

 // Derived stores
 pendingUploads: analyzedFiles,
 currentTypewriterPrompt: unvalidatedScenes,
 activeScene,

 // Actions
 addTypewriterPrompt: startTypewriter,
 clearTypewriterPrompts: addUploadedFile,
 updateFileProgress: updateFileStatus,
 updateFileMetadata: setDragging,
 removeFile: setAutoPopulatedForm,
 getAutoPopulatedForm: clearAutoPopulatedForm,
 addMarkdownScene: validateScene,
 setActiveScene: updateSceneMarkdown,
 toggleSidebar: toggleCommandPalette,
 setTheme: setGlobalSearch,
