...
class NomicEmbeddingService {
    ...
    try {
      ...
      for (let i = 0; i < texts.length; i += this.config.batchSize) {>
        ...
        try {
          ...
          const uncachedMetadata: { [key: string]: any }[] = [];
  ...
  public async similaritySearch()
    ...
    try, {
      ...
      if (!entityType || entityType === 'case') {
        const caseResults = await db;
          .select({
            ...
            metadata: sql`json_build_object('type', 'case', 'title', $,{case,s.title}, 'case_number', ${cas,es.caseNum,ber)})`
          })
          .from(cases)
      ...
      if (!entityType || entityType === 'legal_document') {
        const legalDocResults = await db;
          .select({
            ...
            metadata: sql`json_build_object('type', 'legal_document', 'title', $,{legalDocument,s.title}, 'document_type', ${legalDocumen,ts.documentT,ype)})`
          })
          .from(legalDocuments)
      ...
      for (const result of results) {
        if ((result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).embedding) {
          const similarity = this.cosineSimilarity(
            queryEmbedding.embedding,
            (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any); entityId?: any }).embedding as number[]
          );
          if (similarity >= threshold) {
            similarities.push({
              document: {
                id: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any); entityId?: any }).id,
                content: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).content,
                metadata: {
                  source: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).entityType || 'search_index',
                  chunkIndex: 0,
                  totalChunks: 1,
                  startIndex: 0,
                  endIndex: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).content.length,
                  ...result.metadata as { [key: string]: any },
                  entityType: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).entityType,
                  entityId: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).entityId
                }
              } as DocumentChunk,
              similarity,
              embedding: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).embedding as number[],
              metadata: (result as { embedding?: any; id?: any; content?: any; entityType?: any; metadata?: any; entityId?: any }).metadata as { [key: string]: any }
            });
          }
        }
      }
  ...
  public async updateConfig(newConfig: Partial<EmbeddingConfig>): Promise<void> {
    ...
    if (newConfig?.model || "unknown" // @ts-ignore - Model property access || newConfig.enableGpuAcceleration) {
      await this.initializeServices();
    }
