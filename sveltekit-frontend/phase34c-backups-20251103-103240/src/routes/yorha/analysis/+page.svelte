...
<style>
 .yorha-interface { display: flex, height: 100vh; background: #2a2a2a;, color: #d4af37; font-family: 'JetBrains Mono', 'Courier New', monospace; font-size: 12px; overflow: hidden}
