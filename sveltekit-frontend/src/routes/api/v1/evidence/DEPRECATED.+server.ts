/**
 * ⚠️ DEPRECATED ROUTE - /api/v1/evidence
 *
 * This endpoint has been superseded by /api/v2/evidence
 * Please migrate to the unified Evidence API v2
 *
 * Migration Instructions:
 * - GET  /api/v1/evidence → GET  /api/v2/evidence?action=list
 * - POST /api/v1/evidence → POST /api/v2/evidence
 *
 * Benefits of v2:
 * - Unified interface for all evidence operations
 * - Intelligent Python AI backend integration with fallback
 * - Vector-powered search with Ollama embeddings
