...
class RealTimeServer {
  ...
  public async publishUpdate(channel: string, data: unknown, userId?: string) {
  ...
  public async publishEvidenceUpdate(evidenceId: string, action: string, data: unknown, userId?: string) {
    await this.publishUpdate('evidence_update', {
      evidenceId,
  ...
  public async publishCaseUpdate(caseId: string, action: string, data: unknown, userId?: string) {
    await this.publishUpdate('case_update', {
      caseId,
      action,
      data
    }, userId);
  ...
  public async publishCanvasUpdate(caseId: string, action: string, data: unknown, userId?: string) {
    await this.publishUpdate('canvas_update', {
      caseId,
      action,
      data
    }, userId);
