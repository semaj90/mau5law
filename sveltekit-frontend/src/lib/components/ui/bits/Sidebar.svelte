...
<div
  class={`
    ...
    ${theme === 'gaming' ? 'border-r border-green-400/30' : ''}
  `}
  ...
  <div class="p-4">
    <button
      ...
      class={`
        ...
        ${themeClasses[theme].homeButton}
        ${activeItem === 'home' ? themeClasses[theme].activeItem : ''}
        ${theme === 'gaming' ? 'border border-green-400/30' : ''}
      `}
          ...
          <li>
            ...
            <button
              ...
              class={`
                ...
                ${activeItem === item.id ? themeClasses[theme].activeItem : ''}
                ${item.disabled ? 'opacity-50 cursor-not-allowed' : ''}
                ${theme === 'gaming' && !item.disabled ? 'hover:border-green-400/50 border border-transparent' : ''}
              `}
            ...
            >
              ...
              <div class={`
                ...
                ${isExpanded ? 'scale-100' : 'scale-110'}
                ${theme === 'gaming' ? 'filter drop-shadow-[0_0_6px_currentColor]' : ''}
              `}>
                {item.icon}
              </div>
              ...
              {:else if item.badge}
                ...
                <div
                  class={`
                    ...
                    ${theme === 'gaming'
                      ? 'bg-green-400 shadow-[0_0_6px_rgba(0,255,65,0.6)]'
                      : 'bg-red-500'
                    }
                  `}
                >{/if}
                  ...
                  <li>
                    <button
                      ...
                      class={`
                        ...
                        ${themeClasses[theme].item}
                        ${activeItem === child.id ? themeClasses[theme].activeItem : ''}
