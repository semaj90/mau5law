...
const fallbackEnsureProperties = <T extends DBRow>(target: unknown, defaults: DBRow): T => {
...
export const safeEnsureProperties = <T extends DBRow>(obj: unknown, defaults: DBRow = defaultRowShape): T => {
    try {
...
export const ensureConnection = async (client: DBClient | Sql | unknown): Promise<DBClient> => {
    ...
    try {
        const fn = dbClient.query ?? dbClient.execute;
...
export const enhanceResultWithTypes = <T extends DBRow>(result: unknown, defaults: DBRow): T =>
...
export const entityEnhancers = {
    ...
    chatMessage: (msg: unknown) => enhanceResultWithTypes(msg, {
        id: null,
        message: '',
        role: 'user',
    ...
    vectorOperation: (op: unknown) => enhanceResultWithTypes(op, {
        id: null,
