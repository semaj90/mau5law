  ...
  <DropdownMenu.Portal forceMount>
    {#if open}
      <DropdownMenu.Content class="ai-menu" transition:fly={{ duration: 150, y: -8 }}>
        ...
        <!-- Separator -->
        <DropdownMenu.Separator class="ai-menu__separator" />
        <!-- AI Tools Section -->
        <DropdownMenu.Group class="ai-menu__section">
          <DropdownMenu.Label class="ai-menu__header">
            <Brain size={14} />
...
<details class="ai-dropdown" bind:open={open}>
  <summary
    ...
    on:click|preventDefault={disabled || isGenerating}
  >
    <span class="ai-trigger__content">
      <Brain class="icon" />
      <span class="label">AI Actions</span>
    </span>
