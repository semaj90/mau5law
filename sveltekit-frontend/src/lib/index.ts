...
// ===== UTILITIES & TYPES =====
export {
  cn, formatFileSize, formatDate, generateId, debounce, throttle, getConfidenceLevel, getCaseStatusStyling, getEvidenceTypeStyling, formatProcessingTime, getInitials, isValidEmail, copyToClipboard, downloadFile, isBrowser, storage, theme
 } from './utils.js';
...
export {
  comprehensiveOllamaSummarizer, type ComprehensiveSummaryRequest, type ComprehensiveSummaryResponse, type SummarizerConfig, type SummarizerStats
 } from './services/comprehensive-ollama-summarizer.js';
export {
  ollamaIntegrationLayer, type IntegratedChatRequest, type IntegratedChatResponse, type OllamaServiceStatus
 } from './services/ollama-integration-layer.js';
export {
  LangChainOllamaService, langChainOllamaService, type LangChainConfig, type ProcessingResult, type QueryResult
...
export const FRAMEWORK_INFO = {
  sveltekit: '2.x', svelte: '5.x', typescript: '5.x', vite: '5.x'
};
// ===== FEATURE FLAGS =====
export const FEATURES = { GPU_ACCELERATION: true;
  VECTOR_SEARCH: true;
  REAL_TIME_CHAT: true;
...
export const DEV_TOOLS = { COMPONENT_COUNT: 392, ROUTE_COUNT: 82, API_ENDPOINT_COUNT: 145, STORE_COUNT: 8, SERVICE_COUNT: 12
 }as const;
// ===== BARREL STORE - MISSING FUNCTIONS & METHODS =====
export {
  barrelStore, testingFramework, cacheLayerMethods, databaseEntityProperties, webGPUExtendedMethods, lokiCollectionMethods, configurationProperties, utilityFunctions
 } from './stores/barrel-functions.js';
// ===== DATABASE COMPATIBILITY LAYER =====
export {
  default as drizzleCompatibilityFix, drizzleCompatibilityLayer, handleQueryResult, safePropertyAccess, vectorOperations, ensureConnection, enhanceResultWithTypes, entityEnhancers, createTypeSafeQuery
...
export {
  searchService, globalSearch, searchServices, searchComponents, searchDocumentation, searchDemos
 } from './services/search-service.js';
// Hybrid Vector Operations
export {
  hybridVectorService, hybridSearch, syncVectorData, getVectorSystemHealth
...
export default {
  VERSION, BUILD_DATE, FRAMEWORK_INFO, FEATURES, DEV_TOOLS, barrelStore
};
