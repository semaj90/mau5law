    ...
    {#snippet children()}
      <div class="search-form">
        <div class="form-group">
          <label for="search-input" class="nes-text">
        ...
        {#if showAdvanced}
          <div class="advanced-controls">
            <div class="control-group">
              <label for="threshold-input" class="nes-text">
                <Target class="inline-icon" />
                Similarity Threshold: {similarityThresholdLabel}
              </label>
              <input
                id="threshold-input"
                type="range"
              ...
              {#if result.metadata}
                <div class="result-metadata">
                  {#if result.metadata.variant}
                    <span class="nes-badge is-dark">{result.metadata.variant}</span>
                  {/if}
