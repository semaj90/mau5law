 ...
 * Prioritizes Docker service hostnames via environment variables, * falling back to localhost for local development.
 */
...
// Add other service endpoints here as needed, following the same pattern.
// For example:
