...
const meta = {
  ...
  parameters: { layout: 'padded',
    docs: { description: { component: 'AI-powered file upload component with real-time processing and vector embeddings'
      } }
    } }
  },
  tags: ['autodocs'],
  argTypes: { maxFileSize: { control: 'number',
    ...
    enableAIProcessing: { control: 'boolean',
