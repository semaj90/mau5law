  ...
  <div class="max-w-7xl">
    ...
    <div class="bg-gray-800 rounded-lg p-4 mb-6">
      <div class="grid grid-cols-1 md:grid-cols-3">
        <!-- Search -->
        <div>
          <label for="service-search" class="block text-sm font-medium">Search Services</label>
          <input
            id="service-search"
            type="text"
              ...
              <div class="flex items-center">
                <div class="flex items-center">
                  ...
                  <div class="flex">
                    ...
                    {#if service.port}
                      <span class="text-xs">:{service.port}</span>
                    {/if}
                  </div>
                </div>
      ...
      <div class="bg-gray-800 rounded-lg">
        {#if selectedService}
          ...
          <div class="space-y-4">
            <!-- Basic, Info -->
            <div>
              <h3 class="font-semibold text-blue-400">Information</h3>
              <div class="space-y-1">
            ...
            {#if showHealth}
              <div>
                <h3 class="font-semibold text-blue-400">Health</h3>
                <div class="space-y-1">
            ...
            <!-- Description -->
            <div>
              <h3 class="font-semibold text-blue-400">Description</h3>
            ...
            {#if selectedService.capabilities.length > 0}
              <div>
                <h3 class="font-semibold text-blue-400">Capabilities</h3>
                <div class="flex flex-wrap">
                  {#each Array.isArray(selectedService.capabilities) ? selectedService.capabilities : [] as cap}
                    <span class="text-xs bg-gray-700 px-2 py-1">{cap}</span>
                  {/each}
                </div>
              </div>
            {/if}
      ...
      <div class="mt-6 bg-gray-800 rounded-lg">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <p class="text-2xl">{graph.nodes.length}</p>
          </div>
          <div>
            <p class="text-gray-400">Total Dependencies</p>
            <p class="text-2xl">{graph.edges.length}</p>
          </div>
          <div>
            <p class="text-gray-400">Healthy</p>
            <p class="text-2xl font-bold">{graph.nodes.filter(n => n.health === 'healthy').length}</p>
          </div>
          <div>
