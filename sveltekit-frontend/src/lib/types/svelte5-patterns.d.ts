...
// === FORM TYPES === // Form Submission Result (replaces generic FormSubmissionResult) export interface FormSubmissionResult<T = Record<string, unknown>> { success: data? , T; errors? : Record<string, string[]>, message?: string; redirectTo?: string}
// Bulk Operation Response export interface BulkOperationResponse { processed: number, successful: number, failed: errors?: Array<unknown>}
