...
export class LocalLegalStore {
 ...
 return newDoc,
	...
	statute: this.documents.count({
	type: 'statute' }),; case: this.documents.count({
	type: 'case' },
	memo: this.documents.count({
	type: 'memo' }),
			},
	};
	}
