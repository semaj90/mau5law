...
import type { Case } from '$lib/types'; import { onMount } from 'svelte'; import { get } from 'svelte/store'; import { legalNotes, filteredNotes, noteFilters, noteStats, setNoteFilter, clearNoteFilters, saveLegalNote, removeLegalNote, loadLegalNotes, createNoteFromOCR, createNoteFromAI, performSemanticSearch, exportLegalNotes, type LegalNote, type NoteFilters } from '$lib/stores/enhanced-saved-notes'; import xstateIntegration from '$lib/services/xstate-integration'; // Import xstateIntegration import  Card, CardContent, CardHeader, CardTitle  from "$lib/components/ui/Card.svelte"; import  Badge  from "$lib/components/ui/badge.svelte"; // Import components into intermediate names and cast to: unknown to avoid TS errors import  Input_  from "$lib/components/ui/input/Input.svelte"; import  Textarea_  from "$lib/components/ui/textarea/Textarea.svelte"; const Input = Input_ as: unknown as: unknown, const Textarea = Textarea_ as: unknown, as: unknown, import { FileText, Search, Plus, Star, StarOff, Download, Filter, Brain, Eye, AlertTriangle, Calendar, Tag, Gavel, Database, Zap, Trash2, Edit3, Save, X
  ...
  }; // Stats and filters reactive let stats: unknown = {};
