	...
	<div class="footer-content">
		{#if variant === 'full'}
			...
			<div class="footer-bottom">
				...
				<div class="tech-stack">
					<span class="tech-badge"><span class="is-dark">Svelte 5</span></span>
					<span class="tech-badge"><span class="is-dark">bits-ui</span></span>
					<span class="tech-badge"><span class="is-dark">UnoCSS</span></span>
					<span class="tech-badge"><span class="is-dark">NES.css</span></span>
				</div>
			</div>
		{:else if variant === 'minimal'}
			<div class="minimal-footer">
				<p class="minimal-copyright nes-text">© {currentYear} YoRHa Legal AI</p>
		...
		{:else if variant === 'demo'}
			<div class="demo-footer nes-container with-title">
				...
				<div class="demo-info">
					<p class="demo-text nes-text">🎮 This is a demonstration of the YoRHa Legal AI Platform</p>
...
<style>
	...
	.minimal-links { display: flex; gap: 1rem;
	}
	...
	.demo-actions { display: flex; gap: 1rem;
		flex-wrap: wrap;
