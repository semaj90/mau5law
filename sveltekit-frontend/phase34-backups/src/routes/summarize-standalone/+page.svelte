 ...
 , DATE: August, 25, 2025
  ...
  async function handleSummarize(): Promise<any> {
    ...
    processingSteps = [
      ...
      'âœ‚ï¸ Splitting into semantic chunks...',
      'ðŸ§  Processing chunks with gemma3-legal...',
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        processingSteps.push('âœ… Summarization complete!');
...
'
      ...
      processingSteps.push('âŒ Network error');
    } finally {
      isLoading = false}
  }
...
<div class="summarization-container">
  <header class="page-header">
    <h1>ðŸ›ï¸ Legal Document Summarization</h1>
    <p class="subtitle">Advanced AI analysis powered by LangChain and your local legal model</p>
    <div class="status-bar">
      <div class="stats">
        <span>ðŸ“„ Words: {wordCount.toLocaleString()}</span>
        <span>ðŸ“ Characters: {charCount.toLocaleString()}</span>
        <span>â±ï¸ Est. time: {estimatedProcessingTime}s</span>
      </div>
      <div class="actions">
      ...
      <div class="input-panel">
        <div class="input-controls">
          <div class="file-upload">
            <label for="file-input" class="btn"> ðŸ“ Upload Document </label>
        ...
        <div class="text-input-area">
          ...
          <div class="input-footer">
            ...
            >
              {#if isLoading}
                ðŸ§  Processing... ({processingSteps.length}/4 steps)
              {:else}
                âš¡ Summarize Document
              {/if}
            </button>
          </div>
        </div>
      ...
      <div class="summary-panel">
          ...
          <div class="summary-result">
            <div class="result-header">
              ...
              <div class="result-actions">
                <button id="copy-btn" class="btn nes-btn" onclick={copySummary}> ðŸ“‹ Copy Summary </button>
              </div>
            </div>
            <div class="summary-content">
              ...
              {#if metadata}
                <div class="metadata-panel">
                  <h4>ðŸ“Š Processing Metadata</h4>
        ...
        {:else if errorMessage}
          <div class="error-panel">
            <h3>âŒ Processing Error</h3>
            <p>{errorMessage}</p>
            <button class="btn nes-btn" onclick={() => (activeTab = 'input')}> â† Back to Input </button>
          </div>
        {:else}
          <div class="empty-state">
            <h3>ðŸ“ No Summary Yet</h3>
      ...
      <div class="analysis-panel">
        {#if metadata?.legalRiskAnalysis}
          <div class="risk-analysis">
            <h3>âš–ï¸ Legal Risk Analysis</h3>
        ...
        {:else}
          <div class="empty-state">
            <h3>âš–ï¸ No Legal Analysis Available</h3>
...
<style>
  ...
  #document-input {
    width: 100%;
    padding: 1rem; border: 2px solid #e5e7eb
    border-radius: 0.5rem
