	  ...
	  <div class="flex justify-between items-center">
		...
		<div class="flex items-center gap-2">
		  ...
		  <div class="flex gap-1">
			<span class={`px-2 py-1 rounded text-xs font-medium border ${aiBackends.vllm.available ? 'bg-primary text-white' : 'border-gray-300 text-gray-700'}`}>vLLM</span>
			...
			<span class={`px-2 py-1 rounded text-xs font-medium border ${aiBackends.goMicroservice.available ? 'bg-primary text-white' : 'border-gray-300 text-gray-700'}`}>Go µS</span>
		  </div>
