 ...
 * Prioritizes Docker service name, falls back to localhost for development.
 */
...
/**
 * Centralized utility to get the Redis URL.
 */
...
/**
 * Centralized utility to get the Qdrant API endpoint.
 */
...
/**
 * Centralized utility to get the PostgreSQL database URL.
 */
