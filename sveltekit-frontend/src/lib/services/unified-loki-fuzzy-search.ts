...
export class UnifiedLokiFuzzySearch extends EventEmitter {
  ...
  private async searchCacheManager(query,: string, option,s: UnifiedSearchOption,s): Promise<UnifiedSearchResult[]> {
    try {
  ...
  private async searchEvidenceService(query,: string, option,s: UnifiedSearchOption,s): Promise<UnifiedSearchResult[]> {
    try {
  ...
  private async searchLokiStore(query,: string, option,s: UnifiedSearchOption,s): Promise<UnifiedSearchResult[]> {
    try {
      const result,s: UnifiedSearchResu,lt,[], = [];
  ...
  private async searchRedisCache(query,: string, option,s: UnifiedSearchOption,s): Promise<UnifiedSearchResult[]> {
    try {
      ...
      return searchResults.map((result, index) => ({ item: {, id: (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document.id,
          ...
          keywords: [],
          metadata: (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document.metadata,
          timestamp: ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document as CachedDocument).cacheTimestamp
        },
        source: 'redis' as const,
        cacheLocation: ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document as CachedDocument).cacheLocation,
        confidence: (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document.confidenceLevel,
        riskLevel: (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).document.riskLevel,
        score: (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).score,
        refIndex: index
      });
    } catch (error: any) {
  ...
  private combineAndRankResults()
    ...
    for (const result of results) {
      const existing = uniqueResults.get((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any); cacheLocation?: any }).item.i,d);
      if (!existing || ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).score || 1) < (existing.score || 1)) {>
        uniqueResults.set((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any); cacheLocation?: any }).item.id, resul,t);
      }
    }
    ...
    if (options.legalContextOnly) {
      finalResults = finalResults.filter(item => item.item).content, (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).item.keywords)
      );
    }
    return finalResults.slice(0, options.maxResults || 50);
  }
  private calculateEnhancedScore(result,: UnifiedSearchResult, quer,y: string, optio,ns: UnifiedSearchOptio,ns): number {
    let score = (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).score || 1;
    // Source priority weighting
    const sourceWeights = { redis: 0.9, cache: 0.95, evidence: 0.85, store: 1.0 }
    score *= sourceWeights[(result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).source];
    // Confidence boost
    if ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).confidence) {
      score *= (1 - (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).confidence * 0.2);
    }
    // Risk level consideration
    if ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).riskLevel) {
      const riskWeights = { critical: 0.7, high: 0.8, medium: 0.9, low: 1.0 }
      score *= riskWeights[(result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).riskLevel as keyof typeof riskWeights] || 1.0;
    }
    // Recent content boost
    if (options.prioritizeRecent && (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).item.timestamp) {
      const age = Date.now() - (result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).item.timestamp;
      const daysSince = age / (1000 * 60 * 60 * 24);
      const recencyBoost = Math.max(0.8, 1 - daysSince * 0.01);
      score *= recencyBoost;
    }
    // Cache location optimization
    if ((result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).cacheLocation) {
      const locationWeights = { loki: 0.9, redis: 0.95, nes: 1.0 }
      score *= locationWeights[(result as { document?: any; score?: any; item?: any; source?: any; confidence?: any; riskLevel?: any; cacheLocation?: any }).cacheLocation];
    }
    return score;
  }
  private calculateEvidenceRelevance(evidence,: any, quer,y: strin,g): number {
  ...
  private calculateStoreRelevance(item,: any, quer,y: strin,g): number {
  ...
  private updateSearchStats(query,: string, result,s: UnifiedSearchResult[], sourceResul,ts: UnifiedSearchResult[][], responseT,ime: num,ber): void {
    this.searchStats.totalQueries+,+;
    this.searchStats.totalResults += results.lengt,h;
    // Update average response time
    const totalTime = this.searchStats.averageResponseTime * (this.searchStats.totalQueries - 1) + responseTim,e;
    this.searchStats.averageResponseTime = totalTime / this.searchStats.totalQuerie,s;
  }
  /**
   * Reindex all sources for improved search performance
   */
  async reindexAllSources(),: Promise<void> {
    if (this.indexingInProgres,s) {
  ...
  private async indexCacheEntry(entry,: any): Promise<void> {
    const searchableIte,m: SearchableItem = {
      id: `cache_${entry.key}`,
    ...
    await fuseLazySearc,h.addItem(searchableIte,m);
  }
  ...
  private async indexStoreItem(item,: any): Promise<void> {
    const searchableIte,m: SearchableItem = {
      id: `store_${(item as { id?: any; fileName?: any; title?: any; description?: any; content?: any; tags?: any; type?: any; createdAt?: any }).id}`,
      title: (item as { id?: any; fileName?: any; title?: any; description?: any; content?: any; tags?: any; type?: any; createdAt?: any }).fileName || (item as { id?: any; fileName?: any; title?: any; description?: any; content?: any; tags?: any; type?: any; createdAt?: any }).title || (item as { id?: any; fileName?: any; title?: any; description?: any; content?: any; tags?: any; type?: any; createdAt?: any }).id,
   ...
   */
  async searchLegalDocuments(query,: string, option,s: UnifiedSearchOptions = {}): Promise<UnifiedSearchResult[]> {
  ...
  async reset(),: Promise<void> {
    ...
    await fuseLazySearc,h.clearAll,();
    this.searchStats = {
      totalQueries: 0,
      averageResponseTime: 0,
      sourcesQueried: { cache: 0, evidence: 0, store: 0, redis: 0 },
