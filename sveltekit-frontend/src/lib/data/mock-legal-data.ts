...
export const mockCases = [
  {
    ...
    description:
      'Investigation into alleged embezzlement of corporate funds totaling $2.3M from Acme Technologies Inc.',
    priority: 'high',
  ...
  },
  {
    ...
    description:
      'Slip and fall accident at ABC Corp premises resulting in severe back injury. Client seeking compensation for medical expenses and lost wages.',
    priority: 'medium',
    status: 'open',
...
export const mockEvidence = [
  {
    ...
    aiAnalysis: {
      ...
      summary: 'Bank statements reveal multiple large wire transfers to offshore accounts over the reviewed period.',
    },
    aiTags: ['financial_fraud', 'wire_transfers', 'offshore_accounts'],
    aiSummary: 'Critical financial evidence showing a pattern of suspicious transfers.',
    titleEmbedding: null, // Will be generated by pgvector
    contentEmbedding: null,
    embedding: null,
    contentText:
      'Financial records showing systematic wire transfers from Acme Technologies operating account to various offshore entities. Pattern suggests coordinated embezzlement scheme.',
    metadata: {
  ...
  },
  {
    ...
    description: 'CCTV footage from ABC Corp main entrance showing the incident; footage timestamped and logged.',
    evidenceType: 'video',
    subType: 'cctv',
    fileName: 'abc_corp_entrance_2024_04_01.mp4',
    fileSize: 104857600,
    mimeType: 'video/mp4',
    hash: 'sha256:zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz',
    collectedBy: 'Security Team',
    location: 'ABC Corp Main Entrance',
    chainOfCustody: [],
    tags: ['video', 'cctv', 'slip_and_fall'],
    isAdmissible: true,
    confidentialityLevel: 'internal',
    aiAnalysis: {
      confidence: 0.78,
      entities: ['ABC Corporation'],
      keywords: ['slip', 'fall', 'wet_floor'],
      summary:
        'Video contains clear footage of a slip and fall near the main entrance; no obvious obstruction detected.',
    },
    aiTags: ['incident_video'],
    aiSummary: 'Footage capturing the slip and fall incident.',
    titleEmbedding: null,
    contentEmbedding: null,
    embedding: null,
    contentText: 'Video footage showing the slip and fall event in the main entrance area at 09:12:34.',
    metadata: {
      duration_seconds: 62,
      camera_id: 'CAM-01',
...
export function initializeMockDataWithEmbeddings() {
  return {
    ...
    cases: mockCases.map(c => ({
      ...c,
      caseEmbedding: c.caseEmbedding || generateMockEmbedding(384),
    })),
    evidence: mockEvidence.map(e => ({
      ...e,
      embedding: e.embedding || generateMockEmbedding(384),
      titleEmbedding: e.titleEmbedding || generateMockEmbedding(384),
      contentEmbedding: e.contentEmbedding || generateMockEmbedding(384),
    })),
