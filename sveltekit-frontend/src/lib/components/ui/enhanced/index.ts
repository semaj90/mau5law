...
export const nierClasses = { button: 'yorha-button', buttonPrimary: 'yorha-button-primary', card: 'yorha-card', cardElevated: 'yorha-card-elevated', input: 'yorha-input', panel: 'yorha-panel', separator: 'yorha-separator', scrollbar: `yorha-scrollbar`  }as const;
