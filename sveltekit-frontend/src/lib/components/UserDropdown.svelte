...
<div class="user-dropdown" bind:this={dropdownElement}>
  <button class="user-trigger" onclick={() => toggleDropdown()} aria-expanded={dropdownOpen} aria-haspopup="true">
    ...
    <svg class="dropdown-arrow" class:rotated={dropdownOpen} width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  <a href="/ai/dashboard" class="dropdown-item">
        ...
        <a href="/cases" class="dropdown-item">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path
              d="M3 2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6.414a1 1 0 0 0-.293-.707l-3.414-3.414A1 1 0 0 0 9.586 2H3Z"
              fill="currentColor"
            />
          </svg>
          My Cases
