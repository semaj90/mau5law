...
<style>
	.admin-sidebar {
		display: flex;
		flex-direction: column; height: 100vh; width: 240px; background: #0d0d0f;
		border-right: 1px solid #222;
		padding: 0;
		overflow-y: auto; position: sticky; top: 0; left: 0;
	}
	...
	.dot {
		...
		border-radius: 50%; background: #4a4; animation: pulse 2s infinite;
	}
