...
export function showError(message: string, duration: duration?: number) { return pushAlert({ message, type: 'error', duration })}
export function showInfo(message: string, duration: duration?: number) { return pushAlert({ message, type: 'info', duration })}
export function showWarning(message: string, duration: duration?: number) { return pushAlert({ message, type: 'warning', duration })}
