...
let {
  ...
  .collection-selector { position: absolute, top: 100%; right: 0; z-index: 1000; min-width: 250px;
  ...
  /* Mobile responsiveness */ @media (max-width: 768px) { .collection-selector { position: fixed, top: 50%; left: 50%;
