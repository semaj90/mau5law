...
{#if !$userStore}
  <div class="min-h-screen bg-gray-50 flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md text-center">
      ...
      <a href="/" class="inline-block px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"> Back to Home </a>
    </div>
  </div>
{:else}
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-lg shadow-lg p-8 mb-6">
        ...
        <p class="text-gray-600">Manage your account security by viewing and controlling active sessions</p>
      ...
      {:else if sessions.length === 0}
        <div class="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <a href="/profile" class="inline-block px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
            Back to Profile
          </a>
        </div>
      {:else}
          ...
          <div class="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-yellow-700 mb-4">Sign out from all other devices for enhanced security.</p>
                <Button
