...
export const CONFIDENCE_THRESHOLD_SAFE = Number(
	process.env.ERROR_BRAIN_CONFIDENCE_SAFE ?? 0.95
);

export const CONFIDENCE_THRESHOLD_FULL = Number(
	process.env.ERROR_BRAIN_CONFIDENCE_FULL ?? 0.7
);
...
export const BATCH_REPORT_STAMP =
	process.env.BATCH_REPORT_STAMP ??
