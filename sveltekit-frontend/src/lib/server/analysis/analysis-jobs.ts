...
export async function enqueueJob(params: {
	...
	const [row] = await db.insert(analysisJobs).values({
...
export async function updateAnalysisJob(id: string, patch: {
	status?: JobStatus;
	progress?: string;
	result?: Record<string, unknown>;
	error?: string | null;
...
export async function completeAnalysisJob(id: string, result: Record<string, unknown>): Promise<void> {
