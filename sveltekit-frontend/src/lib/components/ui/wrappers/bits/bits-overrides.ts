...
export function getBitsOverrides(): OverrideMap | undefined { try { return globalThis.__BITS_OVERRIDES__}catch { return undefined} }
export function registerOverride(name, string, impl: unknown): void { try { if (!globalThis.__BITS_OVERRIDES__) globalThis.__BITS_OVERRIDES__ = {}; globalThis.__BITS_OVERRIDES__[name] = impl}catch { // no-op }
} } 
