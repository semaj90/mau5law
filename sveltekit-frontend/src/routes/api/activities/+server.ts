...
export const GET: RequestHandler = async ({ locals, url }) => {
  try {
    ...
    const orderColumn =
      sortBy === 'title' ? caseActivities.title :
      sortBy === 'activityType' ? caseActivities.activityType :
      sortBy === 'status' ? caseActivities.status :
      sortBy === 'priority' ? caseActivities.priority :
      sortBy === 'scheduledFor' ? caseActivities.scheduledFor :
      sortBy === 'completedAt' ? caseActivities.completedAt :
