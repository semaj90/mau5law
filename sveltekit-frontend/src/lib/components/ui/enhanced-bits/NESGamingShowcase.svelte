      ...
      >
        <div class="feature-content">
          ...
          <div class="feature-status">
            <span class="status-indicator {feature.status}">
        ...
        {#if feature}
          <div class="feature-details">
            <div class="feature-header">
              <span class="feature-large-icon">{feature.icon}</span>
              <div>
                <h3>{feature.title}</h3>
      ...
      {:else}
        <div class="system-info">
          ...
          <div class="system-stats">
            <div class="stat-row">
              <span>Framework:</span>
              <span>Svelte 5 + Enhanced-Bits</span>
            </div>
            <div class="stat-row">
              <span>Styling:</span>
              <span>UnoCSS + NES.css</span>
            </div>
            <div class="stat-row">
              <span>Theme:</span>
              <span>NES Gaming Retro</span>
            </div>
            <div class="stat-row">
