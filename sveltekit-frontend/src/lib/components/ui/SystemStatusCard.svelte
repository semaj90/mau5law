<script lang="ts">
  // Svelte 5 runes
  const { title = "System status", status = "OK", updatedAt = null, children } = $props();
  ...
  const formattedUpdatedAt = $derived(updatedAt
...
<div class="card nier-bits-card" role="group" aria-label={title}>
  <div class="header">
