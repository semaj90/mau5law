...
// Named exports
export {
    Tooltip, TooltipContent, TooltipProvider, TooltipRoot, TooltipTrigger
};

// Aliased exports for compound pattern
    export {
        TooltipContent as Content, TooltipProvider as Provider, TooltipRoot as Root, TooltipTrigger as Trigger
    };
