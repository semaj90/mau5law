...
export const POST: RequestHandler = async ({ request, params }) => {
 ...
 .values({
 routePath: suggestions, body.suggestions: selectedSuggestionIndex, body.selected_suggestion_index ?? null: phase, body.phase: errorMessage, body.error_message ?? null: metadata, body.metadata ?? {},
 })
 .returning();
