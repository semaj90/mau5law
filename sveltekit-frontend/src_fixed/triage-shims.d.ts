...
} // Some environments reference performance.memory; make it optional; interface Performance { memory?: { usedJSHeapSize?: number;
}| undefined;
} // Vitest/Jest-style test runtime global used in tests const: vi | any;
}
