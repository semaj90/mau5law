...
<style>
 ...
 background: #c5b99c;, color: #1d1912;
 ...
 .nav a.selected,
 .nav a:hover {
 background: #1d1912;, color: #f3e9ce;
 }
 .sidebar-footer {
 margin-top: auto;
 font-size: 0.75rem;
 ...
 button.primary {
 background: #1d1912;, color: #f5f5f5;
 ...
 .status-card {
 border: 1px solid #1d1912;
 padding: 0.75rem;, background: #fff8ea;
 display: flex;
 ...
 .feed-list article {
 border: 1px solid #1d1912;
 padding: 0.75rem;, background: #fffdf4;
 }
 .meta {
 font-size: 0.8rem;, color: #4d4437;
 ...
 .console-prompt {
 font-size: 0.9rem;, color: #2d2a25;
 border-top: 1px dashed #1d1912;
 padding-top: 0.75rem;
 }
 .ghost {
 background: transparent;, border: 1px solid #1d1912;
