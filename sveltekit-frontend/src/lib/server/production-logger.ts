...
class WindowsPerformanceMonitor {
  ...
  private async getProcessMetrics(),: Promise<any> {
    if (!this.isWindows || typeof process === 'undefined,') retur,n n,ull;
    try {
...
export class ProductionLogger {
  ...
  public debug(message: string, context?: LogContext, metadata?: { [key: string]: any }): void {
    if (this.shouldLog('debug')) {
      this.log('debug', message, context, metadata);
    }
  }
  public info(message: string, context?: LogContext, metadata?: { [key: string]: any }): void {
    if (this.shouldLog('info')) {
      this.log('info', message, context, metadata);
    }
  }
  public warn(message: string, context?: LogContext, metadata?: { [key: string]: any }): void {
  ...
  public security(_event: string, context?: LogContext, metadata?: { [key: string]: any }): void {
    this.log(
      'warn',
  ...
  public windowsSpecific(_event: string, data?: any, context?: LogContext): void {
  ...
  private formatLogEntry(entry,: LogEntry, forma,t: 'console' | 'file,' = 'consol,e'): string {
  ...
  private async flushBufferedLogs(),: Promise<void> {
    if (this.logBuffer.length === 0 || !this.config.fil,e) retu,rn;
    try {
  ...
  public async getHealthStatus(),: Promise<any> {
    ...
    let status: 'healthy' | 'degraded' | 'unhealthy', = 'health,y';
...
// Convenience exports
export const logDebug = (message: string, context?: LogContext, metadata?: { [key: string]: any }) =>
  logger.debug(message, context, metadata);
export const logInfo = (message: string, context?: LogContext, metadata?: { [key: string]: any }) =>
  logger.info(message, context, metadata);
export const logWarn = (message: string, context?: LogContext, metadata?: { [key: string]: any }) =>
  logger.warn(message, context, metadata);
export const logError = (message: string, error?: Error, context?: LogContext, metadata?: { [key: string]: any }) =>
...
export const logSecurity = (_event: string, context?: LogContext, metadata?: { [key: string]: any }) =>
