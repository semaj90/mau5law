...
<style>
 ...
 .type-evidence { background: #4caf50;
	color: white; }
 .type-strategy { background: #2196f3;
	color: white; }
 .type-risk { background: #f44336;
	color: white; }
 .type-precedent { background: #ff9800;
	color: white; }
 .type-investigation { background: #9c27b0;
	color: white; }
