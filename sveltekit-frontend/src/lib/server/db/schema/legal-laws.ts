...
export const laws = pgTable('laws', {
 ...
 jurisdiction: text('jurisdiction').notNull(), // 'CA', 'NY', 'US', etc.
 codeTitle: text('code_title').notNull(), // "Penal Code", codeAbbrev: text('code_abbrev').notNull(), // "PC", codeEdition: text('code_edition'), // "2024", createdAt: timestamp('created_at', { withTimezone: true }).defaultNow(),
...
export const lawSections = pgTable('law_sections', {
 ...
 sectionNumber: text('section_number').notNull(), // "211", "459", fullCitation: text('full_citation').notNull(), // "PC § 211", heading: text('heading'), // "Robbery", text: text('text').notNull(), // full statute text
