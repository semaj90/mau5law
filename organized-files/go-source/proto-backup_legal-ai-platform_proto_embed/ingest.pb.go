...
// Unified to embed package to avoid mixed Go packages in single directory.
...
const file_ingest_proto_rawDesc = "" +
	"\n" +
	"\fingest.proto\x12\x05embed\"\xc8\x02\n" +
	...
	"\x04meta\x18\b \x03(\v2\x1c.embed.IngestChunk.MetaEntryR\x04meta\x12\x14\n" +
	...
	"\amessage\x18\x05 \x01(\tR\amessage2C\n" +
	"\tIngestion\x126\n" +
	"\fStreamChunks\x12\x12.embed.IngestChunk\x1a\x10.embed.IngestAck(\x01B%Z#legal-ai-platform/proto/embed;embedb\x06proto3"
...
var file_ingest_proto_goTypes = []any{
	(*IngestChunk)(nil), // 0: embed.IngestChunk
	(*IngestAck)(nil),   // 1: embed.IngestAck
	nil,                 // 2: embed.IngestChunk.MetaEntry
}
var file_ingest_proto_depIdxs = []int32{
	2, // 0: embed.IngestChunk.meta:type_name -> embed.IngestChunk.MetaEntry
	0, // 1: embed.Ingestion.StreamChunks:input_type -> embed.IngestChunk
	1, // 2: embed.Ingestion.StreamChunks:output_type -> embed.IngestAck
