    ...
    <div class="flex items-center gap-4 mb-6">
      <div class="relative">
        ...
        <div class="absolute -bottom-1 -right-1">
          <span class="{getScoreColor(scoring.score)} text-white text-xs px-2 py-1 rounded-full">
    ...
    <div class="grid grid-cols-2 gap-3 mb-4">
      <div class="score-metric">
        ...
        <div class="w-full h-1 bg-slate-800 rounded overflow-hidden">
          <div class="bg-blue-500 h-full rounded" style="width: {(scoring.breakdown.admissibility / 25) * 100}%"></div>
        </div>
      </div>
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
        ...
        <div class="w-full h-1 bg-slate-800 rounded overflow-hidden">
          <div class="bg-green-500 h-full rounded" style="width: {(scoring.breakdown.relevance / 25) * 100}%"></div>
        </div>
      </div>
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
        ...
        <div class="w-full h-1 bg-slate-800 rounded overflow-hidden">
          <div class="bg-yellow-500 h-full rounded" style="width: {(scoring.breakdown.quality / 25) * 100}%"></div>
        </div>
      </div>
      <div class="score-metric">
        <div class="flex justify-between items-center mb-1">
        ...
        <div class="w-full h-1 bg-slate-800 rounded overflow-hidden">
          <div class="bg-purple-500 h-full rounded" style="width: {(scoring.breakdown.strategic / 25) * 100}%"></div>
        </div>
      </div>
    </div>
    <!-- AI Reasoning -->
