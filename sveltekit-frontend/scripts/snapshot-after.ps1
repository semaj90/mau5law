...
<#
.SYNOPSIS
    Phase 90: Take database snapshot AFTER migration
#>

$ErrorActionPreference = 'Stop'

Write-Host "`n📸 Phase 90: Taking database snapshot (AFTER)..." -ForegroundColor Cyan
...
$outputFile = Join-Path $PSScriptRoot ".." "logs" "db-snapshot-after-$timestamp.json"
...
try {
    ...
    Write-Host "`n📊 Row counts after migration:" -ForegroundColor Magenta
