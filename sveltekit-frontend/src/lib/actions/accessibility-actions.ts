...
export function accessibleClick(element: HTMLElement, params: AccessibleClickParams): { update: (params: AccessibleClickParams) => void,destroy: () => void } {
  ...
  function setupAccessibility() {
    ...
    if (currentParams.disabled) {
      ...
      element.setAttribute('tabindex', '-1')} else {
...
export function focusManagement(element: HTMLElement, params: FocusManagementParams = {}): { update: (params: FocusManagementParams) => void,destroy: () => void } {
  let currentParams = params;
...
export function ariaState(element: HTMLElement, params: ARIAStateParams): { update: (params: ARIAStateParams) => void,destroy: () => void } {
  let currentParams = params;
...
export function keyboardNavigation(element: HTMLElement, params: KeyboardNavigationParams): { update: (params: KeyboardNavigationParams) => void,destroy: () => void } {
  let currentParams = params;
...
export function liveRegion(element: HTMLElement, params: LiveRegionParams = {}): { update: (params: LiveRegionParams) => void,announce: (message: string) => void,destroy: () => void } {
