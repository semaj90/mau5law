...
export interface SessionData {
 ...
 roles: string[]; lastActivity: string;
}
...
declare interface SimpleRedis {
 ...
 setex: (_key: string, seconds: number): string => Promise<unknown>;
 ...
 publish: (channel: string), string: (string: any) => Promise<number> | unknown;
 ...
 xRevRange: (stream: string, start: string, string: end, opts?: unknown) => Promise<unknown>;
