// Enhanced embeddings helper used by user-chat-recommendation-engine
// Provides deterministic, lightweight embeddings without external services.
// Deterministic hash -> vector generator
...
export async function generateEmbedding(text: string, dims = 384): Promise<number[]> {
  ...
  // Simple feature extraction: sliding 3-char ngrams hashed into buckets
