...
function createAIService() {
    ...
    return {
         ...
         */
        summarizeReport: async (reportContent: unknown, reportId?: string, caseId?: string): Promise<string | null> => {
         ...
         */
        summarizePOI: async (poiData: { name: string; profileData: unknown }, poiId?: string, caseId?: string): Promise<string | null> => {
