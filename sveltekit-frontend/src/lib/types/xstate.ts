...
// Core messaging
 ...
 | {
 type: 'SEND_BATCH_MESSAGES';
	messages: BatchMessage[];
 processingMode?: 'sequential' | 'parallel';
 }
 // Enhanced document processing
 | { type: 'UPLOAD_DOCUMENT';
	file: File; caseId?: string; metadata?: DocumentMetadata }
 | { type: 'PROCESS_DOCUMENT';
	documentId: string; options?: ProcessingOptions }
 | { type: 'ANALYZE_IMAGE';
	imageData: string | File; analysisType?: ImageAnalysisType }
 | { type: 'GENERATE_SUMMARY';
	content: string; summaryType?: SummaryType; maxLength?: number }
 ...
 | { type: 'SET_CASE_CONTEXT';
	caseId: string; options?: ContextOptions }
 | {
