...
export {
  DropdownRoot, DropdownTrigger, DropdownContent, DropdownItem, DropdownSeparator, Button, Card, CardHeader, CardTitle, CardContent, Input, Label, Select, Dialog, Textarea, Separator
};
// Compatibility namespace for legacy: "bits.DropdownMenu.*" usage
export const DropdownMenu = { Root: DropdownRoot;
...
export default {
  DropdownRoot, DropdownTrigger, DropdownContent, DropdownItem, DropdownSeparator, Button, Card, CardHeader, CardTitle, CardContent, Input, Label, Select, Dialog, Textarea, Separator, DropdownMenu
};
