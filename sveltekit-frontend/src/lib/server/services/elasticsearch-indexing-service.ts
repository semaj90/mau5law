...
export async function indexCaseChunk(
  ...
  try {
    ...
    const response = await fetch(
      `${ELASTICSEARCH_URL}/${INDICES.CASE_CHUNKS}/_doc/${chunkId}`,
      {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
...
export async function indexLawSection(
  ...
  try {
    ...
    const response = await fetch(
      `${ELASTICSEARCH_URL}/${INDICES.LAW_SECTIONS}/_doc/${sectionId}`,
      {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
...
export async function batchIndexCaseChunks(
  ...
  try {
    ...
    console.log(
      `[Elasticsearch] Successfully indexed ${documents.length} case chunks`
    );
  } catch (error) {
...
export async function batchIndexLawSections(
  ...
  try {
    ...
    console.log(
      `[Elasticsearch] Successfully indexed ${documents.length} law sections`
    );
  } catch (error) {
...
> {
  try {
    ...
    const response = await fetch(
      `${ELASTICSEARCH_URL}/${INDICES.CASE_CHUNKS}/_search`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
> {
  try {
    ...
    const response = await fetch(
      `${ELASTICSEARCH_URL}/${INDICES.LAW_SECTIONS}/_search`,
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
...
export async function deleteDocument(
  ...
  try {
    console.log(
      `[Elasticsearch] Deleting document ${documentId} from ${indexName}`
    );

    const response = await fetch(
      `${ELASTICSEARCH_URL}/${indexName}/_doc/${documentId}`,
      {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
