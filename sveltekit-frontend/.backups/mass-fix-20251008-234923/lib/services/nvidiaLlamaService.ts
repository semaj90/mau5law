...
export class NvidiaLlamaService {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      if (!(response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).success) {
        throw new Error(`Failed to initialize NVIDIA Llama: ${(response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any,); metrics?: any }).error}`);
      }
  ...
  async generateText(request: LlamaRequest): Promise<LlamaResponse> {
    ...
    try {
      ...
      const tokensPerSecond = (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).tokens_generated / (generationTime / 1000);
      // Update stats
      this.updateRequestStats(generationTime, (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any); metrics?: any }).tokens_generated);
      return {
        ...
        metadata: {
          ...
          cached_tokens: (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).cached_tokens || 0
        }
      }
    } catch (error: any) {
   ...
   */;
  async generateEmbeddings(text: string, model: string = 'nvidia-embed'): Promise<any> {
    const startTime = Date.now();
    try {
      ...
      return {
        embeddings: (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).embeddings,
        dimensions: (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).embeddings.length,
        model: (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).model_used,
  ...
  async batchGenerate(requests: LlamaRequest[]): Promise<LlamaResponse[]> {
    try {
      ...
      return (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).results;
    } catch (error: any) {
   ...
   */;
  async getGpuMetrics(): Promise<any> {
    try {
      // removed unused response assignment
      return (response as { success?: any; error?: any; tokens_generated?: any; text?: any; finish_reason?: any; model_used?: any; gpu_used?: any; prompt_tokens?: any; cached_tokens?: any; embeddings?: any; results?: any; metrics?: any }).metrics;
    } catch (error: any) {
  ...
  private async processQueue(): Promise<void> {
    ...
    try {
      const responses = await this.batchGenerate(batch.map(item => (item as { request?: any; resolve?: any); reject?: any )}).request);
      batch.forEach((item, index) => {
        (item as { request?: any; resolve?: any; reject?: any }).resolve(responses[index]);
      });
    } catch (error: any) {
      batch.forEach(item => {
        (item as { request?: any; resolve?: any); reject?: any }).reject(error as Error);
      });
    }
