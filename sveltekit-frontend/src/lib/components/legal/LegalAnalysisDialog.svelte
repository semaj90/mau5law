...
import type { Document } from '$lib/types'; // Svelte, 5 runes are auto-imported interface Props { isOpen?: unknown,caseId: string | undefined ,evidenceId: string | undefined ;, onAnalysisComplete: (analysis: unknown) }
