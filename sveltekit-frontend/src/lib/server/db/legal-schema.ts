...
export const legal_queries = pgTable('legal_queries', {
  ...
  inference_time: real('inference_time'), // milliseconds
  model_used: text('model_used').default('unknown'),
...
export const legal_documents = pgTable('legal_documents', {
  id: serial('id').primaryKey(),
  document_id: text('document_id').notNull().unique(), // existing field
...
export const document_entities = pgTable('document_entities', {
  id: serial('id').primaryKey(),
  document_id: integer('document_id').references(() => legal_documents.id),
  entity_id: integer('entity_id').references(() => legal_entities.id),
...
export const model_performance = pgTable('model_performance', {
  ...
  avg_inference_time: real('avg_inference_time'),
