...
<div class="flex h-screen flex-col">
 ...
 {#each sections as section (section.id)}
	<button
	class={`rounded-lg border border-black/20 bg-black/60 p-4 transition-all hover:border-amber-400 ${
...
>
 ...
 border border-black/20 bg-panel p-6 shadow-lg duration-200 animate-in fade-in-0 zoom-in-95 sm: rounded-lg md:w-full"
 ...
 >
 <div class="space-y-4">
 <h2 id="dialog-title" class="text-xl font-semibold text-black">Create New Case</h2>
