  ...
  if (globalConfig.enableGPUMonitoring && typeof window !== 'undefined') {
    try {
      import('../../stores/gpu-summary-store.svelte.ts').then(module => {
        ...
        console.log('=Ê ParallaxDynamic: GPU monitoring enabled');
      }).catch(err => {
...
export function createParallaxLayers(container, layerConfigs) {
  ...
  console.log(`=Ð ParallaxDynamic: Created ${instances.length} layer instances`);
  return instances;
}
...
function stopAnimationLoop() {
  ...
  console.log('ù ParallaxDynamic: Animation loop stopped');
}
...
function destroyInstance(instanceId) {
  ...
  console.log('=Ñ ParallaxDynamic: Destroyed instance:', instanceId);
  return true;
}
...
export function cleanup() {
  ...
  stopAnimationLoop();
  console.log('>ù ParallaxDynamic: Complete cleanup performed');
}
...
export function pauseAll() {
  stopAnimationLoop();
  console.log('ø ParallaxDynamic: All animations paused');
}
