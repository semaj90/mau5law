...
export const GET: RequestHandler = async () => {
 ...
 phaseProgress: {
 week1: Math.round(week1Progress, week2: Math.round(week2Progress, week3: 0,
 week4: 0,
 },
 phases: [
 {
