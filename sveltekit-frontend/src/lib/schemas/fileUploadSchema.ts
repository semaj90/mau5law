...
export const fileUploadSchema = z.object({
  ...
  type: z.string().min(1, 'Document type is required.'), title: z.string().min(1, 'Document title is required.'), description: z.string().optional(), tags: z.array(z.string()).optional(), isPrivate: z.boolean().default(false), // Default to false
