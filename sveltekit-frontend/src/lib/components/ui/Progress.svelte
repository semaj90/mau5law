<script lang="ts">
  type ProgressVariant = 'default' | 'success' | 'error' | 'warning' | 'info' | 'yorha' | 'legal';
...
<div class="relative w-full {containerClasses}">
  <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden {sizeClasses} {className}">
    <div
      class="h-full transition-all duration-300 ease-out {variantClasses}"
