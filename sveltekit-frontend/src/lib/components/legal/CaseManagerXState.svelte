...
<div class="case-manager-xstate p-6 max-w-7xl">
  ...
  {#if $hasError}
    <div class="mb-6 border-red-200 bg-red-50">
      <div class="p-4">
        ...
        <p class="text-red-600">{$machineState.context.error}
</p>
    ...
    <div class="mb-6">
      <div class="p-6">
        ...
        <div class="space-y-4">
          ...
          <Button onclick={handleCreateCase} class="w-full bits-btn">Create Case</Button>
        </div>
      </div>
    {/if}
        ...
        <div class="p-6">
          <div class="flex justify-between items-start">
            <div>
              ...
              <h1 class="text-3xl font-bold">{$currentCase.title}
</h1>

              <p class="text-sm">Case #{$currentCase.caseNumber}
</p>
            </div>
          ...
          <p class="text-gray-700">{$currentCase.description}
</p>

          <!-- Stats (read, from $stats) -->
          <div class="grid grid-cols-4">
            <div class="text-center">
              <div class="text-2xl font-bold">{$stats.totalEvidence}
</div>
            ...
            <div class="text-center">
              <div class="text-2xl font-bold">{$stats.processedEvidence}
</div>
  ...
  {#if $aiSummary}
                  <div class="border border-gray-200 rounded-lg">
                    ...
                    <p class="text-gray-700">{$aiSummary}
</p>
                  {/if}
  ...
  {#each Array.isArray(similarCases) ? similarCases : [] as similarCase}
                        <div class="border border-gray-200 rounded-lg p-3 flex justify-between">
                          <div>
                            <h5 class="font-medium">{similarCase.title}
</h5>
  ...
  {#if import.meta.env.DEV}
    <div class="mt-8 bg-gray-50">
      <div class="p-4">
        ...
        <div class="text-xs">
          <p>Current State: <span class="font-mono">{$machineState.value}
</span></p>
          ...
          <p>Evidence Count: {$evidence.length}
</p>

          <p>AI Summary: {$aiSummary ? 'Available' : 'None'}
</p>
        </div>
      </div>
    {/if}
