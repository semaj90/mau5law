...
class KeyboardShortcutsService {
  ...
  private findMatchingShortcut(_event: KeyboardEvent): KeyboardShortcut | null {
  ...
  private matchesKeyCombo(_event: KeyboardEvent, shortcut: KeyboardShortcut): boolean {
  ...
  // Public API methods
  public getShortcut(id,: string): KeyboardShortcut | undefine,d {
