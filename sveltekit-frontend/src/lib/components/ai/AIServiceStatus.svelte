<script lang="ts">
  ...
  $effect(() => {
    ...
    if (serviceStatus) {
      // This would be updated from the actual queue in a real implementation
      offlineQueueCount = 0;
    }
  });
</script>
  ...
  {#if serviceStatus}
    <div class="service-list">
      <div class="service-item">
        <svelte:component
          this={getServiceIcon(serviceStatus.ollama).component}
          class="w-5 h-5 {getServiceIcon(serviceStatus.ollama).class}"
        />
        <div class="service-info">
          <div class="service-name">Ollama AI</div>
          <div class="service-desc">Document analysis & generation</div>
        </div>
      ...
      <div class="service-item">
        <svelte:component
          ...
          class="w-5 h-5 {getServiceIcon(serviceStatus.embedding).class}"
        />
        <div class="service-info">
          <div class="service-name">Embedding Service</div>
          <div class="service-desc">Vector generation</div>
        </div>
      ...
      <div class="service-item">
        <svelte:component
          ...
          class="w-5 h-5 {getServiceIcon(serviceStatus.qdrant).class}"
        />
        <div class="service-info">
          <div class="service-name">Qdrant Vector DB</div>
          <div class="service-desc">Similarity search</div>
        </div>
      ...
      <div class="service-item">
        <svelte:component
          ...
          class="w-5 h-5 {getServiceIcon(serviceStatus.rag).class}"
        />
        <div class="service-info">
          <div class="service-name">RAG Pipeline</div>
          <div class="service-desc">Enhanced search</div>
        </div>
