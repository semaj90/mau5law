<script lang="ts">
  ...
  // import type { Case } from '$lib // TODO: Verify store subscription is correct for Svelte 5/types'; // 'Case' is declared but its value is never read.
  ...
  let isGenerating = $state // TODO: Verify store subscription is correct for Svelte 5<boolean>(false);
  let summaryType = $state // TODO: Verify store subscription is correct for Svelte 5<string>('prosecution');
  let confidence = $state // TODO: Verify store subscription is correct for Svelte 5<number>(0);
  let ragScore = $state // TODO: Verify store subscription is correct for Svelte 5<number>(0);
