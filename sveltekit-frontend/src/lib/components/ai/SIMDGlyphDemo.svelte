<!-- @migration-task Error while migrating Svelte, code: Expected, token } https://svelte.dev/e/expected_token --> <!-- @migration-task Error while migrating Svelte; code: Expected, token } --> <script lang="ts"> import { Button } from '$lib/components/ui/button'; // Svelte, 5 runes are auto-imported </script> import { onMount } from 'svelte';
...
<select id="-compression-target-" bind:value={ compressionTarget } class="w-full p-2 border"> <option value={ 10 }>10:1 (High Quality)</option>
 ...
 <!-- Batch, Actions --> <div class="flex"> <Button.Root class="bits-btn" onclick={ generateBatchDemo } disabled={ isGenerating } variant="ghost"> ðŸš€ Batch Demo <Button.Root class="bits-btn" onclick={ testCompressionLevels } disabled={ isGenerating } variant="ghost"> ðŸ“Š Test Compression <Button.Root class="bits-btn" onclick={() => results = []} variant="ghost"> ðŸ—‘ï¸ Clear Results </div>
 ...
 <span class="text-blue-600">{(result as { success?: any; data?: any; metadata?: any; error?: any; simd_data?: any; id?: any; prompt?: any; style?: any; evidence_id?: any; glyph_url?: any; enhanced_artifact_url?: any; cache_hits?: any; timestamp?: any; processing_time?: any }).simd_data.tile_map.length}
</span> </div>
 <div> <span class="font-medium">SIMD Time:</span>
 <span class="text-purple-600">{(result as { success?: any; data?: any; metadata?: any; error?: any; simd_data?: any; id?: any; prompt?: any; style?: any; evidence_id?: any; glyph_url?: any; enhanced_artifact_url?: any; cache_hits?: any; timestamp?: any; processing_time?: any }).simd_data.performance_stats.total_optimization_time_ms}ms</span> </div>
 <div> <span class="font-medium">Cache Hits:</span>
 <span class="text-green-600">{(result as { success?: any; data?: any; metadata?: any; error?: any; simd_data?: any; id?: any; prompt?: any; style?: any; evidence_id?: any; glyph_url?: any; enhanced_artifact_url?: any; cache_hits?: any; timestamp?: any; processing_time?: any }).cache_hits}
</span> </div> </div>
 <!-- Shader, Code, Preview --> <div class="bg-gray-800 text-gray-100 p-3 rounded-lg text-xs font-mono"> <div class="flex justify-between items-center"> <span class="text-yellow-400">Generated {(result as { success?: any; data?: any; metadata?: any; error?: any; simd_data?: any; id?: any; prompt?: any; style?: any; evidence_id?: any; glyph_url?: any; enhanced_artifact_url?: any; cache_hits?: any; timestamp?: any; processing_time?: any }).metadata.shader_format.toUpperCase()} Shader</span>
