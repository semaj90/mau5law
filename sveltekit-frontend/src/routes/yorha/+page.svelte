  ...
  async function checkClusterHealth(): Promise<any> {
    ...
    try {
      ...
      systemData = {
        ...
        memory_usage:
          typeof healthData.memory === 'number' ? healthData.memory : systemData.memory_usage,
        gpu_utilization:
          typeof healthData.gpu === 'number' ? healthData.gpu : systemData.gpu_utilization,
        network_latency:
          typeof healthData.latency === 'number' ? healthData.latency : systemData.network_latency,
        active_processes:
          typeof healthData.processes === 'number'
