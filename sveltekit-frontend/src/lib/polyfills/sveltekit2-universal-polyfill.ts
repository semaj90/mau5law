          ...
          return {
            requestDevice: async (descriptor?: any) => {
              return { createShaderModule: (descriptor: any) => ({ id: Math.random() }),
                createBuffer: (descriptor: any) => ({ id: Math.random(),
                ...
                createComputePipeline: (descriptor: any) => ({ id: Math.random(),
                  getBindGroupLayout: () => ({ id: Math.random() })
                }),
                createPipelineLayout: (descriptor: any) => ({ id: Math.random() }),
                createCommandEncoder: () => ({ beginComputePass: () => ({
                    setPipeline: () => {},
                    setBindGroup: () => {},
                    dispatchWorkgroups: () => {},
                    end: () => {} }
