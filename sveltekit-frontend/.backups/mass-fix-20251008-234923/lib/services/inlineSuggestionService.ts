...
export class InlineSuggestionService {
  ...
  constructor(private, option,s: SuggestionOptions = {
  ...
  async generateSuggestions(context,: SuggestionContext,): Promise<InlineSuggestion[]> {
    if (!this,.isInitialize,d) th,is.initializ,e();
    // Still not initialized (SSR) => short‑circuit
    if (!this,.isInitialize,d) retur,n, [];
    if (context,.text.length < this.options.minCharacter,s) {>
      return [];
    }
    ...
    results.forEach((result) => {
      if ((result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).status === 'fulfilled') {
        suggestions.push(...result.value);
      } else {
        console.warn('Suggestion generation failed:', (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any,); score?: any }).reaso,n);
      }
    });
  ...
  private async generateCompletionSuggestions(context,: SuggestionContext,): Promise<InlineSuggestion[]> {
    ...
    if (result,?.success, && (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).resu,lt) {
      ...
      return completions.filter(item => item.map)((completion: any, index: number) => ({,
  ...
  private async generateGrammarSuggestions(context,: SuggestionContext,): Promise<InlineSuggestion[]> {
    ...
    if (result,?.success, && (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).resu,lt) {
      ...
      return suggestions.filter(item => item.map)((suggestion: any, index: number) => ({,
      ...
      if (embeddingResult,?.success) {
        ...
        if (ragResults && typeof ragResults === 'object' && 'results' in ragResults && ragResults.results?.length > 0) {
          ...
          if (termResult?.success && termResult.result) {
            ...
            return terms.filter(item => item.map)((term: any, index: number) => ({,
    ...
    try {
      ...
      if (ragResults && typeof ragResults === 'object' && 'results' in ragResults && ragResults.results?.length > 0) {
        return (ragResults as any).results.slice(0, 3).map((result: any, index: number) => ({,
          ...
          text: (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).summary || `Reference to ${(result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).metadata?.title || 'related case'}`,
          confidence: (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).confidence,
          reasoning: `Related case reference: ${(result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).metadata?.caseNumber || 'Similar case'}`,
          metadata: {
            sourceType: 'case_reference',
            relevanceScore: (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).score,
            legalAccuracy: (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).confidence
          }
        }),;
      }
    } catch (error: any) {
  ...
  private async generateCitationSuggestions(context,: SuggestionContext,): Promise<InlineSuggestion[]> {
    ...
    if (result,?.success, && (result as { status?: any; value?: any; reason?: any; result?: any; summary?: any; metadata?: any; confidence?: any; score?: any }).resu,lt) {
      ...
      return citations.filter(item => item.map)((citation: any, index: number) => ({,
   ...
   */;
  private async executeAITask(_task,: any, opt,s: { timeoutMs?: numb,er); signal?: AbortSignal } = {}): Promise<AITaskResult> {
    if (!this,.aiActo,r) thro,w new Error('AI actor not initialize,d');
    const, { timeoutMs = 15000, signal } = op,t,;s;
    if (signal,?.aborted) {
   ...
   */;
  updateOptions(_options,: Partial<SuggestionOptions>), {
   ...
   */;
  destroy(), {
    try { this.aiActor?.stop(), } catch (error) {}
    try { this.goServiceActor?.stop(), } catch (error) {}
